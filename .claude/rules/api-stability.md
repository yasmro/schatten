...
`@theme`-registered CSS custom property currently shipped — i.e. the
machine-readable form of this contract. It ships under
`@yasmro/schatten/schatten.manifest.json` and is regenerated by
`pnpm build:manifest` from `dist/schatten.css`. Schema:
