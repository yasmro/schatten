...
- [#448](https://github.com/yasmro/schatten/pull/448) [`9bbb954`](https://github.com/yasmro/schatten/commit/9bbb95442ddcff3210dbf6f558d1d319f169fb08) Thanks [@yasmro](https://github.com/yasmro)! - BREAKING: Radix ベース lv1 (Select / Tooltip / Popover / DropdownMenu / Tabs / Radio / Checkbox / Switch / Separator / Avatar) の公開 Props 型から Radix 継承を全廃 (closes [#156](https://github.com/yasmro/schatten/issues/156))。各 Props は「native 要素の props + curated 再宣言」になり、Radix が型上公開していた未使用 prop は型エラーになる。
