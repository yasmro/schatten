import{j as e,r as E}from"./iframe-CB3Xjzq2.js";import{C as M}from"./Callout-CaE6bKfS.js";import{B as i}from"./Button-Ct0PrQE9.js";import{B as m}from"./Badge-Bn9oYlen.js";import"./preload-helper-hmmh1zBP.js";import"./utils-BQHNewu7.js";import"./index-D1SQP9Z-.js";import"./index-ZmD5P2F2.js";import"./chevron-up-CNwKXsCR.js";import"./index-CQeJrFeU.js";import"./index-C79u-Xgy.js";import"./Spinner-CgDqMUJm.js";const A=`/*
...
overriding \`--color-foreground\`) shows up immediately here.`,...(k=(x=r.parameters)==null?void 0:x.docs)==null?void 0:k.description}}};var g,b,f,y,w;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: 'Per Special',
  argTypes: {
    special: {
...
(\`&args=special:...;mode:...\`).`,...(w=(y=s.parameters)==null?void 0:y.docs)==null?void 0:w.description}}};var S,v,j,N,T;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...(j=(v=l.parameters)==null?void 0:v.docs)==null?void 0:j.source},description:{story:"For each canonical token, renders a color swatch inside a scoped wrapper\n(Mode class + `data-theme`) across four scenarios — light/no-Special,\nlight/spring-early, dark/no-Special, dark/spring-early. The browser's CSS\ncascade resolves `var(--color-X)` per scenario, so the swatch colors\nempirically prove which axis each token follows: Special-owned tokens shift\nbetween the (none) and (spring-early) columns; Mode-owned tokens shift\nbetween the light and dark columns; `--color-info` stays pinned to blue.",...(T=(N=l.parameters)==null?void 0:N.docs)==null?void 0:T.description}}};const q=["Overview","PerSpecial","CascadeVerification"];export{l as CascadeVerification,r as Overview,s as PerSpecial,q as __namedExportsOrder,X as default};
