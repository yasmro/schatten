...
<!-- [aria-invalid]    error styling -->
<!-- :disabled         disabled tokens (wrapper :has() recolours label too) -->`})]}),e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--subtle mt-8",children:"Coming in subsequent sweeps: Select / Tooltip (sweep-5), Toast / Dialog (sweep-6), Field / FieldSet (sweep-7)."})]})};var l,o,d;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
}`,...(d=(o=i.parameters)==null?void 0:o.docs)==null?void 0:d.source}}};const L=["Reference"];export{i as Reference,L as __namedExportsOrder,C as default};
