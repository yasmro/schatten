...
}`,...p.parameters?.docs?.source},description:{story:"§1 — Root pass-through. Every component spreads `...props` onto its root, so\n`data-testid` (and `data-cy`, `data-test`, …) ride straight through.",...p.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
...
}`,...m.parameters?.docs?.source},description:{story:`§2 — Compound components. Each named sub-component forwards its own props, so
every part can carry an independent testid. Select is the canonical example.`,...m.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
...
}`,...u.parameters?.docs?.source},description:{story:`§3 — asChild caveat. A Trigger whose child is an element merges its props onto
that child (Radix Slot), so the testid lands on the child, not on a wrapper.`,...u.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
...
React Testing Library, with role-first as the default.`,...b.parameters?.docs?.description}}};const Ve=["Overview","RootPassThrough","CompoundComponents","AsChildCaveat","PortalContent","CuratedPropsExceptions","FormFields","NamingAndNoAutoTestid","FrameworkSelectors"];export{u as AsChildCaveat,m as CompoundComponents,y as CuratedPropsExceptions,x as FormFields,b as FrameworkSelectors,C as NamingAndNoAutoTestid,h as Overview,g as PortalContent,p as RootPassThrough,Ve as __namedExportsOrder,Ue as default};
