import{I as r,A as e}from"./iframe-f3C9lqTd.js";import{u as _e,P as y,c as b,b as Re,d as Te,a as Ee}from"./index-DTu2zvdf.js";import{u as _}from"./index-B3sodpwI.js";import{u as N}from"./index-DLTwPrin.js";import{P as Fe,D as We}from"./index-BNjXo6zS.js";import{R as Me,h as Ve,u as qe,F as Ye}from"./Combination-6qokhJVN.js";import{P as R}from"./index-CT-WxP7r.js";/* empty css               */import{B as d}from"./Button-B89UESKs.js";import{S as Ge}from"./Separator-CfrBGyHh.js";import{X as Ke}from"./x-Bx_ZFGm4.js";import"./preload-helper-CDs4oQVQ.js";import"./index-DNOBZ28b.js";import"./index-ePpZJxz5.js";import"./index-gPncLeti.js";import"./utils-DclmTqRz.js";import"./index-DQHfBcw3.js";/* empty css               */import"./Spinner-Bzty0r34.js";/* empty css                *//* empty css                  */import"./createLucideIcon-Paz3fXwW.js";var j="Dialog",[ye]=Re(j),[$e,h]=ye(j),ve=t=>{const{__scopeDialog:n,children:o,open:s,defaultOpen:i,onOpenChange:a,modal:l=!0}=t,c=r.useRef(null),p=r.useRef(null),[g,m]=_e({prop:s,defaultProp:i??!1,onChange:a,caller:j});return e.jsx($e,{scope:n,triggerRef:c,contentRef:p,contentId:N(),titleId:N(),descriptionId:N(),open:g,onOpenChange:m,onOpenToggle:r.useCallback(()=>m(L=>!L),[m]),modal:l,children:o})};ve.displayName=j;var Oe="DialogTrigger",He=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=h(Oe,o),a=_(n,i.triggerRef);return e.jsx(y.button,{type:"button","aria-haspopup":"dialog","aria-expanded":i.open,"aria-controls":i.contentId,"data-state":F(i.open),...s,ref:a,onClick:b(t.onClick,i.onOpenToggle)})});He.displayName=Oe;var T="DialogPortal",[Ue,Ce]=ye(T,{forceMount:void 0}),De=t=>{const{__scopeDialog:n,forceMount:o,children:s,container:i}=t,a=h(T,n);return e.jsx(Ue,{scope:n,forceMount:o,children:r.Children.map(s,l=>e.jsx(R,{present:o||a.open,children:e.jsx(Fe,{asChild:!0,container:i,children:l})}))})};De.displayName=T;var P="DialogOverlay",xe=r.forwardRef((t,n)=>{const o=Ce(P,t.__scopeDialog),{forceMount:s=o.forceMount,...i}=t,a=h(P,t.__scopeDialog);return a.modal?e.jsx(R,{present:s||a.open,children:e.jsx(Xe,{...i,ref:n})}):null});xe.displayName=P;var ze=Te("DialogOverlay.RemoveScroll"),Xe=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=h(P,o);return e.jsx(Me,{as:ze,allowPinchZoom:!0,shards:[i.contentRef],children:e.jsx(y.div,{"data-state":F(i.open),...s,ref:n,style:{pointerEvents:"auto",...s.style}})})}),f="DialogContent",Se=r.forwardRef((t,n)=>{const o=Ce(f,t.__scopeDialog),{forceMount:s=o.forceMount,...i}=t,a=h(f,t.__scopeDialog);return e.jsx(R,{present:s||a.open,children:a.modal?e.jsx(Ze,{...i,ref:n}):e.jsx(Je,{...i,ref:n})})});Se.displayName=f;var Ze=r.forwardRef((t,n)=>{const o=h(f,t.__scopeDialog),s=r.useRef(null),i=_(n,o.contentRef,s);return r.useEffect(()=>{const a=s.current;if(a)return Ve(a)},[]),e.jsx(Be,{...t,ref:i,trapFocus:o.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:b(t.onCloseAutoFocus,a=>{var l;a.preventDefault(),(l=o.triggerRef.current)==null||l.focus()}),onPointerDownOutside:b(t.onPointerDownOutside,a=>{const l=a.detail.originalEvent,c=l.button===0&&l.ctrlKey===!0;(l.button===2||c)&&a.preventDefault()}),onFocusOutside:b(t.onFocusOutside,a=>a.preventDefault())})}),Je=r.forwardRef((t,n)=>{const o=h(f,t.__scopeDialog),s=r.useRef(!1),i=r.useRef(!1);return e.jsx(Be,{...t,ref:n,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:a=>{var l,c;(l=t.onCloseAutoFocus)==null||l.call(t,a),a.defaultPrevented||(s.current||(c=o.triggerRef.current)==null||c.focus(),a.preventDefault()),s.current=!1,i.current=!1},onInteractOutside:a=>{var p,g;(p=t.onInteractOutside)==null||p.call(t,a),a.defaultPrevented||(s.current=!0,a.detail.originalEvent.type==="pointerdown"&&(i.current=!0));const l=a.target;((g=o.triggerRef.current)==null?void 0:g.contains(l))&&a.preventDefault(),a.detail.originalEvent.type==="focusin"&&i.current&&a.preventDefault()}})}),Be=r.forwardRef((t,n)=>{const{__scopeDialog:o,trapFocus:s,onOpenAutoFocus:i,onCloseAutoFocus:a,...l}=t,c=h(f,o),p=r.useRef(null),g=_(n,p);return qe(),e.jsxs(e.Fragment,{children:[e.jsx(Ye,{asChild:!0,loop:!0,trapped:s,onMountAutoFocus:i,onUnmountAutoFocus:a,children:e.jsx(We,{role:"dialog",id:c.contentId,"aria-describedby":c.descriptionId,"aria-labelledby":c.titleId,"data-state":F(c.open),...l,ref:g,onDismiss:()=>c.onOpenChange(!1)})}),e.jsxs(e.Fragment,{children:[e.jsx(Qe,{titleId:c.titleId}),e.jsx(tt,{contentRef:p,descriptionId:c.descriptionId})]})]})}),E="DialogTitle",we=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=h(E,o);return e.jsx(y.h2,{id:i.titleId,...s,ref:n})});we.displayName=E;var ke="DialogDescription",Ie=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=h(ke,o);return e.jsx(y.p,{id:i.descriptionId,...s,ref:n})});Ie.displayName=ke;var Ae="DialogClose",Pe=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=h(Ae,o);return e.jsx(y.button,{type:"button",...s,ref:n,onClick:b(t.onClick,()=>i.onOpenChange(!1))})});Pe.displayName=Ae;function F(t){return t?"open":"closed"}var je="DialogTitleWarning",[_t,Le]=Ee(je,{contentName:f,titleName:E,docsSlug:"dialog"}),Qe=({titleId:t})=>{const n=Le(je),o=`\`${n.contentName}\` requires a \`${n.titleName}\` for the component to be accessible for screen reader users.

If you want to hide the \`${n.titleName}\`, you can wrap it with our VisuallyHidden component.

For more information, see https://radix-ui.com/primitives/docs/components/${n.docsSlug}`;return r.useEffect(()=>{t&&(document.getElementById(t)||console.error(o))},[o,t]),null},et="DialogDescriptionWarning",tt=({contentRef:t,descriptionId:n})=>{const s=`Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Le(et).contentName}}.`;return r.useEffect(()=>{var a;const i=(a=t.current)==null?void 0:a.getAttribute("aria-describedby");n&&i&&(document.getElementById(n)||console.warn(s))},[s,t,n]),null},nt=ve,ot=De,at=xe,st=Se,it=we,rt=Ie,Ne=Pe;function lt({title:t,description:n}){return e.jsxs("div",{className:"st-dialog__header",children:[e.jsx(it,{className:"st-dialog__title",children:t}),n&&e.jsx(rt,{className:"st-dialog__description",children:n})]})}function ct({children:t}){return e.jsx("div",{className:"st-dialog__body",children:t})}function dt({actionButton:t,cancelButton:n,subActionButton:o,anyLoading:s}){const i=!!t.isLoading,a=!!(o!=null&&o.isLoading);return e.jsxs("div",{className:"st-dialog__footer",children:[e.jsx(d,{variant:t.variant??"primary",isLoading:i,disabled:a,onClick:t.onClick,icon:t.icon,className:"order-1 sm:order-3",children:t.label}),n&&e.jsx(Ne,{asChild:!0,children:e.jsx(d,{variant:"secondary",disabled:s,onClick:n.onClick,icon:n.icon,className:"order-2",children:n.label})}),o&&e.jsx(Ge,{className:"order-3 my-2 sm:my-0 sm:hidden","aria-hidden":"true"}),o&&e.jsx(d,{variant:"tertiary",isLoading:a,disabled:i,onClick:o.onClick,icon:o.icon,className:"order-4 sm:order-1 sm:mr-auto",children:o.label})]})}function ut({disabled:t}){return e.jsx("div",{className:"st-dialog__close",children:e.jsx(Ne,{asChild:!0,children:e.jsx(d,{variant:"tertiary",size:"sm",icon:Ke,"aria-label":"Close",disabled:t})})})}const u=({isOpen:t,onOpenChange:n,title:o,description:s,isCloseButtonVisible:i=!0,actionButton:a,cancelButton:l,subActionButton:c,children:p})=>{r.useEffect(()=>{},[t,a.onClick]);const g=!!a.isLoading||!!(c!=null&&c.isLoading),m=r.useCallback(L=>{g&&L.preventDefault()},[g]);return e.jsx(nt,{open:t,onOpenChange:n,children:e.jsxs(ot,{children:[e.jsx(at,{className:"st-dialog__overlay"}),e.jsxs(st,{onEscapeKeyDown:m,onPointerDownOutside:m,onInteractOutside:m,...s===void 0&&{"aria-describedby":void 0},className:"st-dialog__content",children:[e.jsx(lt,{title:o,description:s}),p&&e.jsx(ct,{children:p}),e.jsx(dt,{actionButton:a,cancelButton:l,subActionButton:c,anyLoading:g}),i&&e.jsx(ut,{disabled:g})]})]})})};u.displayName="Dialog";try{u.displayName="Dialog",u.__docgenInfo={description:"",displayName:"Dialog",filePath:"/home/runner/work/schatten/schatten/src/components/lv1/Dialog/Dialog.tsx",methods:[],props:{isOpen:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Controlled open state.",name:"isOpen",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!0,tags:{},type:{name:"boolean"}},onOpenChange:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Called when the open state changes (close ✕, ESC, overlay click, cancel button).",name:"onOpenChange",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!0,tags:{},type:{name:"(isOpen: boolean) => void"}},title:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Dialog heading. Rendered as the accessible name via Radix `aria-labelledby`.",name:"title",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!0,tags:{},type:{name:"string"}},description:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Optional supporting text rendered below the title.",name:"description",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!1,tags:{},type:{name:"string"}},isCloseButtonVisible:{defaultValue:{value:"true"},declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Whether the close (✕) button in the top-right is rendered.",name:"isCloseButtonVisible",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!1,tags:{default:"true"},type:{name:"boolean"}},actionButton:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:`Required primary action. Set \`isLoading: true\` on the slot to show
...
- Desktop (horizontal): visual order is \`SubAction … Cancel Action\`
  ...
  confirmation lands on the primary action immediately.`,name:"children",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!1,tags:{},type:{name:"ReactNode"}}},tags:{}}}catch{}const Rt={title:"Components/lv1/Dialog",component:u,parameters:{layout:"centered",docs:{description:{component:`Dialog renders a modal overlay for important content or actions —
...
}`,...(G=(Y=O.parameters)==null?void 0:Y.docs)==null?void 0:G.source}}};var K,$,H;C.parameters={...C.parameters,docs:{...(K=C.parameters)==null?void 0:K.docs,source:{originalSource:`{
  name: 'Destructive',
  parameters: {
    docs: {
      description: {
...
}`,...(H=($=C.parameters)==null?void 0:$.docs)==null?void 0:H.source}}};var U,z,X;D.parameters={...D.parameters,docs:{...(U=D.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(X=(z=D.parameters)==null?void 0:z.docs)==null?void 0:X.source}}};var Z,J,Q;x.parameters={...x.parameters,docs:{...(Z=x.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  name: 'Loading',
  parameters: {
    docs: {
      description: {
...
}`,...(Q=(J=x.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var ee,te,ne;S.parameters={...S.parameters,docs:{...(ee=S.parameters)==null?void 0:ee.docs,source:{originalSource:`{
...
}`,...(ne=(te=S.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var oe,ae,se;B.parameters={...B.parameters,docs:{...(oe=B.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  name: 'Async Action',
  parameters: {
    docs: {
      description: {
...
}`,...(se=(ae=B.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};var ie,re,le;w.parameters={...w.parameters,docs:{...(ie=w.parameters)==null?void 0:ie.docs,source:{originalSource:`{
...
}`,...(le=(re=w.parameters)==null?void 0:re.docs)==null?void 0:le.source}}};var ce,de,ue;k.parameters={...k.parameters,docs:{...(ce=k.parameters)==null?void 0:ce.docs,source:{originalSource:`{
...
}`,...(ue=(de=k.parameters)==null?void 0:de.docs)==null?void 0:ue.source}}};var pe,ge,he;I.parameters={...I.parameters,docs:{...(pe=I.parameters)==null?void 0:pe.docs,source:{originalSource:`{
...
}`,...(he=(ge=I.parameters)==null?void 0:ge.docs)==null?void 0:he.source}}};var me,fe,be;A.parameters={...A.parameters,docs:{...(me=A.parameters)==null?void 0:me.docs,source:{originalSource:`{
  name: 'Long Content',
  parameters: {
    docs: {
      description: {
...
}`,...(be=(fe=A.parameters)==null?void 0:fe.docs)==null?void 0:be.source}}};const Tt=["Playground","Confirm","Destructive","WithSubAction","Loading","SubActionLoading","AsyncAction","AsyncSubAction","WithoutCloseButton","InfoOnly","LongContent"];export{B as AsyncAction,w as AsyncSubAction,O as Confirm,C as Destructive,I as InfoOnly,x as Loading,A as LongContent,v as Playground,S as SubActionLoading,D as WithSubAction,k as WithoutCloseButton,Tt as __namedExportsOrder,Rt as default};
