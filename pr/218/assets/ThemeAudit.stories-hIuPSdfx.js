import{j as e,r as M}from"./iframe-A08ieE8-.js";import{C as T}from"./Callout-BdZqhS_f.js";import{B as m}from"./Button-qmdXkyGC.js";import{B as i}from"./Badge-BoUZ3q4y.js";import"./preload-helper-Ba7VrmIS.js";import"./utils-BQHNewu7.js";import"./index-D1SQP9Z-.js";import"./index-B6fL-VhJ.js";import"./chevron-up-DdrH6Wi_.js";import"./index-B9AWlT0Y.js";import"./index-B0wnt4Px.js";import"./Spinner-CCBeMRkW.js";const A=`/*
...
`,l=[{name:"season--spring-early",label:"Spring Early",jpn:"桜色・薄紅"},{name:"season--spring-late",label:"Spring Late",jpn:"若草色・萌黄"},{name:"season--summer-early",label:"Summer Early",jpn:"萌葱色・常磐色"},{name:"season--summer-peak",label:"Summer Peak",jpn:"朱色・柿色"},{name:"season--autumn-early",label:"Autumn Early",jpn:"浅葱色・薄藍"},{name:"season--autumn-late",label:"Autumn Late",jpn:"山吹色・飴色"},{name:"season--winter-early",label:"Winter Early",jpn:"銀鼠・薄墨"},{name:"season--winter-deep",label:"Winter Deep",jpn:"深紅・墨"}],P=["light","dark"],O=A.replace(/:root\[/g,".theme-audit-cell[");function c(){return e.jsx("style",{children:O})}function $(){return e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx(m,{variant:"primary",size:"sm",children:"Primary"}),e.jsx(m,{variant:"secondary",size:"sm",children:"Secondary"}),e.jsx(i,{variant:"neutral",appearance:"solid",children:"Neutral"}),e.jsx(i,{variant:"success",appearance:"subtle",children:"Success"}),e.jsx("span",{className:"size-4 rounded bg-theme-500","aria-hidden":"true"}),e.jsx("span",{className:"size-4 rounded bg-theme-200","aria-hidden":"true"}),e.jsx("span",{className:"size-4 rounded bg-theme-700","aria-hidden":"true"})]})}function E({mode:n,special:o}){const a=n==="dark";return e.jsxs("div",{className:`theme-audit-cell ${a?"dark":""} flex flex-col gap-3 rounded-lg border border-border bg-background p-4`,"data-theme":o??void 0,children:[e.jsxs("div",{className:"flex items-center justify-between text-xs",children:[e.jsx("span",{className:"font-mono text-foreground-muted",children:o??"(no theme)"}),e.jsx("span",{className:"rounded bg-surface px-1.5 py-0.5 font-mono text-foreground-subtle uppercase",children:n})]}),e.jsx($,{}),e.jsx(T,{variant:"info",appearance:"subtle",title:"Info",children:"Theme scale and Mode tokens combine here."})]})}const q={title:"Foundation/ThemeAudit",parameters:{layout:"fullscreen"}},r={name:"Overview (16 patterns)",parameters:{docs:{description:{story:"8 Specials × 2 Modes = 16 patterns. Rows = Special (seasonal palette); columns = Mode (light/dark). Use this grid to verify orthogonality and to spot regressions when a new Special is added."}}},render:()=>e.jsxs("div",{className:"theme-audit-overview p-6",children:[e.jsx(c,{}),e.jsxs("header",{className:"mx-auto mb-6 max-w-6xl",children:[e.jsx("h1",{className:"mb-2 font-bold text-3xl text-foreground",children:"Theme Composition Audit"}),e.jsx("p",{className:"text-foreground-muted text-sm leading-relaxed",children:"Mode (light/dark) and Special (seasonal palette) are independent axes. This grid renders every combination so visual regressions across the matrix can be spotted in one screen."})]}),e.jsx("div",{className:"mx-auto grid max-w-6xl grid-cols-2 gap-3 md:grid-cols-2",children:l.map(n=>e.jsxs("div",{className:"contents",children:[e.jsxs("div",{className:"col-span-2 mt-4 flex items-baseline gap-2 first:mt-0",children:[e.jsx("h2",{className:"font-semibold text-base text-foreground",children:n.label}),e.jsx("span",{className:"text-foreground-muted text-xs",children:n.jpn}),e.jsx("span",{className:"ml-auto font-mono text-foreground-subtle text-xs",children:n.name})]}),P.map(o=>e.jsx(E,{mode:o,special:n.name},`${n.name}-${o}`))]},n.name))})]})},s={name:"Per Special",argTypes:{special:{description:"Which Special palette to apply on this story.",control:"select",options:["none",...l.map(n=>n.name)],table:{type:{summary:`${l.map(n=>`"${n.name}"`).join(" | ")} | "none"`},defaultValue:{summary:"none"}}},mode:{description:"Mode for this story (independent of the toolbar).",control:"select",options:["light","dark"],table:{type:{summary:'"light" | "dark"'},defaultValue:{summary:"light"}}}},args:{special:"none",mode:"light"},render:n=>{const{special:o,mode:a}=n;return e.jsxs("div",{className:"p-6",children:[e.jsx(c,{}),e.jsx("div",{className:"mx-auto max-w-3xl",children:e.jsx(E,{mode:a,special:o==="none"?null:o})})]})}},L=[{name:"--color-theme-500",owner:"Special",purpose:"Theme scale mid-tone"},{name:"--color-theme-200",owner:"Special",purpose:"Theme scale tint"},{name:"--color-background",owner:"Mode",purpose:"Page background"},{name:"--color-surface",owner:"Mode",purpose:"Card / container"},{name:"--color-foreground",owner:"Mode",purpose:"Primary text"},{name:"--color-border",owner:"Mode",purpose:"Default border"},{name:"--color-surface-disabled",owner:"Mode",purpose:"Disabled (Specials must not override)"},{name:"--color-info",owner:"Pinned",purpose:"Pinned to blue; never moves with Special"}],d=[{id:"l-none",label:"light · (none)",mode:"light",special:null},{id:"l-spring",label:"light · spring-early",mode:"light",special:"season--spring-early"},{id:"d-none",label:"dark · (none)",mode:"dark",special:null},{id:"d-spring",label:"dark · spring-early",mode:"dark",special:"season--spring-early"}];function D(){const n=M.useId();return e.jsxs("div",{children:[e.jsx("h2",{id:n,className:"mb-2 font-semibold text-foreground text-xl",children:"Cascade verification"}),e.jsxs("p",{className:"mb-4 text-foreground-muted text-sm leading-relaxed",children:["Each column is a sample point: a wrapper with the indicated Mode class and"," ",e.jsx("code",{className:"rounded bg-surface-hover px-1 font-mono",children:"data-theme"}),". Per the two-axis model, Mode-owned tokens (background, foreground, border, disabled) must change between the light/dark columns; Special-owned tokens (",e.jsx("code",{className:"rounded bg-surface-hover px-1 font-mono",children:"--color-theme-*"}),") must change between the (none) / (spring-early) columns;"," ",e.jsx("code",{className:"rounded bg-surface-hover px-1 font-mono",children:"--color-info"})," must remain pinned to blue everywhere."]}),e.jsx("div",{className:"overflow-x-auto rounded-lg border border-border",children:e.jsxs("table",{"aria-labelledby":n,className:"w-full border-collapse text-sm",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-surface-hover text-left",children:[e.jsx("th",{className:"px-3 py-2 font-mono font-semibold text-foreground",children:"token"}),e.jsx("th",{className:"px-3 py-2 font-semibold text-foreground",children:"owner"}),d.map(o=>e.jsx("th",{className:"px-3 py-2 font-mono text-foreground text-xs",children:o.label},o.id))]})}),e.jsx("tbody",{children:L.map(o=>e.jsxs("tr",{className:"border-border border-t",children:[e.jsx("td",{className:"px-3 py-2 font-mono text-foreground text-xs",children:o.name}),e.jsxs("td",{className:"px-3 py-2",children:[e.jsx("span",{className:`rounded px-1.5 py-0.5 font-mono text-xs ${o.owner==="Special"?"bg-theme-100 text-theme-900":o.owner==="Mode"?"bg-info-subtle text-info":"bg-warning-subtle text-warning"}`,children:o.owner}),e.jsx("div",{className:"text-foreground-muted text-xs",children:o.purpose})]}),d.map(a=>e.jsx("td",{className:"px-3 py-2",children:e.jsx("div",{className:`theme-audit-cell ${a.mode==="dark"?"dark":""} inline-flex items-center gap-2 rounded border border-border bg-background p-1`,"data-theme":a.special??void 0,children:e.jsx("span",{className:"inline-block size-5 rounded border border-border",style:{background:`var(${o.name})`},"aria-hidden":"true"})})},a.id))]},o.name))})]})})]})}const t={name:"Cascade Verification",render:()=>e.jsxs("div",{className:"p-6",children:[e.jsx(c,{}),e.jsx("div",{className:"mx-auto max-w-5xl",children:e.jsx(D,{})})]})};var h,p,u,x,g;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(u=(p=r.parameters)==null?void 0:p.docs)==null?void 0:u.source},description:{story:`8 Specials × 2 Modes = 16 cells. Each cell is a scoped theme context, so
...
overriding \`--color-foreground\`) shows up immediately here.`,...(g=(x=r.parameters)==null?void 0:x.docs)==null?void 0:g.description}}};var k,b,f,y,S;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'Per Special',
  argTypes: {
    special: {
...
}`,...(f=(b=s.parameters)==null?void 0:b.docs)==null?void 0:f.source},description:{story:`Renders the showcase for one Special × one Mode at a time, both selected via
...
(\`&args=special:...;mode:...\`).`,...(S=(y=s.parameters)==null?void 0:y.docs)==null?void 0:S.description}}};var v,j,w,N,C;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(w=(j=t.parameters)==null?void 0:j.docs)==null?void 0:w.source},description:{story:`Reads \`getComputedStyle()\` from off-screen cells to show, for each canonical
...
Mode-owned and Special-owned tokens move along their respective axes.`,...(C=(N=t.parameters)==null?void 0:N.docs)==null?void 0:C.description}}};const G=["Overview","PerSpecial","CascadeVerification"];export{t as CascadeVerification,r as Overview,s as PerSpecial,G as __namedExportsOrder,q as default};
