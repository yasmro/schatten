...
}`,...(x=(u=l.parameters)==null?void 0:u.docs)==null?void 0:x.source}}};var b,g,w;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: 'Disabled',
  render: () => <div className="flex flex-col gap-4 w-80">
      <Textarea disabled placeholder="Disabled" rows={3} />
      <Textarea disabled defaultValue="Disabled with value" rows={3} />
    </div>
}`,...(w=(g=o.parameters)==null?void 0:g.docs)==null?void 0:w.source}}};const z=["Playground","Sizes","ErrorState","Disabled"];export{o as Disabled,l as ErrorState,a as Playground,s as Sizes,z as __namedExportsOrder,E as default};
