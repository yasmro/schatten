import{j as e}from"./iframe-D2-cehdT.js";import{C as l}from"./Checkbox-CEYSFYXl.js";import{I as r}from"./Input-CH5dULJx.js";import{R as re,a as o}from"./Radio-DLDdGUEq.js";import{S as le,a as oe,b as te,c as se,d as j}from"./Select-CeOpGZa3.js";import{S as f}from"./Switch-BR1i3P9y.js";import{T as ie}from"./Textarea-BoEHvQ3L.js";import{T as de}from"./Tooltip-CQFAkrO5.js";import{F as a}from"./Field-DyMI1Mmk.js";import"./preload-helper-UdksRuwG.js";import"./index-Cs9tBLXC.js";import"./index-CSIr4LPW.js";import"./index-CobW0wc1.js";import"./index-IPZE5KJp.js";import"./index-NlYxDWqm.js";import"./index-CpwmPzLp.js";import"./field-B_nxVfl8.js";import"./utils-DCADjnpI.js";import"./index-CkIaN0ex.js";import"./index-CrpFtOBQ.js";import"./index-CfmqJ0Nt.js";import"./index-DChLa1vl.js";import"./index-CICq29yE.js";import"./index-B3ioDEvX.js";import"./Combination-CKb1O9qJ.js";import"./index-YxhLHHR3.js";import"./index-d2PKybyz.js";import"./chevron-up-Cx7rmRT4.js";import"./createLucideIcon-CwfbhnG_.js";import"./check-BJ9MtxUe.js";import"./info-DcfbmSyK.js";const Le={title:"Components/lv1/Field",component:a,parameters:{layout:"centered"},tags:["autodocs"],decorators:[v=>e.jsx(de,{delayDuration:100,children:e.jsx(v,{})})],argTypes:{label:{description:"Label text for the field.",control:"text",table:{type:{summary:"ReactNode"}}},description:{description:"Description text displayed above the input.",control:"text",table:{type:{summary:"ReactNode"}}},tooltip:{description:"Tooltip content displayed on hover of info icon next to label.",control:"text",table:{type:{summary:"ReactNode"}}},error:{description:"Error message to display.",control:"text",table:{type:{summary:"string"}}},isError:{description:"Explicitly set error state. If not provided, derived from error prop presence.",control:"boolean",table:{type:{summary:"boolean"}}},required:{description:"Show required indicator (*).",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},disabled:{description:"Disable the field. Propagates to child components via context.",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},flexGrow:{description:"Flex grow factor for layout within FieldSet.",control:"select",options:[void 0,0,1],table:{type:{summary:"0 | 1"}}},flexShrink:{description:"Flex shrink factor for layout within FieldSet.",control:"select",options:[void 0,0,1],table:{type:{summary:"0 | 1"}}},flexBasis:{description:"Flex basis for layout within FieldSet (CSS value).",control:"text",table:{type:{summary:"string"}}}}},t={name:"Playground",args:{label:"Email",description:"We'll never share your email."},render:v=>e.jsx(a,{...v,children:e.jsx(r,{placeholder:"you@example.com"})})},s={name:"With Input",render:()=>e.jsxs("div",{className:"flex flex-col gap-6 w-80",children:[e.jsx(a,{label:"Username",description:"Choose a unique username.",children:e.jsx(r,{placeholder:"johndoe"})}),e.jsx(a,{label:"Email",required:!0,children:e.jsx(r,{type:"email",placeholder:"you@example.com"})})]})},i={name:"With Textarea",render:()=>e.jsx("div",{className:"w-80",children:e.jsx(a,{label:"Bio",description:"Tell us about yourself.",children:e.jsx(ie,{placeholder:"Write something..."})})})},d={name:"With Select",render:()=>e.jsx("div",{className:"w-80",children:e.jsx(a,{label:"Country",description:"Select your country.",children:e.jsxs(le,{children:[e.jsx(oe,{children:e.jsx(te,{placeholder:"Select a country"})}),e.jsxs(se,{children:[e.jsx(j,{value:"us",children:"United States"}),e.jsx(j,{value:"uk",children:"United Kingdom"}),e.jsx(j,{value:"jp",children:"Japan"})]})]})})})},c={name:"With Checkbox",render:()=>e.jsx("div",{className:"w-80",children:e.jsx(a,{label:"Interests",description:"Select your interests.",children:e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(l,{label:"Technology"}),e.jsx(l,{label:"Design"}),e.jsx(l,{label:"Business"})]})})})},n={name:"With Switch",render:()=>e.jsx("div",{className:"w-80",children:e.jsx(a,{label:"Notifications",description:"Enable push notifications.",children:e.jsx(f,{})})})},m={name:"With RadioGroup",render:()=>e.jsx("div",{className:"w-80",children:e.jsx(a,{label:"Plan",description:"Choose your subscription plan.",children:e.jsxs(re,{defaultValue:"free",children:[e.jsx(o,{value:"free",label:"Free"}),e.jsx(o,{value:"pro",label:"Pro"}),e.jsx(o,{value:"enterprise",label:"Enterprise"})]})})})},p={name:"With Tooltip",render:()=>e.jsxs("div",{className:"flex flex-col gap-6 w-80",children:[e.jsx(a,{label:"Email",tooltip:"Used for account recovery and important notifications.",children:e.jsx(r,{type:"email",placeholder:"you@example.com"})}),e.jsx(a,{label:"Password",description:"Must be at least 8 characters.",tooltip:"Use a mix of letters, numbers, and symbols for better security.",required:!0,children:e.jsx(r,{type:"password",placeholder:"Enter password"})})]})},u={name:"Error",render:()=>e.jsxs("div",{className:"flex flex-col gap-6 w-80",children:[e.jsx(a,{label:"Email",error:"Please enter a valid email address.",children:e.jsx(r,{type:"email",defaultValue:"invalid-email"})}),e.jsx(a,{label:"Password",error:"Password must be at least 8 characters.",required:!0,children:e.jsx(r,{type:"password",defaultValue:"123"})})]})},h={name:"Disabled",render:()=>e.jsxs("div",{className:"flex flex-col gap-6 w-80",children:[e.jsx(a,{label:"Username",description:"This field is disabled.",disabled:!0,children:e.jsx(r,{placeholder:"johndoe"})}),e.jsx(a,{label:"Notifications",disabled:!0,children:e.jsx(f,{})})]})},x={name:"Required",render:()=>e.jsxs("div",{className:"flex flex-col gap-6 w-80",children:[e.jsx(a,{label:"Full Name",required:!0,children:e.jsx(r,{placeholder:"John Doe"})}),e.jsx(a,{label:"Email",required:!0,description:"Required field.",children:e.jsx(r,{type:"email",placeholder:"you@example.com"})})]})},b={name:"Label Usage Patterns",render:()=>e.jsxs("div",{className:"flex flex-col gap-8 w-96",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold text-foreground-muted mb-3",children:"Checkbox Group: Field.label for group, Checkbox.label for options"}),e.jsx(a,{label:"Notification settings",description:"Select all that apply.",children:e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(l,{label:"Email notifications"}),e.jsx(l,{label:"Push notifications"}),e.jsx(l,{label:"SMS notifications"})]})})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold text-foreground-muted mb-3",children:"RadioGroup: Field.label for group, Radio.label for options"}),e.jsx(a,{label:"Subscription plan",description:"Choose one plan.",children:e.jsxs(re,{defaultValue:"free",children:[e.jsx(o,{value:"free",label:"Free - Basic features"}),e.jsx(o,{value:"pro",label:"Pro - Advanced features"}),e.jsx(o,{value:"enterprise",label:"Enterprise - Custom solutions"})]})})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold text-foreground-muted mb-3",children:"Switch: Field.label only (single toggle)"}),e.jsx(a,{label:"Enable dark mode",description:"Apply dark theme to the interface.",children:e.jsx(f,{})})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold text-foreground-muted mb-3",children:"Standalone (without Field): Use component label"}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(l,{label:"Remember me"}),e.jsx(f,{label:"Dark mode"})]})]})]})};var y,g,S;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: 'Playground',
  args: {
    label: 'Email',
...
}`,...(S=(g=t.parameters)==null?void 0:g.docs)==null?void 0:S.source}}};var F,w,N;s.parameters={...s.parameters,docs:{...(F=s.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: 'With Input',
...
}`,...(N=(w=s.parameters)==null?void 0:w.docs)==null?void 0:N.source}}};var R,C,W;i.parameters={...i.parameters,docs:{...(R=i.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'With Textarea',
...
}`,...(ae=(ee=b.parameters)==null?void 0:ee.docs)==null?void 0:ae.source}}};const Ae=["Playground","WithInput","WithTextarea","WithSelect","WithCheckbox","WithSwitch","WithRadioGroup","WithTooltip","ErrorState","Disabled","Required","LabelUsagePatterns"];export{h as Disabled,u as ErrorState,b as LabelUsagePatterns,t as Playground,x as Required,c as WithCheckbox,s as WithInput,m as WithRadioGroup,d as WithSelect,n as WithSwitch,i as WithTextarea,p as WithTooltip,Ae as __namedExportsOrder,Le as default};
