...
<!-- Note: .st-icon itself has no CSS body. Tailwind's --minify strips it
  ...
  render: () => <div className="p-8 max-w-4xl mx-auto">
      ...
      <Section id="separator" title="Separator — .st-separator" intro="Visual divider. Orientation comes from the data-orientation attribute (no --horizontal / --vertical modifier)." attributes={[{
