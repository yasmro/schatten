import{j as e}from"./iframe-Jowp87Sr.js";/* empty css              *//* empty css                *//* empty css             *//* empty css                  *//* empty css                *//* empty css             */import"./preload-helper-BYHyCJkK.js";const w={title:"Foundation/CSS API",parameters:{layout:"fullscreen",docs:{description:{component:"# CSS API\n\nSchatten ships both a React component surface and a framework-agnostic\nCSS layer. This page is the **reference catalogue** for the CSS layer:\nevery `.st-*` class consumers can write directly in vanilla HTML, with\nthe matching markup and a11y requirements.\n\n- The class names follow the convention in [css-api.md](.claude/rules/css-api.md):\n  `.st-{block}` / `.st-{block}--{modifier}` / `.st-{block}__{element}`,\n  one axis per modifier, attribute-driven state (`[aria-invalid]`,\n  `[data-state]`, `[data-swipe]`, …).\n- Pixel parity between the React side and the vanilla HTML side is\n  verified per-component in each `{Component}.parity.stories.tsx` and\n  pinned by `{Component}.parity.vrt.spec.ts`.\n\n**Coverage today**: sweep-1 (Separator, Text, Icon) + sweep-2 (Spinner,\nBadge, Callout) of #154. The remaining 12 lv1 components arrive in\nsweep-3 through sweep-7 and will be added here as each sweep lands."}}}},s=({id:r,title:c,intro:m,attributes:n,children:u})=>e.jsxs("section",{id:r,className:"mb-12",children:[e.jsx("h2",{className:"st-text st-text--heading st-text--lg st-text--default mb-2",children:c}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--muted mb-4",children:m}),n&&n.length>0&&e.jsxs("div",{className:"mb-4",children:[e.jsx("h3",{className:"st-text st-text--label st-text--sm st-text--default mb-2",children:"Required attributes for vanilla HTML usage"}),e.jsxs("table",{className:"w-full max-w-2xl text-sm border-collapse",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"border-b border-border",children:[e.jsx("th",{className:"text-left py-1 pr-4 font-medium",children:"Attribute"}),e.jsx("th",{className:"text-left py-1 pr-4 font-medium",children:"Meaning"}),e.jsx("th",{className:"text-left py-1 font-medium",children:"When"})]})}),e.jsx("tbody",{children:n.map(a=>e.jsxs("tr",{className:"border-b border-border",children:[e.jsx("td",{className:"py-1 pr-4 font-mono text-xs",children:a.name}),e.jsx("td",{className:"py-1 pr-4",children:a.meaning}),e.jsx("td",{className:"py-1 text-foreground-muted",children:a.required})]},a.name))})]})]}),e.jsx("div",{className:"rounded-md border border-border p-4 bg-surface",children:u})]}),t=({children:r})=>e.jsx("pre",{className:"mt-3 text-xs bg-surface-hover p-3 rounded overflow-x-auto",children:e.jsx("code",{children:r})}),i={name:"Reference (sweep-1 + sweep-2)",render:()=>e.jsxs("div",{className:"p-8 max-w-4xl mx-auto",children:[e.jsx("h1",{className:"st-text st-text--heading st-text--2xl st-text--default mb-2",children:"CSS API — sweep-1 + sweep-2 reference"}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--muted mb-8",children:"The classes below are emitted by `dist/schatten.css`. Import it once and the markup samples render with no React and no consumer Tailwind setup."}),e.jsxs(s,{id:"separator",title:"Separator — .st-separator",intro:"Visual divider. Orientation is an author configuration and goes through a modifier class (--horizontal / --vertical), matching the css-api.md author-config → modifier principle.",attributes:[{name:"role",meaning:'"separator" for semantic dividers, "none" / omit for decorative',required:"recommended"},{name:"aria-orientation",meaning:"For non-decorative vertical separators (assistive tech announces orientation)",required:'role="separator" + vertical only'},{name:"data-orientation",meaning:"Informational only — Radix emits this on the React side; vanilla HTML may include it for DOM parity but it does not drive styling",required:"optional"}],children:[e.jsxs("div",{className:"w-72 space-y-3",children:[e.jsx("span",{className:"st-text st-text--body st-text--sm st-text--muted",children:"Above"}),e.jsx("div",{className:"st-separator st-separator--horizontal",role:"none"}),e.jsx("span",{className:"st-text st-text--body st-text--sm st-text--muted",children:"Below"})]}),e.jsx(t,{children:`<!-- Decorative -->
...
<!-- Modifier vocabulary -->
<!-- orientation: --horizontal | --vertical -->`})]}),e.jsxs(s,{id:"text",title:"Text — .st-text",intro:"Typography primitive. Five orthogonal axes (variant × size × color × align × truncate), all emitted as side-by-side modifiers — never collapsed.",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx("h2",{className:"st-text st-text--heading st-text--lg st-text--default",children:"Heading lg"}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default",children:"Body md, default color."}),e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--muted",children:"Body sm, muted color."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--error",children:"Body md, error color."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--vermillion",children:"Body md, vermillion (朱)."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default st-text--align-right",children:"Right-aligned body."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default st-text--truncate w-64",children:"A very long line that should be truncated on overflow."})]}),e.jsx(t,{children:`<p class="st-text st-text--body st-text--md st-text--default">Body text.</p>
...
<!-- Note: .st-icon itself has no CSS body. Tailwind's --minify strips it
     ...
     comes from a modifier. -->`})]}),e.jsxs(s,{id:"spinner",title:"Spinner — .st-spinner",intro:"Loading indicator. Two modifier axes (variant × size) plus three sub-element classes used by the ripple-type SVG. Animation timing is exposed via two consumer-overridable CSS variables: --schatten-spinner-duration and --schatten-spinner-ripple-delay.",attributes:[{name:'role="status"',meaning:"Announces the loading state to assistive tech",required:"always"},{name:'aria-hidden="true" (on inner SVG)',meaning:"The SVG is decorative; the visually-hidden label carries the meaning",required:"always"},{name:'<span class="sr-only">…</span>',meaning:"Accessible label rendered visually-hidden",required:"always"}],children:[e.jsxs("div",{className:"flex items-center gap-6",children:[e.jsxs("div",{className:"st-spinner st-spinner--default st-spinner--sm",role:"status",children:[e.jsxs("svg",{className:"size-full animate-spin",viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"3"}),e.jsx("path",{className:"opacity-75",d:"M22 12a10 10 0 0 0-10-10",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round"})]}),e.jsx("span",{className:"sr-only",children:"Loading"})]}),e.jsxs("div",{className:"st-spinner st-spinner--default st-spinner--md",role:"status",children:[e.jsxs("svg",{className:"size-full animate-spin",viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"3"}),e.jsx("path",{className:"opacity-75",d:"M22 12a10 10 0 0 0-10-10",stroke:"currentColor",strokeWidth:"3",strokeLinecap:"round"})]}),e.jsx("span",{className:"sr-only",children:"Loading"})]}),e.jsxs("div",{className:"st-spinner st-spinner--default st-spinner--lg",role:"status",children:[e.jsxs("svg",{className:"size-full",viewBox:"0 0 72 72",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{className:"st-spinner__dot",cx:"36",cy:"36",r:"2.6"}),e.jsx("circle",{className:"st-spinner__ripple-1",cx:"36",cy:"36",r:"10",stroke:"currentColor",strokeWidth:"1.4"}),e.jsx("circle",{className:"st-spinner__ripple-2",cx:"36",cy:"36",r:"10",stroke:"currentColor",strokeWidth:"1.2"})]}),e.jsx("span",{className:"sr-only",children:"Loading"})]})]}),e.jsx(t,{children:`<!-- Default (rotating circle) -->
...
<!-- size       : --sm | --md | --lg -->
<!-- icon-only  : --icon-only (presence-only; square aspect ratio) -->`})]}),e.jsxs(s,{id:"callout",title:"Callout — .st-callout",intro:'Inline status block. Pattern B (tone × shape): five variants × two appearances, with sub-element classes (__icon / __title / __body) for layout. No default ARIA role — pass role="status" (polite) or role="alert" (assertive) for dynamic callouts.',attributes:[{name:"role",meaning:'"status" (polite) or "alert" (assertive) for dynamic callouts; omit for static',required:"when-dynamic"},{name:'aria-hidden="true" (on icon SVG)',meaning:"The icon is decorative; the title text carries the meaning",required:"always (icon)"}],children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx("div",{className:"st-callout st-callout--info st-callout--subtle",children:e.jsxs("div",{className:"flex gap-3 items-start",children:[e.jsxs("svg",{className:"st-callout__icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M12 16v-4"}),e.jsx("path",{d:"M12 8h.01"})]}),e.jsxs("div",{className:"flex min-w-0 flex-1 flex-col gap-1",children:[e.jsx("div",{className:"st-callout__title",children:"Heads up"}),e.jsx("div",{className:"st-callout__body",children:"Subtle appearance — tinted background, tone color text."})]})]})}),e.jsx("div",{className:"st-callout st-callout--error st-callout--solid",children:e.jsxs("div",{className:"flex gap-3 items-start",children:[e.jsxs("svg",{className:"st-callout__icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("line",{x1:"12",x2:"12",y1:"8",y2:"12"}),e.jsx("line",{x1:"12",x2:"12.01",y1:"16",y2:"16"})]}),e.jsxs("div",{className:"flex min-w-0 flex-1 flex-col gap-1",children:[e.jsx("div",{className:"st-callout__title",children:"Failed"}),e.jsx("div",{className:"st-callout__body",children:"Solid appearance — saturated fill, inverted foreground."})]})]})})]}),e.jsx(t,{children:`<div class="st-callout st-callout--info st-callout--subtle" role="status">
...
<!-- The Close button is rendered via .st-btn (sweep-3) — not a Callout sub-element. -->`})]}),e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--subtle mt-8",children:"Coming in subsequent sweeps: Button / Checkbox / Switch (sweep-3), Input / Textarea / Radio (sweep-4), Select / Tooltip (sweep-5), Toast / Dialog (sweep-6), Field / FieldSet (sweep-7)."})]})};var l,o,d;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
<!-- Note: .st-icon itself has no CSS body. Tailwind's --minify strips it
     ...
     comes from a modifier. -->\`}</CodeBlock>
      ...
      <Section id="spinner" title="Spinner — .st-spinner" intro="Loading indicator. Two modifier axes (variant × size) plus three sub-element classes used by the ripple-type SVG. Animation timing is exposed via two consumer-overridable CSS variables: --schatten-spinner-duration and --schatten-spinner-ripple-delay." attributes={[{
      name: 'role="status"',
...
<!-- icon-only  : --icon-only (presence-only; square aspect ratio) -->\`}</CodeBlock>
      ...
      <Section id="callout" title="Callout — .st-callout" intro="Inline status block. Pattern B (tone × shape): five variants × two appearances, with sub-element classes (__icon / __title / __body) for layout. No default ARIA role — pass role=&quot;status&quot; (polite) or role=&quot;alert&quot; (assertive) for dynamic callouts." attributes={[{
      name: 'role',
...
}`,...(d=(o=i.parameters)==null?void 0:o.docs)==null?void 0:d.source}}};const N=["Reference"];export{i as Reference,N as __namedExportsOrder,w as default};
