import{j as e}from"./iframe-DlpSoaIZ.js";import{B as d}from"./Badge-CK3uDOrA.js";import{B as g}from"./Button-BFSv_fOZ.js";import{C as l}from"./Checkbox-D4UAU0iz.js";import{I as f}from"./Input-DbRNXL_v.js";import{R as b,a as c}from"./Radio-DrrWfCkc.js";import{S as v,a as N,b as j,c as y,d as m}from"./Select-D2bwLDV9.js";import{S as w}from"./Spinner-BW6UnaGt.js";import{T as C}from"./Text-Ds4Os0lH.js";import{T as k}from"./Textarea-B3PPp6rX.js";import"./preload-helper-C-OkPrTB.js";import"./index-Bvl14yc8.js";import"./chevron-up-Dqf4WSkV.js";import"./index-DiZijfAW.js";import"./index-B_zhBIfR.js";import"./index-D9nQgjWA.js";import"./index-DQEuQTqQ.js";import"./index-idR-L9s1.js";import"./index-Cd9EWbpk.js";import"./index-CJ6goZUx.js";const W={title:"Welcome",parameters:{layout:"fullscreen"}},r=(t,n)=>{t.preventDefault();const o=`/docs/${n}--docs`;window.parent!==window?window.parent.location.href=`${window.parent.location.origin}/?path=${o}`:window.location.href=`/?path=${o}`},a=({name:t,description:n,children:o,storyPath:i})=>e.jsxs("a",{href:`/docs/${i}--docs`,onClick:u=>r(u,i),className:"group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md",children:[e.jsx("div",{className:"flex items-center justify-center h-40 bg-surface",children:o}),e.jsxs("div",{className:"px-4 py-3 border-t border-border",children:[e.jsx("p",{className:"text-sm font-semibold text-accent group-hover:underline",children:t}),e.jsx("p",{className:"text-xs text-foreground-muted mt-0.5",children:n})]})]}),s={name:"Overview",render:()=>e.jsxs("div",{className:"max-w-4xl mx-auto px-8 py-16",children:[e.jsxs("div",{className:"mb-16",children:[e.jsx("h1",{className:"text-5xl font-bold text-foreground mb-3 tracking-tight",children:"Schatten"}),e.jsxs("p",{className:"text-lg text-foreground-muted leading-relaxed",children:["A design system inspired by Japanese calligraphy — ink on paper.",e.jsx("br",{}),"Built with React, Tailwind CSS, Radix UI, and class-variance-authority."]})]}),e.jsxs("div",{className:"mb-16",children:[e.jsx("h2",{className:"text-xl font-bold text-foreground mb-6",children:"Concept"}),e.jsxs("div",{className:"flex flex-col gap-8",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-base font-semibold text-foreground mb-2",children:"Schatten — the beauty in shadows"}),e.jsxs("p",{className:"text-sm text-foreground-muted leading-relaxed",children:[`"Schatten" is the German word for "shadow." Inspired by Jun'ichiro Tanizaki's`," ",e.jsx("em",{children:"In Praise of Shadows"})," (",e.jsx("span",{className:"font-serif",children:"陰翳礼讃"}),"), this design system finds beauty not in light, but in the subtle interplay of shadow and restraint. Rather than commanding attention with bold decoration and animation, we let the content itself stand forward — through whitespace, muted tones, and quiet refinement."]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-base font-semibold text-foreground mb-2",children:"Ink & Paper — the foundation"}),e.jsxs("p",{className:"text-sm text-foreground-muted leading-relaxed",children:["The color system is built on the metaphor of ",e.jsx("em",{children:"sumi"})," (ink) on ",e.jsx("em",{children:"washi"})," ","(paper). The warmth of handmade paper, the depth of layered ink, and the vermillion seal of a calligrapher's signature — these are not decorations but the DNA of every token and component. Light and dark modes are simply two sides of the same sheet."]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-base font-semibold text-foreground mb-2",children:"Restraint as expression"}),e.jsx("p",{className:"text-sm text-foreground-muted leading-relaxed",children:"A restrained UI is not a lack of design — it is a deliberate choice to let the work speak. Minimal color, subtle transitions, and typographic precision create a quiet confidence. The design recedes so the content can resonate."})]})]})]}),e.jsxs("div",{className:"mb-12",children:[e.jsx("h2",{className:"text-xl font-bold text-foreground mb-4",children:"Components"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4",children:[e.jsx(a,{name:"Button",description:"Triggers actions and events.",storyPath:"components-lv1-button",children:e.jsx(g,{children:"Button"})}),e.jsx(a,{name:"Badge",description:"Displays a status or label.",storyPath:"components-lv1-badge",children:e.jsxs("div",{className:"flex gap-2",children:[e.jsx(d,{children:"Default"}),e.jsx(d,{variant:"outline",children:"Outline"})]})}),e.jsx(a,{name:"Spinner",description:"Indicates a loading state.",storyPath:"components-lv1-spinner",children:e.jsx(w,{})}),e.jsx(a,{name:"Text",description:"Renders styled text content.",storyPath:"components-lv1-text",children:e.jsx(C,{variant:"heading",size:"lg",children:"Heading"})}),e.jsx(a,{name:"Input",description:"Accepts user text input.",storyPath:"components-lv1-input",children:e.jsx(f,{placeholder:"Enter text...",className:"w-40"})}),e.jsx(a,{name:"Textarea",description:"Multi-line text input.",storyPath:"components-lv1-textarea",children:e.jsx(k,{placeholder:"Write something...",className:"w-40",rows:2})}),e.jsx(a,{name:"Checkbox",description:"Toggles a boolean value.",storyPath:"components-lv1-checkbox",children:e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(l,{label:"Option A",defaultChecked:!0}),e.jsx(l,{label:"Option B"})]})}),e.jsx(a,{name:"Select",description:"Picks one option from a list.",storyPath:"components-lv1-select",children:e.jsxs(v,{defaultValue:"apple",children:[e.jsx(N,{className:"w-40",children:e.jsx(j,{})}),e.jsxs(y,{children:[e.jsx(m,{value:"apple",children:"Apple"}),e.jsx(m,{value:"banana",children:"Banana"})]})]})}),e.jsx(a,{name:"Radio",description:"Selects one option from a group.",storyPath:"components-lv1-radio",children:e.jsxs(b,{defaultValue:"a",children:[e.jsx(c,{value:"a",label:"Option A"}),e.jsx(c,{value:"b",label:"Option B"})]})})]})]}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-bold text-foreground mb-4",children:"Foundation"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4",children:[e.jsxs("a",{href:"/docs/foundation-color--docs",onClick:t=>r(t,"foundation-color"),className:"group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md",children:[e.jsx("div",{className:"flex items-center justify-center h-40 bg-surface",children:e.jsx("div",{className:"flex gap-1",children:["bg-solid","bg-foreground-muted","bg-accent","bg-destructive"].map(t=>e.jsx("div",{className:`w-8 h-8 rounded-lg ${t}`},t))})}),e.jsxs("div",{className:"px-4 py-3 border-t border-border",children:[e.jsx("p",{className:"text-sm font-semibold text-accent group-hover:underline",children:"Color"}),e.jsx("p",{className:"text-xs text-foreground-muted mt-0.5",children:"Color tokens and scales."})]})]}),e.jsxs("a",{href:"/docs/foundation-typography--docs",onClick:t=>r(t,"foundation-typography"),className:"group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md",children:[e.jsx("div",{className:"flex items-center justify-center h-40 bg-surface",children:e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx("span",{className:"text-2xl font-bold text-foreground",children:"Aa"}),e.jsx("span",{className:"text-xs text-foreground-muted",children:"Hanken Grotesk"})]})}),e.jsxs("div",{className:"px-4 py-3 border-t border-border",children:[e.jsx("p",{className:"text-sm font-semibold text-accent group-hover:underline",children:"Typography"}),e.jsx("p",{className:"text-xs text-foreground-muted mt-0.5",children:"Font scales and text styles."})]})]})]})]})]})};var p,h,x;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: 'Overview',
  render: () => <div className="max-w-4xl mx-auto px-8 py-16">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          <a href="/docs/foundation-color--docs" onClick={e => navigateToStory(e, 'foundation-color')} className="group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md">
          ...
          <a href="/docs/foundation-typography--docs" onClick={e => navigateToStory(e, 'foundation-typography')} className="group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md">
            <div className="flex items-center justify-center h-40 bg-surface">
...
}`,...(x=(h=s.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};const L=["Overview"];export{s as Overview,L as __namedExportsOrder,W as default};
