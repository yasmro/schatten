...
- Desktop (horizontal): visual order is \`SubAction … Cancel Action\`
  ...
  confirmation lands on the primary action immediately.`,name:"children",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!1,tags:{},type:{name:"ReactNode"}}},tags:{}}}catch{}const Tt={title:"Components/lv1/Dialog",component:u,parameters:{layout:"centered",docs:{description:{component:`Dialog renders a modal overlay for important content or actions —
...
}`,...(ye=(be=A.parameters)==null?void 0:be.docs)==null?void 0:ye.source}}};const _t=["Playground","Confirm","Destructive","WithSubAction","Loading","SubActionLoading","AsyncAction","AsyncSubAction","WithoutCloseButton","InfoOnly","LongContent"];export{B as AsyncAction,w as AsyncSubAction,O as Confirm,C as Destructive,I as InfoOnly,x as Loading,A as LongContent,v as Playground,S as SubActionLoading,D as WithSubAction,k as WithoutCloseButton,_t as __namedExportsOrder,Tt as default};
