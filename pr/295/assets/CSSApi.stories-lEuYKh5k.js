...
<!-- [aria-invalid]    — error styling -->
<!-- :disabled         — disabled tokens -->`})]}),e.jsxs(t,{id:"input",title:"Input — .st-input-wrapper + .st-input",intro:"Two blocks: the wrapper carries layout / border / bg / size modifier / focus-visible ring; the inner <input> is transparent and inherits font / color from the wrapper. State (error / read-only / disabled) is read off the inner input via :has() — vanilla HTML consumers set the matching HTML/ARIA attribute, never a modifier class. The wrapper-click-to-focus ergonomic is React-only — vanilla HTML consumers must click the <input> directly.",attributes:[{name:'aria-invalid="true"',meaning:"Error state — CSS shifts border + bg-subtle + focus-ring via wrapper :has()",required:"when in error"},{name:":disabled / disabled",meaning:"Disabled tokens propagate through :has(.st-input:disabled) on the wrapper",required:"when disabled"},{name:":read-only / readonly",meaning:"Read-only tokens propagate through :has(.st-input:read-only) on the wrapper",required:"when read-only"},{name:"<label for={id}>",meaning:"Associates an external label with the input id (Field provides this)",required:"when externally labelled"}],children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx("div",{className:"st-input-wrapper st-input-wrapper--md w-80",children:e.jsx("input",{type:"email",id:"doc-in-1",className:"st-input",placeholder:"you@example.com"})}),e.jsxs("div",{className:"st-input-wrapper st-input-wrapper--md w-80",children:[e.jsx("span",{className:"st-input__text-left",children:"$"}),e.jsx("input",{type:"text",id:"doc-in-2",className:"st-input",placeholder:"0.00"}),e.jsx("span",{className:"st-input__text-right",children:"USD"})]}),e.jsx("div",{className:"st-input-wrapper st-input-wrapper--md w-80",children:e.jsx("input",{type:"text",id:"doc-in-3",className:"st-input","aria-invalid":"true",defaultValue:"Invalid"})}),e.jsx("div",{className:"st-input-wrapper st-input-wrapper--md w-80",children:e.jsx("input",{type:"text",id:"doc-in-4",className:"st-input",readOnly:!0,defaultValue:"Read-only"})})]}),e.jsx(s,{children:`<div class="st-input-wrapper st-input-wrapper--md">
...
<!-- Precedence (CSS source order):
     ...
     stays on the element so screen readers see the error state. -->`})]}),e.jsxs(t,{id:"textarea",title:"Textarea — .st-textarea",intro:"Single-element form input (no wrapper layer). State (error / read-only / disabled) is expressed as attributes on the textarea itself; the CSS encodes the precedence with source order.",attributes:[{name:'aria-invalid="true"',meaning:"Error state — CSS shifts border + bg-subtle + focus-ring",required:"when in error"},{name:":disabled / disabled",meaning:"Disabled tokens",required:"when disabled"},{name:":read-only / readonly",meaning:"Read-only tokens",required:"when read-only"}],children:[e.jsxs("div",{className:"space-y-3 w-80",children:[e.jsx("textarea",{className:"st-textarea st-textarea--md",rows:3,placeholder:"Tell us about yourself"}),e.jsx("textarea",{className:"st-textarea st-textarea--md",rows:3,"aria-invalid":"true",defaultValue:"Error state"})]}),e.jsx(s,{children:`<textarea class="st-textarea st-textarea--md" rows="3"
...
<!-- Precedence (CSS source order):
     default < [aria-invalid] < :read-only < :disabled -->`})]}),e.jsxs(t,{id:"radio",title:"Radio — .st-radio-group + .st-radio-wrapper + .st-radio",intro:"Three blocks: the group root carries the layout container; each radio is wrapped in inline-flex for [radio] + <label>; the inner block is the Radix Item (the actual radio button). The label's font-size and the dot's size are both derived from the inner radio's size modifier via :has(). Unlike Checkbox, Radix Item Indicator UNMOUNTS when unchecked — vanilla HTML mirrors this by only rendering the indicator chain when checked.",attributes:[{name:'role="radiogroup"',meaning:"On the .st-radio-group root (Radix provides on React side)",required:"always"},{name:'role="radio"',meaning:"On each .st-radio (Radix Item provides on React side)",required:"always"},{name:"aria-checked",meaning:'"true" / "false" on each radio button',required:"always"},{name:"data-state",meaning:'"checked" / "unchecked" — drives the indicator presence (and any future state styling)',required:"always"},{name:'aria-invalid="true"',meaning:"Error state — CSS shifts border + bg-subtle + focus-ring",required:"when in error"}],children:[e.jsxs("div",{role:"radiogroup","aria-label":"doc-radio-example",className:"st-radio-group",children:[e.jsxs("div",{className:"st-radio-wrapper",children:[e.jsx("button",{type:"button",id:"doc-r-1",role:"radio","aria-checked":!1,"data-state":"unchecked",className:"st-radio st-radio--md"}),e.jsx("label",{htmlFor:"doc-r-1",className:"st-radio-wrapper__label",children:"Unchecked"})]}),e.jsxs("div",{className:"st-radio-wrapper",children:[e.jsx("button",{type:"button",id:"doc-r-2",role:"radio","aria-checked":!0,"data-state":"checked",className:"st-radio st-radio--md",children:e.jsx("span",{className:"st-radio__indicator",children:e.jsx("span",{className:"st-radio__dot"})})}),e.jsx("label",{htmlFor:"doc-r-2",className:"st-radio-wrapper__label",children:"Checked"})]})]}),e.jsx(s,{children:`<div role="radiogroup" aria-label="Pick one" class="st-radio-group">
...
<!-- [data-state]      — "checked" / "unchecked" -->
<!-- [aria-invalid]    — error styling -->
<!-- :disabled         — disabled tokens (wrapper :has() also picks this up for label) -->`})]}),e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--subtle mt-8",children:"Coming in subsequent sweeps: Select / Tooltip (sweep-5), Toast / Dialog (sweep-6), Field / FieldSet (sweep-7)."})]})};var o,l,d;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`{
...
<!-- :disabled         — disabled tokens -->\`}</CodeBlock>
      ...
      <Section id="input" title="Input — .st-input-wrapper + .st-input" intro="Two blocks: the wrapper carries layout / border / bg / size modifier / focus-visible ring; the inner <input> is transparent and inherits font / color from the wrapper. State (error / read-only / disabled) is read off the inner input via :has() — vanilla HTML consumers set the matching HTML/ARIA attribute, never a modifier class. The wrapper-click-to-focus ergonomic is React-only — vanilla HTML consumers must click the <input> directly." attributes={[{
      name: 'aria-invalid="true"',
      ...
      required: 'when externally labelled'
        ...
        <div className="space-y-3">
          ...
          <div className="st-input-wrapper st-input-wrapper--md w-80">
            <input type="text" id="doc-in-3" className="st-input" aria-invalid="true" defaultValue="Invalid" />
          </div>
          <div className="st-input-wrapper st-input-wrapper--md w-80">
            <input type="text" id="doc-in-4" className="st-input" readOnly defaultValue="Read-only" />
          </div>
        </div>
...
<!-- Precedence (CSS source order):
     ...
     stays on the element so screen readers see the error state. -->\`}</CodeBlock>
      ...
      <Section id="textarea" title="Textarea — .st-textarea" intro="Single-element form input (no wrapper layer). State (error / read-only / disabled) is expressed as attributes on the textarea itself; the CSS encodes the precedence with source order." attributes={[{
      name: 'aria-invalid="true"',
      meaning: 'Error state — CSS shifts border + bg-subtle + focus-ring',
      required: 'when in error'
    }, {
      ...
      required: 'when read-only'
        ...
        <div className="space-y-3 w-80">
          <textarea className="st-textarea st-textarea--md" rows={3} placeholder="Tell us about yourself" />
          <textarea className="st-textarea st-textarea--md" rows={3} aria-invalid="true" defaultValue="Error state" />
        </div>
...
<!-- Precedence (CSS source order):
     default < [aria-invalid] < :read-only < :disabled -->\`}</CodeBlock>
      ...
      <Section id="radio" title="Radio — .st-radio-group + .st-radio-wrapper + .st-radio" intro="Three blocks: the group root carries the layout container; each radio is wrapped in inline-flex for [radio] + <label>; the inner block is the Radix Item (the actual radio button). The label's font-size and the dot's size are both derived from the inner radio's size modifier via :has(). Unlike Checkbox, Radix Item Indicator UNMOUNTS when unchecked — vanilla HTML mirrors this by only rendering the indicator chain when checked." attributes={[{
      ...
      name: 'data-state',
      meaning: '"checked" / "unchecked" — drives the indicator presence (and any future state styling)',
      required: 'always'
    }, {
      name: 'aria-invalid="true"',
      meaning: 'Error state — CSS shifts border + bg-subtle + focus-ring',
      required: 'when in error'
        ...
        <div role="radiogroup" aria-label="doc-radio-example" className="st-radio-group">
          <div className="st-radio-wrapper">
            ...
            <button type="button" id="doc-r-1" role="radio" aria-checked={false} data-state="unchecked" className="st-radio st-radio--md" />
          ...
          <div className="st-radio-wrapper">
            {/* biome-ignore lint/a11y/useSemanticElements: see preceding comment */}
            <button type="button" id="doc-r-2" role="radio" aria-checked={true} data-state="checked" className="st-radio st-radio--md">
...
}`,...(d=(l=i.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};const L=["Reference"];export{i as Reference,L as __namedExportsOrder,C as default};
