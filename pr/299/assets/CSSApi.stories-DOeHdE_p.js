...
<!-- Modifier vocabulary -->
<!-- orientation: --horizontal | --vertical -->`})]}),e.jsxs(t,{id:"text",title:"Text — .st-text",intro:"Typography primitive. Five orthogonal axes (variant × size × color × align × truncate), all emitted as side-by-side modifiers — never collapsed.",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx("h2",{className:"st-text st-text--heading st-text--lg st-text--default",children:"Heading lg"}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default",children:"Body md, default color."}),e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--muted",children:"Body sm, muted color."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--error",children:"Body md, error color."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--vermillion",children:"Body md, vermillion (朱)."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default st-text--align-right",children:"Right-aligned body."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default st-text--truncate w-64",children:"A very long line that should be truncated on overflow."})]}),e.jsx(a,{children:`<p class="st-text st-text--body st-text--md st-text--default">Body text.</p>
...
<!-- [aria-invalid]    error styling -->
<!-- :disabled         disabled tokens (wrapper :has() recolours label too) -->`})]}),e.jsxs(t,{id:"toast",title:"Toast — .st-toast + .st-toaster",intro:"Transient notification mounted into a portal viewport. The per-toast <li> uses Pattern B (tone × shape) via double-class selectors; the viewport <ol> takes a 6-value --{position} modifier. State (enter / exit / swipe) is expressed as Radix data-attributes — vanilla HTML consumers DO NOT get the animation or auto-dismiss behavior, only the static visual frame.",attributes:[{name:"role",meaning:'"status" for polite announcements, "alert" for assertive',required:"required for vanilla — Radix sets this automatically for React"},{name:"aria-live",meaning:'"polite" (most toasts) or "assertive" (urgent — errors)',required:"required for vanilla — pair with role"},{name:"aria-label",meaning:"On the close button",required:"always"}],children:[e.jsx("div",{className:"relative min-h-[200px]",children:e.jsx("ol",{className:"st-toaster st-toaster--bottom-center",style:{position:"static"},children:e.jsxs("li",{className:"st-toast st-toast--success st-toast--subtle",role:"status","aria-live":"polite",children:[e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"st-toast__icon","aria-hidden":"true",children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"m9 12 2 2 4-4"})]}),e.jsxs("div",{className:"st-toast__content",children:[e.jsx("div",{className:"st-toast__title",children:"Saved"}),e.jsx("div",{className:"st-toast__description",children:"Your changes have been saved successfully."})]}),e.jsx("button",{type:"button",className:"st-btn st-btn--tertiary st-btn--sm st-btn--icon-only","aria-label":"Close",children:e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",width:"16",height:"16",children:[e.jsx("path",{d:"M18 6 6 18"}),e.jsx("path",{d:"m6 6 12 12"})]})})]})})}),e.jsx(a,{children:`<ol class="st-toaster st-toaster--bottom-center">
...
<!-- [data-state="open"|"closed"]  on overlay AND content — drives the
                                    ...
                                    keyframes -->`})]}),e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--subtle mt-8",children:"Coming in subsequent sweeps: Field / FieldSet (sweep-7)."})]})};var o,l,d;i.parameters={...i.parameters,docs:{...(o=i.parameters)==null?void 0:o.docs,source:{originalSource:`{
...
<!-- :disabled         disabled tokens (wrapper :has() recolours label too) -->\`}</CodeBlock>
      ...
      <Section id="toast" title="Toast — .st-toast + .st-toaster" intro="Transient notification mounted into a portal viewport. The per-toast <li> uses Pattern B (tone × shape) via double-class selectors; the viewport <ol> takes a 6-value --{position} modifier. State (enter / exit / swipe) is expressed as Radix data-attributes — vanilla HTML consumers DO NOT get the animation or auto-dismiss behavior, only the static visual frame." attributes={[{
      name: 'role',
      ...
      required: 'always'
        ...
        <div className="relative min-h-[200px]">
          <ol className="st-toaster st-toaster--bottom-center" style={{
          position: 'static'
        }}>
            <li className="st-toast st-toast--success st-toast--subtle" role="status" aria-live="polite">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="st-toast__icon" aria-hidden="true">
                <circle cx="12" cy="12" r="10" />
                <path d="m9 12 2 2 4-4" />
              </svg>
              <div className="st-toast__content">
                <div className="st-toast__title">Saved</div>
                <div className="st-toast__description">
                  Your changes have been saved successfully.
                </div>
              </div>
              <button type="button" className="st-btn st-btn--tertiary st-btn--sm st-btn--icon-only" aria-label="Close">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" width="16" height="16">
                  <path d="M18 6 6 18" />
                  <path d="m6 6 12 12" />
                </svg>
              </button>
...
}`,...(d=(l=i.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};const R=["Reference"];export{i as Reference,R as __namedExportsOrder,q as default};
