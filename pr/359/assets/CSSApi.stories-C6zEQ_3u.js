import{i as e}from"./preload-helper-BwGARNBo.js";import{t}from"./iframe-DRAyPivV.js";import{t as n}from"./Badge-iv_A9Zgt.js";import{t as r}from"./Spinner-B1t0dTgX.js";import{t as i}from"./Button-CaIbaukk.js";import{t as a}from"./Callout-BwFedOvL.js";import{t as o}from"./Checkbox-aDSSUBKZ.js";import{t as s}from"./Separator-wSUK2ZoA.js";import{t as c}from"./Dialog-CkGYS4Vm.js";import{t as l}from"./Input-nCwfNCSi.js";import{t as u}from"./Tooltip-DYR_Ck9V.js";import{t as d}from"./Field-CNGjm2J7.js";import{t as f}from"./Radio-C8AUZv9j.js";import{t as p}from"./Select-eBMPg0Ha.js";import{t as m}from"./Switch-sKlEg1Q2.js";import{t as h}from"./Textarea-OJFcFBdw.js";import{t as g}from"./FieldSet-CzmE6uDM.js";import{t as _}from"./Icon-CQpWRiC2.js";import{t as v}from"./Text-9HhLXuO1.js";import{t as y}from"./Toast-Cb3GGyfd.js";var b,x,S,C,w,T,E;e((()=>{n(),i(),a(),o(),c(),d(),g(),_(),l(),f(),p(),s(),r(),m(),v(),h(),y(),u(),b=t(),x={title:`CSS API/Overview`,parameters:{layout:`fullscreen`,docs:{description:{component:`# CSS API
...
+ sweep-6 (Toast, Dialog) + sweep-7 (Field, FieldSet) of #154.`}}}},S=()=>(0,b.jsx)(`style`,{children:`
  ...
  `}),C=({id:e,title:t,intro:n,attributes:r,children:i})=>(0,b.jsxs)(`section`,{id:e,className:`cssapi-doc__section`,children:[(0,b.jsx)(`h2`,{className:`st-text st-text--heading st-text--lg st-text--default cssapi-doc__title-spacing`,children:t}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--md st-text--muted cssapi-doc__intro-spacing`,children:n}),r&&r.length>0&&(0,b.jsxs)(`div`,{className:`cssapi-doc__attr-wrapper`,children:[(0,b.jsx)(`h3`,{className:`st-text st-text--label st-text--sm st-text--default cssapi-doc__title-spacing`,children:`Required attributes for vanilla HTML usage`}),(0,b.jsxs)(`table`,{className:`cssapi-doc__attr-table`,children:[(0,b.jsx)(`thead`,{children:(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`th`,{scope:`col`,children:`Attribute`}),(0,b.jsx)(`th`,{scope:`col`,children:`Meaning`}),(0,b.jsx)(`th`,{scope:`col`,children:`When`})]})}),(0,b.jsx)(`tbody`,{children:r.map(e=>(0,b.jsxs)(`tr`,{children:[(0,b.jsx)(`td`,{className:`cssapi-doc__attr-name`,children:e.name}),(0,b.jsx)(`td`,{children:e.meaning}),(0,b.jsx)(`td`,{children:e.required})]},e.name))})]})]}),(0,b.jsx)(`div`,{className:`cssapi-doc__panel`,children:i})]}),w=({children:e})=>(0,b.jsx)(`pre`,{className:`cssapi-doc__code`,children:(0,b.jsx)(`code`,{children:e})}),T={name:`Reference (all 18 lv1 components)`,render:()=>(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(S,{}),(0,b.jsxs)(`div`,{className:`cssapi-doc`,children:[(0,b.jsx)(`h1`,{className:`st-text st-text--heading st-text--2xl st-text--default cssapi-doc__title-spacing`,children:`CSS API — every lv1 component`}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--md st-text--muted cssapi-doc__intro-spacing--lg`,children:"The classes below are emitted by `dist/schatten.css`. Import it once and the markup samples render with no React and no consumer Tailwind setup."}),(0,b.jsxs)(C,{id:`separator`,title:`Separator — .st-separator`,intro:`Visual divider. Orientation is an author configuration and goes through a modifier class (--horizontal / --vertical), matching the css-api.md author-config → modifier principle.`,attributes:[{name:`role`,meaning:`"separator" for semantic dividers, "none" / omit for decorative`,required:`recommended`},{name:`aria-orientation`,meaning:`For non-decorative vertical separators (assistive tech announces orientation)`,required:`role="separator" + vertical only`},{name:`data-orientation`,meaning:`Informational only — Radix emits this on the React side; vanilla HTML may include it for DOM parity but it does not drive styling`,required:`optional`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__col-wide cssapi-doc__stack`,children:[(0,b.jsx)(`span`,{className:`st-text st-text--body st-text--sm st-text--muted`,children:`Above`}),(0,b.jsx)(`div`,{className:`st-separator st-separator--horizontal`,role:`none`}),(0,b.jsx)(`span`,{className:`st-text st-text--body st-text--sm st-text--muted`,children:`Below`})]}),(0,b.jsx)(w,{children:`<!-- Decorative -->
...
<!-- Modifier vocabulary -->
<!-- orientation: --horizontal | --vertical -->`})]}),(0,b.jsxs)(C,{id:`text`,title:`Text — .st-text`,intro:`Typography primitive. Five orthogonal axes (variant × size × color × align × truncate), all emitted as side-by-side modifiers — never collapsed.`,children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__stack cssapi-doc__stack--tight`,children:[(0,b.jsx)(`h2`,{className:`st-text st-text--heading st-text--lg st-text--default`,children:`Heading lg`}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--md st-text--default`,children:`Body md, default color.`}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--sm st-text--muted`,children:`Body sm, muted color.`}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--md st-text--error`,children:`Body md, error color.`}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--md st-text--vermillion`,children:`Body md, vermillion (朱).`}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--md st-text--default st-text--align-right`,children:`Right-aligned body.`}),(0,b.jsx)(`p`,{className:`st-text st-text--body st-text--md st-text--default st-text--truncate w-64`,children:`A very long line that should be truncated on overflow.`})]}),(0,b.jsx)(w,{children:`<p class="st-text st-text--body st-text--md st-text--default">Body text.</p>
...
<!-- truncate: --truncate (presence-only) -->`})]}),(0,b.jsxs)(C,{id:`icon`,title:`Icon — .st-icon`,intro:`SVG icon primitive. The root class itself has no CSS body — every visual property lives on a modifier. Pair with any inline SVG (e.g. a Lucide path).`,attributes:[{name:`aria-hidden="true"`,meaning:`Decorative icons`,required:`always (decorative)`},{name:`role="img" + aria-label`,meaning:`Meaningful icons that carry information`,required:`when-applicable`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__row`,children:[(0,b.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,className:`st-icon st-icon--sm st-icon--default`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{cx:`11`,cy:`11`,r:`8`}),(0,b.jsx)(`path`,{d:`m21 21-4.3-4.3`})]}),(0,b.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,className:`st-icon st-icon--md st-icon--error`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{cx:`11`,cy:`11`,r:`8`}),(0,b.jsx)(`path`,{d:`m21 21-4.3-4.3`})]}),(0,b.jsxs)(`svg`,{xmlns:`http://www.w3.org/2000/svg`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,className:`st-icon st-icon--lg st-icon--vermillion`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{cx:`11`,cy:`11`,r:`8`}),(0,b.jsx)(`path`,{d:`m21 21-4.3-4.3`})]})]}),(0,b.jsx)(w,{children:`<svg class="st-icon st-icon--md st-icon--inherit" aria-hidden="true"
...
<!-- Note: .st-icon itself has no CSS body. Tailwind's --minify strips it
     ...
     comes from a modifier. -->`})]}),(0,b.jsxs)(C,{id:`spinner`,title:`Spinner — .st-spinner`,intro:`Loading indicator. Two modifier axes (variant × size) plus six sub-element classes spanning the two animation types (default: rotor / track / arc; ripple: dot / ripple-1 / ripple-2). SVG sizing is handled automatically via the .st-spinner > svg child selector — no Tailwind utility needed. Ripple timing is exposed via two consumer-overridable CSS variables (--st-spinner-duration / --st-spinner-ripple-delay); default-type rotation is hardcoded to 1s linear infinite.`,attributes:[{name:`role="status"`,meaning:`Announces the loading state to assistive tech`,required:`always`},{name:`aria-hidden="true" (on inner SVG)`,meaning:`The SVG is decorative; the visually-hidden label carries the meaning`,required:`always`},{name:`<span class="sr-only">…</span>`,meaning:`Accessible label rendered visually-hidden`,required:`always`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--wide`,children:[(0,b.jsxs)(`div`,{className:`st-spinner st-spinner--default st-spinner--sm`,role:`status`,children:[(0,b.jsxs)(`svg`,{className:`st-spinner__rotor`,viewBox:`0 0 24 24`,fill:`none`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{className:`st-spinner__track`,cx:`12`,cy:`12`,r:`10`,stroke:`currentColor`,strokeWidth:`3`}),(0,b.jsx)(`path`,{className:`st-spinner__arc`,d:`M22 12a10 10 0 0 0-10-10`,stroke:`currentColor`,strokeWidth:`3`,strokeLinecap:`round`})]}),(0,b.jsx)(`span`,{className:`cssapi-doc__sr-only`,children:`Loading`})]}),(0,b.jsxs)(`div`,{className:`st-spinner st-spinner--default st-spinner--md`,role:`status`,children:[(0,b.jsxs)(`svg`,{className:`st-spinner__rotor`,viewBox:`0 0 24 24`,fill:`none`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{className:`st-spinner__track`,cx:`12`,cy:`12`,r:`10`,stroke:`currentColor`,strokeWidth:`3`}),(0,b.jsx)(`path`,{className:`st-spinner__arc`,d:`M22 12a10 10 0 0 0-10-10`,stroke:`currentColor`,strokeWidth:`3`,strokeLinecap:`round`})]}),(0,b.jsx)(`span`,{className:`cssapi-doc__sr-only`,children:`Loading`})]}),(0,b.jsxs)(`div`,{className:`st-spinner st-spinner--default st-spinner--lg`,role:`status`,children:[(0,b.jsxs)(`svg`,{viewBox:`0 0 72 72`,fill:`none`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{className:`st-spinner__dot`,cx:`36`,cy:`36`,r:`2.6`}),(0,b.jsx)(`circle`,{className:`st-spinner__ripple-1`,cx:`36`,cy:`36`,r:`10`,stroke:`currentColor`,strokeWidth:`1.4`}),(0,b.jsx)(`circle`,{className:`st-spinner__ripple-2`,cx:`36`,cy:`36`,r:`10`,stroke:`currentColor`,strokeWidth:`1.2`})]}),(0,b.jsx)(`span`,{className:`cssapi-doc__sr-only`,children:`Loading`})]})]}),(0,b.jsx)(w,{children:`<!-- Default (rotating circle) — SVG carries the rotor + opacity stack -->
...
<!-- Default-type rotation is hardcoded 1s linear infinite. SVG sizing is
     ...
     is required on the inner SVG. -->`})]}),(0,b.jsxs)(C,{id:`badge`,title:`Badge — .st-badge`,intro:`Status descriptor. Pattern B (tone × shape): five variants × three appearances, all written as double-class selectors so every combination shares the same specificity. Includes --icon-only modifier for square icon-only chips.`,attributes:[{name:`role`,meaning:`Set role="img" on icon-only badges so the aria-label is exposed (a bare div is role generic and drops the name)`,required:`when --icon-only`},{name:`aria-label`,meaning:`Required for icon-only badges (no visible text)`,required:`when --icon-only`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__stack`,children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--tight`,children:[(0,b.jsx)(`span`,{className:`cssapi-doc__col-narrow cssapi-doc__label`,children:`subtle`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--neutral st-badge--subtle st-badge--md`,children:`neutral`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--success st-badge--subtle st-badge--md`,children:`success`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--error st-badge--subtle st-badge--md`,children:`error`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--warning st-badge--subtle st-badge--md`,children:`warning`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--info st-badge--subtle st-badge--md`,children:`info`})]}),(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--tight`,children:[(0,b.jsx)(`span`,{className:`cssapi-doc__col-narrow cssapi-doc__label`,children:`solid`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--neutral st-badge--solid st-badge--md`,children:`neutral`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--success st-badge--solid st-badge--md`,children:`success`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--error st-badge--solid st-badge--md`,children:`error`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--warning st-badge--solid st-badge--md`,children:`warning`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--info st-badge--solid st-badge--md`,children:`info`})]}),(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--tight`,children:[(0,b.jsx)(`span`,{className:`cssapi-doc__col-narrow cssapi-doc__label`,children:`outline`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--neutral st-badge--outline st-badge--md`,children:`neutral`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--success st-badge--outline st-badge--md`,children:`success`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--error st-badge--outline st-badge--md`,children:`error`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--warning st-badge--outline st-badge--md`,children:`warning`}),(0,b.jsx)(`div`,{className:`st-badge st-badge--info st-badge--outline st-badge--md`,children:`info`})]})]}),(0,b.jsx)(w,{children:`<!-- variant × appearance combination resolved by double-class selectors -->
...
<!-- size       : --sm | --md | --lg -->
<!-- icon-only  : --icon-only (presence-only; square aspect ratio) -->`})]}),(0,b.jsxs)(C,{id:`callout`,title:`Callout — .st-callout`,intro:`Inline status block. Pattern B (tone × shape): five variants × two appearances. Sub-elements (__icon / __content / __title / __body / __action) sit directly under the block — layout (display: flex) is on .st-callout itself, with align-items auto-switching between center (single-content) and start (multi-line, via :has()). No default ARIA role — pass role="status" (polite) or role="alert" (assertive) for dynamic callouts.`,attributes:[{name:`role`,meaning:`"status" (polite) or "alert" (assertive) for dynamic callouts; omit for static`,required:`when-dynamic`},{name:`aria-hidden="true" (on icon SVG)`,meaning:`The icon is decorative; the title text carries the meaning`,required:`always (icon)`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__stack`,children:[(0,b.jsxs)(`div`,{className:`st-callout st-callout--info st-callout--subtle`,children:[(0,b.jsxs)(`svg`,{className:`st-callout__icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`}),(0,b.jsx)(`path`,{d:`M12 16v-4`}),(0,b.jsx)(`path`,{d:`M12 8h.01`})]}),(0,b.jsxs)(`div`,{className:`st-callout__content`,children:[(0,b.jsx)(`div`,{className:`st-callout__title`,children:`Heads up`}),(0,b.jsx)(`div`,{className:`st-callout__body`,children:`Subtle appearance — tinted background, tone color text.`})]})]}),(0,b.jsxs)(`div`,{className:`st-callout st-callout--error st-callout--solid`,children:[(0,b.jsxs)(`svg`,{className:`st-callout__icon`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,"aria-hidden":`true`,children:[(0,b.jsx)(`circle`,{cx:`12`,cy:`12`,r:`10`}),(0,b.jsx)(`line`,{x1:`12`,x2:`12`,y1:`8`,y2:`12`}),(0,b.jsx)(`line`,{x1:`12`,x2:`12.01`,y1:`16`,y2:`16`})]}),(0,b.jsxs)(`div`,{className:`st-callout__content`,children:[(0,b.jsx)(`div`,{className:`st-callout__title`,children:`Failed`}),(0,b.jsx)(`div`,{className:`st-callout__body`,children:`Solid appearance — saturated fill, inverted foreground.`})]})]})]}),(0,b.jsx)(w,{children:`<!-- Layout is on .st-callout itself — sub-elements sit directly under it -->
...
<!-- Layout alignment is automatic:
       ...
       - title AND body present  → align-items: flex-start  (via :has()) -->`})]}),(0,b.jsxs)(C,{id:`button`,title:`Button — .st-btn`,intro:`Action element. Pattern A (single-axis role): six variants × three sizes plus the --icon-only modifier. Loading state is signalled by aria-busy='true' alongside disabled; CSS routes the cursor to wait and fades the content / spinner overlay sub-elements. The link variant uses a flat DOM (no overlay / content wrapper) and inherits font-size by default so a <a class='st-btn st-btn--link'> embedded in a paragraph follows the surrounding text.`,attributes:[{name:`type="button"`,meaning:`Avoid implicit form submission on <button>`,required:`when inside <form>`},{name:`aria-label`,meaning:`Required for icon-only buttons (no visible text)`,required:`when --icon-only`},{name:`aria-busy="true" + disabled`,meaning:`Loading state — CSS reveals the spinner overlay and switches cursor to wait`,required:`while loading`},{name:`aria-hidden on spinner overlay`,meaning:`Set on .st-btn__spinner-overlay when NOT loading (hide from a11y tree)`,required:`always (toggle inverse of loading)`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__stack`,children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--tight`,children:[(0,b.jsxs)(`button`,{type:`button`,className:`st-btn st-btn--primary st-btn--md`,children:[(0,b.jsx)(`span`,{className:`st-btn__spinner-overlay`,"aria-hidden":`true`}),(0,b.jsx)(`span`,{className:`st-btn__content`,children:`Primary`})]}),(0,b.jsxs)(`button`,{type:`button`,className:`st-btn st-btn--secondary st-btn--md`,children:[(0,b.jsx)(`span`,{className:`st-btn__spinner-overlay`,"aria-hidden":`true`}),(0,b.jsx)(`span`,{className:`st-btn__content`,children:`Secondary`})]}),(0,b.jsxs)(`button`,{type:`button`,className:`st-btn st-btn--tertiary st-btn--md`,children:[(0,b.jsx)(`span`,{className:`st-btn__spinner-overlay`,"aria-hidden":`true`}),(0,b.jsx)(`span`,{className:`st-btn__content`,children:`Tertiary`})]}),(0,b.jsxs)(`button`,{type:`button`,className:`st-btn st-btn--destructive st-btn--md`,children:[(0,b.jsx)(`span`,{className:`st-btn__spinner-overlay`,"aria-hidden":`true`}),(0,b.jsx)(`span`,{className:`st-btn__content`,children:`Destructive`})]})]}),(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--tight`,children:[(0,b.jsx)(`button`,{type:`button`,className:`st-btn st-btn--link st-btn--sm`,children:`Small link`}),(0,b.jsx)(`button`,{type:`button`,className:`st-btn st-btn--link st-btn--md`,children:`Medium link`}),(0,b.jsx)(`button`,{type:`button`,className:`st-btn st-btn--link st-btn--lg`,children:`Large link`})]})]}),(0,b.jsx)(w,{children:`<!-- Non-link variants — keep the __spinner-overlay + __content structure -->
...
<!-- [aria-busy="true"]:disabled     — restores variant colour + cursor: wait -->`})]}),(0,b.jsxs)(C,{id:`checkbox`,title:`Checkbox — .st-checkbox + .st-checkbox-wrapper`,intro:`Two blocks: the wrapper carries the inline-flex layout for [checkbox] + <label>; the inner block is the Radix Root (the actual button). The label's font-size is derived from the inner checkbox's size modifier via :has(), so vanilla HTML consumers only set the size class on the checkbox itself.`,attributes:[{name:`role="checkbox"`,meaning:`Schatten renders Radix Root which already provides the role`,required:`always (Radix-provided)`},{name:`aria-checked`,meaning:`"true" / "false" / "mixed" (mixed for indeterminate)`,required:`always`},{name:`data-state`,meaning:`"checked" / "unchecked" / "indeterminate" — drives the indicator visibility`,required:`always`},{name:`aria-invalid="true"`,meaning:`Error state — CSS shifts border + bg-subtle + focus-ring`,required:`when in error`},{name:`<label for={id}>`,meaning:`Associates with the checkbox via id (the wrapper sees it)`,required:`when label present`}],children:[(0,b.jsx)(`div`,{className:`cssapi-doc__stack`,children:(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--wide`,children:[(0,b.jsxs)(`div`,{className:`st-checkbox-wrapper`,children:[(0,b.jsx)(`button`,{type:`button`,id:`doc-cb-1`,role:`checkbox`,"aria-checked":!1,"data-state":`unchecked`,className:`st-checkbox st-checkbox--md`,children:(0,b.jsx)(`span`,{className:`st-checkbox__indicator`,children:(0,b.jsx)(`svg`,{viewBox:`0 0 16 16`,fill:`none`,"aria-hidden":`true`,children:(0,b.jsx)(`path`,{d:`M2.5 8.5L3.5 7.5L6.5 10.5L12.5 3.5L13.5 4.5L6.5 12.5Z`,fill:`currentColor`})})})}),(0,b.jsx)(`label`,{htmlFor:`doc-cb-1`,className:`st-checkbox-wrapper__label`,children:`Unchecked`})]}),(0,b.jsxs)(`div`,{className:`st-checkbox-wrapper`,children:[(0,b.jsx)(`button`,{type:`button`,id:`doc-cb-2`,role:`checkbox`,"aria-checked":!0,"data-state":`checked`,className:`st-checkbox st-checkbox--md`,children:(0,b.jsx)(`span`,{className:`st-checkbox__indicator`,children:(0,b.jsx)(`svg`,{viewBox:`0 0 16 16`,fill:`none`,"aria-hidden":`true`,children:(0,b.jsx)(`path`,{d:`M2.5 8.5L3.5 7.5L6.5 10.5L12.5 3.5L13.5 4.5L6.5 12.5Z`,fill:`currentColor`})})})}),(0,b.jsx)(`label`,{htmlFor:`doc-cb-2`,className:`st-checkbox-wrapper__label`,children:`Checked`})]}),(0,b.jsxs)(`div`,{className:`st-checkbox-wrapper`,children:[(0,b.jsx)(`button`,{type:`button`,id:`doc-cb-3`,role:`checkbox`,"aria-checked":`mixed`,"data-state":`indeterminate`,className:`st-checkbox st-checkbox--md`,children:(0,b.jsx)(`span`,{className:`st-checkbox__indicator`,children:(0,b.jsx)(`svg`,{viewBox:`0 0 16 16`,fill:`none`,"aria-hidden":`true`,children:(0,b.jsx)(`path`,{d:`M3 8H13`,stroke:`currentColor`,strokeWidth:`2.5`})})})}),(0,b.jsx)(`label`,{htmlFor:`doc-cb-3`,className:`st-checkbox-wrapper__label`,children:`Indeterminate`})]})]})}),(0,b.jsx)(w,{children:`<div class="st-checkbox-wrapper">
...
<!-- :disabled         — disabled tokens (wrapper :has() also picks this up) -->`})]}),(0,b.jsxs)(C,{id:`switch`,title:`Switch — .st-switch + .st-switch-wrapper`,intro:`On/off toggle. Same wrapper + block shape as Checkbox. The thumb's position and the check-icon's opacity are both driven by .st-switch[data-state='checked'] descendant selectors — no Tailwind 'group' utility on the JSX.`,attributes:[{name:`role="switch"`,meaning:`Radix Root provides the role`,required:`always (Radix-provided)`},{name:`aria-checked`,meaning:`"true" / "false" — switches are binary`,required:`always`},{name:`data-state`,meaning:`"checked" / "unchecked" — drives thumb position + check icon visibility`,required:`always`},{name:`aria-invalid="true"`,meaning:`Error state — CSS shifts border + bg + checked-state bg to error tokens`,required:`when in error`}],children:[(0,b.jsx)(`div`,{className:`cssapi-doc__stack`,children:(0,b.jsxs)(`div`,{className:`cssapi-doc__row cssapi-doc__row--wide`,children:[(0,b.jsxs)(`div`,{className:`st-switch-wrapper`,children:[(0,b.jsxs)(`button`,{type:`button`,id:`doc-sw-1`,role:`switch`,"aria-checked":!1,"data-state":`unchecked`,className:`st-switch st-switch--md`,children:[(0,b.jsx)(`span`,{className:`st-switch__check`,children:(0,b.jsx)(`svg`,{viewBox:`0 0 16 16`,fill:`none`,"aria-hidden":`true`,children:(0,b.jsx)(`path`,{d:`M2.5 8.5L3.5 7.5L6.5 10.5L12.5 3.5L13.5 4.5L6.5 12.5Z`,fill:`currentColor`})})}),(0,b.jsx)(`span`,{className:`st-switch__thumb`,"data-state":`unchecked`})]}),(0,b.jsx)(`label`,{htmlFor:`doc-sw-1`,className:`st-switch-wrapper__label`,children:`Off`})]}),(0,b.jsxs)(`div`,{className:`st-switch-wrapper`,children:[(0,b.jsxs)(`button`,{type:`button`,id:`doc-sw-2`,role:`switch`,"aria-checked":!0,"data-state":`checked`,className:`st-switch st-switch--md`,children:[(0,b.jsx)(`span`,{className:`st-switch__check`,children:(0,b.jsx)(`svg`,{viewBox:`0 0 16 16`,fill:`none`,"aria-hidden":`true`,children:(0,b.jsx)(`path`,{d:`M2.5 8.5L3.5 7.5L6.5 10.5L12.5 3.5L13.5 4.5L6.5 12.5Z`,fill:`currentColor`})})}),(0,b.jsx)(`span`,{className:`st-switch__thumb`,"data-state":`checked`})]}),(0,b.jsx)(`label`,{htmlFor:`doc-sw-2`,className:`st-switch-wrapper__label`,children:`On`})]})]})}),(0,b.jsx)(w,{children:`<div class="st-switch-wrapper">
...
<!-- [aria-invalid]    — error styling -->
<!-- :disabled         — disabled tokens -->`})]}),(0,b.jsxs)(C,{id:`input`,title:`Input — .st-input-wrapper + .st-input`,intro:`Single-line text input. Two blocks: the wrapper carries the flex row, border, background, focus ring, and the disabled / readOnly / error surfaces; the inner .st-input is just flex-1 with inherited font + color. State (aria-invalid / read-only / disabled) is read off the inner input via :has() — vanilla HTML consumers set the attributes on the <input> and the wrapper restyles automatically. Sub-elements .st-input__icon-left/right and .st-input__text-left/right inherit sizing from the wrapper size modifier.`,attributes:[{name:`<label for={id}>`,meaning:`Pairs with the inner input via id`,required:`when externally labelled`},{name:`aria-invalid="true"`,meaning:`Error state — wrapper recolors border + background via .st-input-wrapper:has(.st-input[aria-invalid="true"])`,required:`when in error`},{name:`readonly`,meaning:`Warm-tint readOnly surface; value still focusable`,required:`when display-only`},{name:`disabled`,meaning:`Disabled tokens; cursor flips to not-allowed`,required:`when not interactable`},{name:`aria-describedby`,meaning:`Links to description / error message id (Schatten <Field> auto-wires this)`,required:`when description present`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__stack cssapi-doc__col-form`,children:[(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{type:`text`,placeholder:`Default`,className:`st-input`,"aria-label":`doc-input-default`})}),(0,b.jsxs)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:[(0,b.jsx)(`span`,{className:`st-input__text-left`,children:`$`}),(0,b.jsx)(`input`,{type:`number`,placeholder:`0.00`,className:`st-input`,"aria-label":`doc-input-amount`}),(0,b.jsx)(`span`,{className:`st-input__text-right`,children:`USD`})]}),(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{type:`text`,placeholder:`Error`,className:`st-input`,"aria-invalid":`true`,"aria-label":`doc-input-error`})}),(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{type:`text`,defaultValue:`Read-only`,readOnly:!0,className:`st-input`,"aria-label":`doc-input-readonly`})}),(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{type:`text`,defaultValue:`Disabled`,disabled:!0,className:`st-input`,"aria-label":`doc-input-disabled`})})]}),(0,b.jsx)(w,{children:`<div class="st-input-wrapper st-input-wrapper--md">
...
<!-- NB: wrapper-click → focus-input is React-only ergonomics.
     Vanilla HTML consumers click the <input> itself. -->`})]}),(0,b.jsxs)(C,{id:`textarea`,title:`Textarea — .st-textarea`,intro:`Multi-line text input. Single-element primitive: all state (aria-invalid / read-only / disabled) lives on the same <textarea>, so precedence is plain CSS source order (default < error < readOnly < disabled). Same focus ring shape as Input / Checkbox / Switch.`,attributes:[{name:`<label for={id}>`,meaning:`Pairs with the textarea via id`,required:`when externally labelled`},{name:`aria-invalid="true"`,meaning:`Error state — border + bg-subtle + error focus ring`,required:`when in error`},{name:`readonly`,meaning:`Warm-tint readOnly surface`,required:`when display-only`},{name:`disabled`,meaning:`Disabled tokens; wins over readOnly + error on source order`,required:`when not interactable`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__stack cssapi-doc__col-form`,children:[(0,b.jsx)(`textarea`,{rows:3,placeholder:`Default`,className:`st-textarea st-textarea--md`,"aria-label":`doc-textarea-default`}),(0,b.jsx)(`textarea`,{rows:2,placeholder:`Error`,className:`st-textarea st-textarea--md`,"aria-invalid":`true`,"aria-label":`doc-textarea-error`}),(0,b.jsx)(`textarea`,{rows:2,defaultValue:`Read-only`,readOnly:!0,className:`st-textarea st-textarea--md`,"aria-label":`doc-textarea-readonly`}),(0,b.jsx)(`textarea`,{rows:2,defaultValue:`Disabled`,disabled:!0,className:`st-textarea st-textarea--md`,"aria-label":`doc-textarea-disabled`})]}),(0,b.jsx)(w,{children:`<textarea id="bio" rows="4" class="st-textarea st-textarea--md"
...
<!-- [aria-invalid="true"] — error tokens -->
<!-- :read-only            — warm readOnly surface -->
<!-- :disabled             — disabled tokens (wins on source order) -->`})]}),(0,b.jsxs)(C,{id:`radio`,title:`Radio — .st-radio-group + .st-radio-wrapper + .st-radio`,intro:`Single-select group. Three nested levels: the group root (Radix RadioGroup.Root), the per-item wrapper carrying the [radio] + <label> row, and the inner Radix RadioGroup.Item. Radix unmounts the indicator when unchecked, so vanilla HTML consumers omit the .st-radio__indicator element entirely for unchecked items (compare with Checkbox where the indicator is always in the tree).`,attributes:[{name:`role="radiogroup" (on the group root)`,meaning:`Radix RadioGroup.Root provides the role`,required:`always (Radix-provided)`},{name:`role="radio"`,meaning:`Radix RadioGroup.Item provides the role`,required:`always (Radix-provided)`},{name:`aria-checked`,meaning:`"true" or "false" — radios are binary within the group`,required:`always`},{name:`data-state`,meaning:`"checked" / "unchecked" — drives indicator presence`,required:`always`},{name:`aria-invalid="true"`,meaning:`Error state — border + bg-subtle + focus-ring re-colour`,required:`when in error`},{name:`<label for={id}>`,meaning:`Associates with the radio via id (the wrapper sees it)`,required:`when label present`}],children:[(0,b.jsx)(`div`,{className:`cssapi-doc__stack`,children:(0,b.jsxs)(`div`,{role:`radiogroup`,className:`st-radio-group`,children:[(0,b.jsxs)(`div`,{className:`st-radio-wrapper`,children:[(0,b.jsx)(`button`,{type:`button`,id:`doc-radio-a`,role:`radio`,"aria-checked":!1,"data-state":`unchecked`,className:`st-radio st-radio--md`}),(0,b.jsx)(`label`,{htmlFor:`doc-radio-a`,className:`st-radio-wrapper__label`,children:`Option A`})]}),(0,b.jsxs)(`div`,{className:`st-radio-wrapper`,children:[(0,b.jsx)(`button`,{type:`button`,id:`doc-radio-b`,role:`radio`,"aria-checked":!0,"data-state":`checked`,className:`st-radio st-radio--md`,children:(0,b.jsx)(`span`,{className:`st-radio__indicator`,children:(0,b.jsx)(`span`,{className:`st-radio__dot`})})}),(0,b.jsx)(`label`,{htmlFor:`doc-radio-b`,className:`st-radio-wrapper__label`,children:`Option B (selected)`})]}),(0,b.jsxs)(`div`,{className:`st-radio-wrapper`,children:[(0,b.jsx)(`button`,{type:`button`,id:`doc-radio-c`,role:`radio`,"aria-checked":!1,"data-state":`unchecked`,disabled:!0,className:`st-radio st-radio--md`}),(0,b.jsx)(`label`,{htmlFor:`doc-radio-c`,className:`st-radio-wrapper__label`,children:`Option C (disabled)`})]})]})}),(0,b.jsx)(w,{children:`<div role="radiogroup" class="st-radio-group">
...
<!-- close uses --st-duration-base   default 150ms -->`})]}),(0,b.jsxs)(C,{id:`field`,title:`Field — .st-field`,intro:`Layout + a11y wrapper around a single form input. Stacks label / description / children / error vertically and pairs the external <label htmlFor> with the input id. Vanilla HTML consumers wire htmlFor / id / aria-describedby manually — the framework-agnostic CSS does not auto-wire ARIA.`,attributes:[{name:`htmlFor (label) + id (input)`,meaning:`Pairs the external label with the form control`,required:`always when label is present`},{name:`aria-describedby`,meaning:`Links the input to the description / error message id`,required:`when description or error is present`},{name:`aria-invalid="true"`,meaning:`Set on the inner input to drive the error visual (NOT on the .st-field root)`,required:`when the value is invalid`},{name:`data-error="true"`,meaning:`Observability hook on .st-field root — does NOT drive built-in visuals; consumers may attach external styling to it`,required:`optional (mirror of aria-invalid for external observability)`},{name:`data-disabled="true"`,meaning:`Set on .st-field root when the field is disabled`,required:`optional`}],children:[(0,b.jsxs)(`div`,{className:`cssapi-doc__col-form cssapi-doc__stack`,children:[(0,b.jsxs)(`div`,{className:`st-field`,children:[(0,b.jsx)(`div`,{className:`st-field__label-row`,children:(0,b.jsx)(`label`,{htmlFor:`cssapi-field-email`,className:`st-field__label`,children:`Email`})}),(0,b.jsx)(`label`,{htmlFor:`cssapi-field-email`,id:`cssapi-field-email-desc`,className:`st-field__description`,children:`We never share your email`}),(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{id:`cssapi-field-email`,type:`email`,className:`st-input`,defaultValue:`user@example.com`,"aria-describedby":`cssapi-field-email-desc`})})]}),(0,b.jsxs)(`div`,{className:`st-field`,"data-error":`true`,children:[(0,b.jsx)(`div`,{className:`st-field__label-row`,children:(0,b.jsxs)(`label`,{htmlFor:`cssapi-field-name`,className:`st-field__label`,children:[`Name`,(0,b.jsx)(`span`,{className:`st-field__required-marker`,children:`*`})]})}),(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{id:`cssapi-field-name`,className:`st-input`,required:!0,"aria-invalid":`true`,"aria-describedby":`cssapi-field-name-error`})}),(0,b.jsx)(`p`,{id:`cssapi-field-name-error`,className:`st-field__error`,children:`Name is required`})]})]}),(0,b.jsx)(w,{children:`<!-- Basic field (label + description + input) -->
<div class="st-field">
...
<!-- .st-field__error           error <p> below the input            -->`})]}),(0,b.jsxs)(C,{id:`fieldset`,title:`FieldSet — .st-fieldset`,intro:`Group wrapper around multiple Field instances. Uses native <fieldset> + <legend> so disabling the fieldset cascades to every form control inside. Direction (column / row) and wrap layout live on the inner .st-fieldset__children wrapper.`,attributes:[{name:`aria-describedby`,meaning:`Links the fieldset to its description / error message ids`,required:`when description or error is present`},{name:`aria-invalid="true"`,meaning:`Set on the root <fieldset> when the group has an error`,required:`when isError is true`},{name:`disabled`,meaning:`Native <fieldset disabled> — browser cascades to every descendant form control automatically`,required:`when the group is disabled`},{name:`data-error="true" / data-disabled="true"`,meaning:`Observability hooks mirroring aria-invalid / disabled`,required:`optional`}],children:[(0,b.jsxs)(`fieldset`,{className:`st-fieldset`,"aria-describedby":`cssapi-fs-desc`,children:[(0,b.jsx)(`legend`,{className:`st-fieldset__legend`,children:`Personal Info`}),(0,b.jsx)(`p`,{id:`cssapi-fs-desc`,className:`st-fieldset__description`,children:`Optional details`}),(0,b.jsxs)(`div`,{className:`st-fieldset__children`,children:[(0,b.jsxs)(`div`,{className:`st-field`,children:[(0,b.jsx)(`div`,{className:`st-field__label-row`,children:(0,b.jsx)(`label`,{htmlFor:`cssapi-fs-first`,className:`st-field__label`,children:`First name`})}),(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{id:`cssapi-fs-first`,className:`st-input`})})]}),(0,b.jsxs)(`div`,{className:`st-field`,children:[(0,b.jsx)(`div`,{className:`st-field__label-row`,children:(0,b.jsx)(`label`,{htmlFor:`cssapi-fs-last`,className:`st-field__label`,children:`Last name`})}),(0,b.jsx)(`div`,{className:`st-input-wrapper st-input-wrapper--md`,children:(0,b.jsx)(`input`,{id:`cssapi-fs-last`,className:`st-input`})})]})]})]}),(0,b.jsx)(w,{children:`<fieldset class="st-fieldset" aria-describedby="fs-desc">
...
<!-- .st-fieldset__children     inner <div> flex container with the
                                actual fields                            -->
<!-- .st-fieldset__error        group-level error <p>                    -->`})]})]})]})},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
...
}`,...T.parameters?.docs?.source}}},E=[`Reference`]}))();export{T as Reference,E as __namedExportsOrder,x as default};