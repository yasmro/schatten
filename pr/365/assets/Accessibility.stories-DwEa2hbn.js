...
expect(results.violations).toEqual([])`}),e.jsx(o,{children:"The addon-a11y panel"}),e.jsxs(r,{children:["Storybook's ",e.jsx(t,{children:"addon-a11y"})," runs the same axe surface against the rendered story in the ",e.jsx("strong",{children:"Accessibility"})," panel — the dev-time companion to the CI assertion. Because it scans after the theme decorator applies ",e.jsx(t,{children:".dark"})," /"," ",e.jsx(t,{children:"data-theme"}),", toggling the Theme toolbar surfaces dark-mode and seasonal contrast issues for free."]}),e.jsx(o,{children:"Run it"}),e.jsx(C,{children:`pnpm test:a11y    # playwright --grep a11y          → a11y only
