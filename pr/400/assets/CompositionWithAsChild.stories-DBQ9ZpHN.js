...
}`,...o.parameters?.docs?.source},description:{story:"`Text` polymorphism — `as` swaps the semantic tag; `textVariants()` puts\nText styling on an arbitrary element. `Text` does **not** expose\n`asChild` (removed in v0.11.0).",...o.parameters?.docs?.description}}};const P=["Overview","ButtonAsLink","LinkWithButtonVariants","TextPolymorphism"];export{n as ButtonAsLink,r as LinkWithButtonVariants,a as Overview,o as TextPolymorphism,P as __namedExportsOrder,O as default};
