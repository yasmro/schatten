...
}`,...p.parameters?.docs?.source},description:{story:"The auto-season demo: `getCurrentSeason(date)` maps a date onto the eight\nsolar-term periods. VRT skips this story — the season rendering is pinned\nby Eight Seasons, and the date → season mapping is pinned by\n`src/themes/seasonal/index.test.ts`.",...p.parameters?.docs?.description}}};const _e=["EightSeasons","SideBySide","DashboardMockup","AutoSeason"];export{p as AutoSeason,m as DashboardMockup,d as EightSeasons,c as SideBySide,_e as __namedExportsOrder,Ve as default};
