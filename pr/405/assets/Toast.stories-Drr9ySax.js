...
}`,...c.parameters?.docs?.source},description:{story:"`toast.promise()` drives a toast from a promise. The button below fires a\npromise that resolves after ~1.5s, transitioning loading → success.\nInteractive — not captured by VRT.",...c.parameters?.docs?.description}}};const $=["PlaygroundStory","SubtleTreatments","SolidTreatments","WithAction","TitleOnly","LongContent","LongActionLabel","Loading","PromiseDemo"];export{x as Loading,o as LongActionLabel,h as LongContent,p as PlaygroundStory,c as PromiseDemo,u as SolidTreatments,m as SubtleTreatments,g as TitleOnly,v as WithAction,$ as __namedExportsOrder,I as default};
