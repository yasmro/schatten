...
}`,...u.parameters?.docs?.source},description:{story:"A disabled tab is skipped by keyboard navigation and cannot be activated.",...u.parameters?.docs?.description}}};const P=["Playground","Default","WithIcons","Vertical","ManyTabs","DisabledTab"];export{i as Default,u as DisabledTab,d as ManyTabs,m as Playground,l as Vertical,c as WithIcons,P as __namedExportsOrder,I as default};
