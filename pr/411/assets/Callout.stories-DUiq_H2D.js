import{j as e,r as f}from"./iframe-DUrBO3lT.js";import{C as a}from"./Callout-ZFrGx34r.js";import{B as o}from"./Button-D1pSJ9OP.js";import"./preload-helper-C8C2Cx4B.js";import"./utils-DclmTqRz.js";import"./index-BYWyDHmV.js";/* empty css                */import"./circle-alert-vAyq3qit.js";import"./createLucideIcon-DtdF2U7S.js";import"./triangle-alert-C9ynKcEn.js";import"./info-ChpB6JY1.js";import"./x-CEF_q7g5.js";import"./index-CeASAW-y.js";import"./index-BdFAfiMv.js";/* empty css               */import"./Spinner-B8oqB9qp.js";/* empty css                */const P={title:"Components/lv1/Callout",component:a,parameters:{layout:"padded",docs:{description:{component:`Callout displays inline contextual information — beta notices, form
...
require a role.`}}},tags:["autodocs"],argTypes:{variant:{description:"Tone / state variant. Drives the icon, color treatment, and accent.",control:"select",options:["neutral","success","error","warning","info"],table:{type:{summary:'"neutral" | "success" | "error" | "warning" | "info"'},defaultValue:{summary:"neutral"}}},appearance:{description:"Visual appearance — `subtle` for soft tinted background, `solid` for filled.",control:"select",options:["subtle","solid"],table:{type:{summary:'"subtle" | "solid"'},defaultValue:{summary:"subtle"}}},title:{description:"Optional bold heading rendered above the body content.",control:"text"},children:{description:"Body content. Any ReactNode (text, links, lists).",control:"text"},action:{description:"Free-form action node rendered to the right of the body (e.g. a Button or link).",table:{type:{summary:"ReactNode"}},control:!1},onClose:{description:"When provided, a close (X) button is rendered and invokes this callback on click. Omit to render a non-dismissible callout.",table:{type:{summary:"() => void"}},control:!1}}},g=["neutral","success","error","warning","info"],r={name:"Playground",args:{variant:"info",appearance:"subtle",title:"Heads up",children:"This is a beta feature. Behavior may change."}},s={name:"Subtle Treatments",render:()=>e.jsx("div",{className:"flex flex-col gap-3 max-w-xl",children:g.map(t=>e.jsx(a,{variant:t,appearance:"subtle",title:t.toUpperCase(),children:"The quick brown fox jumps over the lazy dog."},t))})},i={name:"Solid Treatments",render:()=>e.jsx("div",{className:"flex flex-col gap-3 max-w-xl",children:g.map(t=>e.jsx(a,{variant:t,appearance:"solid",title:t.toUpperCase(),children:"The quick brown fox jumps over the lazy dog."},t))})},l={name:"Title Only",render:()=>e.jsxs("div",{className:"flex flex-col gap-3 max-w-xl",children:[e.jsx(a,{variant:"success",title:"Saved"}),e.jsx(a,{variant:"error",title:"Could not connect"})]})},c={name:"Body Only",render:()=>e.jsxs("div",{className:"flex flex-col gap-3 max-w-xl",children:[e.jsxs(a,{variant:"info",children:["This feature is in ",e.jsx("strong",{children:"beta"}),". Please share feedback."]}),e.jsxs(a,{variant:"warning",children:["Three records were skipped."," ",e.jsx("a",{href:"#x",className:"underline",children:"View details"})]})]})},d={name:"With Action",render:()=>e.jsxs("div",{className:"flex flex-col gap-3 max-w-xl",children:[e.jsx(a,{variant:"warning",title:"Unsaved changes",action:e.jsx(o,{size:"sm",children:"Save now"}),children:"Your changes will be lost if you leave this page."}),e.jsx(a,{variant:"info",title:"Update available",action:e.jsx(o,{size:"sm",variant:"secondary",children:"Reload"}),children:"A newer version of this app is ready."})]})},p={name:"Solid With Action",parameters:{docs:{description:{story:'On `appearance="solid"` the saturated background can clash with default Button variants. Pass `<Button variant="inverted">` so the action stays legible.'}}},render:()=>e.jsxs("div",{className:"flex flex-col gap-3 max-w-xl",children:[e.jsx(a,{variant:"warning",appearance:"solid",title:"Unsaved changes",action:e.jsx(o,{variant:"inverted",size:"sm",children:"Save now"}),children:"Your changes will be lost if you leave this page."}),e.jsx(a,{variant:"info",appearance:"solid",title:"Update available",action:e.jsx(o,{variant:"inverted",size:"sm",children:"Reload"}),children:"A newer version of this app is ready."})]})},u={name:"Solid Dismissible",parameters:{docs:{description:{story:'The dedicated close button is tone-agnostic (`currentColor` + `color-mix` hover), so it stays legible on a saturated `solid` surface without a per-appearance variant. Covers the close on `solid` in VRT (the subtle case is covered by "Long Content").'}}},render:()=>e.jsxs("div",{className:"flex flex-col gap-3 max-w-xl",children:[e.jsx(a,{variant:"error",appearance:"solid",title:"Failed",onClose:()=>{},children:"Could not connect to the upstream."}),e.jsx(a,{variant:"success",appearance:"solid",title:"Saved",onClose:()=>{},children:"Your changes have been persisted."})]})},m={name:"Dismissible",render:()=>{const[t,n]=f.useState({a:!0,b:!0});return e.jsxs("div",{className:"flex flex-col gap-3 max-w-xl",children:[t.a&&e.jsx(a,{variant:"info",title:"Heads up",onClose:()=>n(x=>({...x,a:!1})),children:"Click the close button to dismiss this callout."}),t.b&&e.jsx(a,{variant:"warning",title:"With action and close",action:e.jsx(o,{size:"sm",children:"Acknowledge"}),onClose:()=>n(x=>({...x,b:!1})),children:"Both action and close can coexist."}),!t.a&&!t.b&&e.jsx(o,{onClick:()=>n({a:!0,b:!0}),children:"Reset"})]})}},h={name:"Full Matrix",parameters:{docs:{description:{story:"Every defined `variant` × `appearance` combination. All five variants support both appearances."}}},render:()=>e.jsx("div",{className:"grid grid-cols-1 gap-3 max-w-2xl",children:["subtle","solid"].map(t=>g.map(n=>e.jsx(a,{variant:n,appearance:t,title:`${n} / ${t}`,children:"The quick brown fox jumps over the lazy dog."},`${n}-${t}`)))})},v={name:"Long Content",render:()=>e.jsx("div",{className:"max-w-xl",children:e.jsx(a,{variant:"warning",title:"Heads up: long-running operation completed with warnings",action:e.jsx(o,{size:"sm",children:"View details"}),onClose:()=>{},children:"Three records were skipped because they did not match the expected schema. You can retry the import after correcting the source file, or proceed with the partial data that has already been saved."})})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  name: 'Playground',
  args: {
    variant: 'info',
    appearance: 'subtle',
