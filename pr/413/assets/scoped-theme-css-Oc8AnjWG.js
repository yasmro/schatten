...
:root {
  ...
  /* emphasis: readable colored text on pale/light surfaces. Define-only for
     destructive (no subtle/standalone-text consumer today) — kept so all five
     interactive states share one 5-token shape. See state-token-guideline.md. */
