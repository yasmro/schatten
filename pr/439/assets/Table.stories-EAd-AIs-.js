...
}`,...t.parameters?.docs?.source},description:{story:"Interactive single instance — toggle `size` / `striped` / `bordered` /\n`hoverable` in the Controls panel.",...t.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: 'Treatments',
...
}`,...m.parameters?.docs?.source},description:{story:'`selected` highlights a row via `data-state="selected"`. Shown here on a\nstriped table — the selected (even) row is tinted, distinct from its\nun-striped neighbours.',...m.parameters?.docs?.description}}};const E=["Playground","Treatments","Sizes","Hoverable","SelectedRow"];export{i as Hoverable,t as Playground,m as SelectedRow,n as Sizes,o as Treatments,E as __namedExportsOrder,C as default};
