import{j as e,r as R}from"./iframe-CSs2helJ.js";import{B as j}from"./Button-BJO6YN-f.js";import{C as k}from"./Callout-CT_RpoqJ.js";import{D as O}from"./Dialog-BqN9H8ez.js";import{F}from"./Field-CzpJp29k.js";import{I as L}from"./Input-DYl6nPQi.js";import{S as B,a as D,b as N,c as I,d as f}from"./Select-ZOt-iDnY.js";import{t as A,T as E}from"./Toaster-xvhhtl8L.js";import{T,a as w,b as S,c as v}from"./Tooltip-CY4i4qyp.js";import{P as o,L as s,C as r,N as i,a as P,D as q,S as l}from"./docs-ui-DdVXBzAw.js";import"./preload-helper-CraBvC-j.js";import"./index-DQjGYOVR.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css               */import"./Spinner-CBUCQWEC.js";/* empty css                *//* empty css                */import"./circle-alert-BVCa8mBl.js";import"./createLucideIcon-CRUcNOCP.js";import"./triangle-alert-Bm9n62m2.js";import"./info-CrjhZmRw.js";import"./x-BipvINRb.js";import"./index-1ZB8kYwj.js";import"./index-BDXJ-qxl.js";import"./index-XdPE8UXm.js";import"./index-D45AH0aX.js";import"./index-CB6jEe4I.js";import"./index-N0ssubxc.js";import"./index-DBk9zXCb.js";import"./Combination-DjsdW9S-.js";/* empty css               */import"./Separator-BeTZR6Tc.js";import"./index-B4vcCu2B.js";/* empty css                  */import"./field-B1Dhvic2.js";/* empty css              *//* empty css              */import"./index-B_mF-kGR.js";import"./index-BZYSJLeW.js";import"./index-D4JGAMy5.js";import"./index-D9jnJE4c.js";import"./index-BGtZofLk.js";import"./index-Bt8Fx3Si.js";/* empty css               */import"./chevron-up-2CqLDYLF.js";import"./check-C4zjIar7.js";/* empty css              *//* empty css                */const Ae={title:"Patterns/Testing",parameters:{layout:"fullscreen"}},a=({children:d})=>e.jsx("div",{className:"max-w-3xl mx-auto px-8 py-12",children:d}),t=({children:d})=>e.jsx("code",{className:"rounded bg-surface px-1 py-0.5 font-mono text-[0.85em] text-foreground",children:d}),n=({label:d,children:c})=>e.jsxs("div",{className:"border border-border rounded-lg p-4 mb-4",children:[e.jsx("h3",{className:"text-xs font-semibold text-foreground-muted uppercase tracking-wide mb-3",children:d}),e.jsx("div",{className:"flex flex-wrap items-center gap-4",children:c})]}),h={name:"Overview",render:()=>e.jsxs(a,{children:[e.jsx(o,{children:"Testing"}),e.jsxs(s,{children:["How to make Schatten components addressable from a consumer E2E suite (Playwright / Cypress / React Testing Library). The plumbing is deliberately thin: components forward"," ",e.jsx(t,{children:"data-testid"})," (and every other unknown DOM attribute) onto their root element — there is no bespoke ",e.jsx(t,{children:"testId"})," prop to learn."]}),e.jsxs(k,{variant:"info",title:"Role first, testid second",children:["Prefer ",e.jsx(t,{children:"getByRole(role, { name })"})," with an accessible name. It is stable across refactors and doubles as an accessibility check. Reach for ",e.jsx(t,{children:"data-testid"})," ","only when a role-based query is ambiguous, unstable, or impossible (anonymous wrappers, repeated rows)."]}),e.jsx(l,{children:"What this page covers"}),e.jsxs("ul",{className:"list-disc pl-6 text-sm text-foreground-muted flex flex-col gap-2",children:[e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Root pass-through"})," — testid lands on the rendered root via ",e.jsx(t,{children:"{...props}"}),"."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Compound components"})," — each sub-part takes its own testid (Select)."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"asChild caveat"})," — with an element child the testid merges onto the child (Tooltip)."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Portal content"})," — testid goes on the Content, and queries scope from the page (Select / Tooltip)."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Curated-props exceptions"})," — Dialog and Toast do not forward arbitrary attributes; address their children or their role."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Naming & no auto-testid"})," — the value is yours to choose; Schatten never injects one."]})]}),e.jsx(l,{children:"Contributor contract"}),e.jsxs(i,{children:["The implementer-facing source of truth is"," ",e.jsx(t,{children:".claude/rules/component-testid-guideline.md"}),". This page is its live, runnable companion — when the rule and this page disagree, the rule wins."]})]})},p={name:"1. data-testid on the root",render:()=>e.jsxs(a,{children:[e.jsx(o,{children:"1. data-testid on the root"}),e.jsxs(s,{children:["Pass ",e.jsx(t,{children:"data-testid"})," like any other DOM attribute. There is no ",e.jsx(t,{children:"testId"})," ","prop — the component spreads ",e.jsx(t,{children:"{...props}"})," onto its rendered root, so the attribute appears on the real element. The same mechanism works for ",e.jsx(t,{children:"data-cy"}),","," ",e.jsx(t,{children:"data-test"}),", or any custom hook."]}),e.jsx(n,{label:"A button with a testid",children:e.jsx(j,{"data-testid":"submit-btn",children:"Save"})}),e.jsx(l,{children:"Rendered DOM"}),e.jsxs(i,{children:["Inspect the button above — the attribute is on the native ",e.jsx(t,{children:"<button>"}),", alongside the public ",e.jsx(t,{children:"st-*"})," classes."]}),e.jsx(r,{children:`<button data-testid="submit-btn" class="st-btn st-btn--primary st-btn--md">
  Save
</button>`}),e.jsx(l,{children:"Selecting it"}),e.jsx(r,{children:`// Playwright
await page.getByTestId('submit-btn').click()

// …but prefer role + name when it is unambiguous:
await page.getByRole('button', { name: 'Save' }).click()`})]})},u={name:"2. Compound components",render:()=>e.jsxs(a,{children:[e.jsx(o,{children:"2. Compound components"}),e.jsxs(s,{children:["Compound components (Select, Tooltip, RadioGroup) are built from named parts, and each part forwards its own props. Put a ",e.jsx(t,{children:"data-testid"})," on whichever parts your test needs — they are independent. Select is the canonical example."]}),e.jsx(n,{label:"Select with a testid on every part (open it)",children:e.jsxs(B,{children:[e.jsx(D,{"data-testid":"country-trigger",className:"w-56",children:e.jsx(N,{placeholder:"Country"})}),e.jsxs(I,{"data-testid":"country-content",children:[e.jsx(f,{value:"jp","data-testid":"country-item-jp",children:"Japan"}),e.jsx(f,{value:"us","data-testid":"country-item-us",children:"United States"})]})]})}),e.jsx(r,{children:`<Select>
...
<TooltipTrigger data-testid="help">
  <Button>Help</Button>
</TooltipTrigger>`})]})},g={name:"4. Portal-rendered content",render:()=>e.jsxs(a,{children:[e.jsx(o,{children:"4. Portal-rendered content"}),e.jsxs(s,{children:[e.jsx(t,{children:"SelectContent"}),", ",e.jsx(t,{children:"TooltipContent"}),", and similar popups render through a Portal into ",e.jsx(t,{children:"document.body"})," — outside ",e.jsx(t,{children:"#storybook-root"})," and outside the trigger's DOM subtree. A selector rooted at the trigger will never reach them by DOM traversal."]}),e.jsx(l,{children:"Two rules"}),e.jsxs("ul",{className:"list-disc pl-6 text-sm text-foreground-muted flex flex-col gap-2 mb-4",children:[e.jsx("li",{children:"Put the testid on the Content element itself, not on the trigger."}),e.jsxs("li",{children:["Scope the query from ",e.jsx(t,{children:"page"})," (Playwright) / ",e.jsx(t,{children:"screen"})," (RTL), not from a trigger-rooted locator."]})]}),e.jsx(n,{label:"Open the select — the listbox is portaled to body",children:e.jsxs(B,{children:[e.jsx(D,{"data-testid":"fruit-trigger",className:"w-56",children:e.jsx(N,{placeholder:"Pick a fruit"})}),e.jsxs(I,{"data-testid":"fruit-content",children:[e.jsx(f,{value:"apple",children:"Apple"}),e.jsx(f,{value:"banana",children:"Banana"}),e.jsx(f,{value:"cherry",children:"Cherry"})]})]})}),e.jsx(r,{children:`// Playwright — open via the trigger, then scope into the portaled content
await page.getByTestId('fruit-trigger').click()
await page
  .getByTestId('fruit-content')
  .getByRole('option', { name: 'Banana' })
  .click()`})]})};function M(){const[d,c]=R.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(j,{"data-testid":"delete-open",onClick:()=>c(!0),children:"Delete account"}),e.jsx(O,{isOpen:d,onOpenChange:c,title:"Delete account",description:"This action cannot be undone.",actionButton:{label:"Delete",variant:"destructive",onClick:()=>c(!1)},cancelButton:{label:"Cancel"},children:e.jsx("p",{"data-testid":"delete-message",children:"Are you sure you want to delete your account?"})})]})}function H(){return e.jsxs(e.Fragment,{children:[e.jsx(j,{onClick:()=>A({title:"Saved successfully",variant:"success"}),children:"Save"}),e.jsx(E,{})]})}const y={name:"5. Curated-props components",render:()=>e.jsxs(a,{children:[e.jsx(o,{children:"5. Curated-props components"}),e.jsxs(s,{children:["A few high-level components take a curated prop surface and do ",e.jsx("strong",{children:"not"})," spread unknown attributes onto their content. For these, address the children you pass in, or query by role + accessible name."]}),e.jsx(P,{children:"Dialog — put the testid on your children"}),e.jsxs(i,{children:["Dialog renders structured props (",e.jsx(t,{children:"title"}),", ",e.jsx(t,{children:"actionButton"}),","," ",e.jsx(t,{children:"cancelButton"}),") and its ",e.jsx(t,{children:"children"})," in the body — it does not forward a"," ",e.jsx(t,{children:"data-testid"})," onto its Content. Put testids on the elements you author, and use"," ",e.jsx(t,{children:"getByRole('dialog', { name })"})," for the frame (Radix sets"," ",e.jsx(t,{children:'role="dialog"'})," and links the title as its name)."]}),e.jsx(n,{label:"Open the dialog (rendered into a Portal)",children:e.jsx(M,{})}),e.jsx(r,{children:`<Dialog title="Delete account" isOpen={open} onOpenChange={setOpen}
...
React Testing Library, with role-first as the default.`,...b.parameters?.docs?.description}}};const Ee=["Overview","RootPassThrough","CompoundComponents","AsChildCaveat","PortalContent","CuratedPropsExceptions","FormFields","NamingAndNoAutoTestid","FrameworkSelectors"];export{m as AsChildCaveat,u as CompoundComponents,y as CuratedPropsExceptions,x as FormFields,b as FrameworkSelectors,C as NamingAndNoAutoTestid,h as Overview,g as PortalContent,p as RootPassThrough,Ee as __namedExportsOrder,Ae as default};
