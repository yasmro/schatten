...
React Testing Library, with role-first as the default.`,...C.parameters?.docs?.description}}};const Ve=["Overview","RootPassThrough","CompoundComponents","AsChildCaveat","PortalContent","CuratedPropsExceptions","FormFields","NamingAndNoAutoTestid","FrameworkSelectors"];export{m as AsChildCaveat,u as CompoundComponents,x as CuratedPropsExceptions,y as FormFields,C as FrameworkSelectors,b as NamingAndNoAutoTestid,h as Overview,g as PortalContent,p as RootPassThrough,Ve as __namedExportsOrder,He as default};
