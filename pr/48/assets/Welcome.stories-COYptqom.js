import{j as e}from"./iframe-BgFI21VY.js";import{B as c}from"./Badge-BhvrHbVh.js";import{B as b}from"./Button-Bmkq8Qed.js";import{C as m}from"./Checkbox-C0ghM-Qs.js";import"./field-CBY_jlPE.js";import{F as v}from"./Field-CVxGCT9K.js";import{I as p}from"./Input-YOszpSiq.js";import{R as y,a as h}from"./Radio-BXrJFWIc.js";import{S as N,a as j,b as w,c as C,d as x}from"./Select-ByL93c5p.js";import{S as k}from"./Spinner-DeHXHqTv.js";import{S}from"./Switch-BmhU9myl.js";import{T}from"./Text-DU11Y2hT.js";import{T as P}from"./Textarea-bkIZ4WG0.js";import"./preload-helper-DT0q8JqK.js";import"./index-BWQqXIGr.js";import"./chevron-up-IfM0cR0c.js";import"./index-DHk-Frat.js";import"./index-nlOnA0i1.js";import"./index-BcT_uTsb.js";import"./index-CYgffu45.js";import"./index-CxydGQv5.js";import"./index-B9I01__a.js";import"./index-0y8tt3hn.js";const X={title:"Welcome",parameters:{layout:"fullscreen"}},d=(o,r,i="docs")=>{o.preventDefault();const s=`/docs/${r}--${i}`,a=window.parent!==window?window.parent:window,l=new URL(a.location.href);l.searchParams.set("path",s),a.location.href=l.toString()},t=({name:o,description:r,children:i,storyPath:s})=>e.jsxs("a",{href:`/docs/${s}--docs`,onClick:a=>d(a,s),className:"group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md",children:[e.jsx("div",{className:"flex items-center justify-center h-40 bg-surface",onClick:a=>{a.preventDefault(),a.stopPropagation()},children:i}),e.jsxs("div",{className:"px-4 py-3 border-t border-border",children:[e.jsx("p",{className:"text-sm font-semibold text-accent group-hover:underline",children:o}),e.jsx("p",{className:"text-xs text-foreground-muted mt-0.5",children:r})]})]}),n={name:"Overview",render:()=>e.jsxs("div",{className:"max-w-4xl mx-auto px-8 py-16",children:[e.jsxs("div",{className:"mb-16",children:[e.jsx("h1",{className:"text-5xl font-bold text-foreground mb-3 tracking-tight",children:"Schatten"}),e.jsxs("p",{className:"text-lg text-foreground-muted leading-relaxed",children:["A design system inspired by Japanese calligraphy — ink on paper.",e.jsx("br",{}),"Built with React, Tailwind CSS, Radix UI, and class-variance-authority."]})]}),e.jsxs("div",{className:"mb-16",children:[e.jsx("h2",{className:"text-xl font-bold text-foreground mb-6",children:"Concept"}),e.jsxs("div",{className:"flex flex-col gap-8",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-base font-semibold text-foreground mb-2",children:"Schatten — the beauty in shadows"}),e.jsxs("p",{className:"text-sm text-foreground-muted leading-relaxed",children:[`"Schatten" is the German word for "shadow." Inspired by Jun'ichiro Tanizaki's`," ",e.jsx("em",{children:"In Praise of Shadows"})," (",e.jsx("span",{className:"font-serif",children:"陰翳礼讃"}),"), this design system finds beauty not in light, but in the subtle interplay of shadow and restraint. Rather than commanding attention with bold decoration and animation, we let the content itself stand forward — through whitespace, muted tones, and quiet refinement."]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-base font-semibold text-foreground mb-2",children:"Ink & Paper — the foundation"}),e.jsxs("p",{className:"text-sm text-foreground-muted leading-relaxed",children:["The color system is built on the metaphor of ",e.jsx("em",{children:"sumi"})," (ink) on ",e.jsx("em",{children:"washi"})," ","(paper). The warmth of handmade paper, the depth of layered ink, and the vermillion seal of a calligrapher's signature — these are not decorations but the DNA of every token and component. Light and dark modes are simply two sides of the same sheet."]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-base font-semibold text-foreground mb-2",children:"Restraint as expression"}),e.jsx("p",{className:"text-sm text-foreground-muted leading-relaxed",children:"A restrained UI is not a lack of design — it is a deliberate choice to let the work speak. Minimal color, subtle transitions, and typographic precision create a quiet confidence. The design recedes so the content can resonate."})]})]})]}),e.jsxs("div",{className:"mb-12",children:[e.jsx("h2",{className:"text-xl font-bold text-foreground mb-4",children:"UI Components"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4",children:[e.jsx(t,{name:"Button",description:"Triggers actions and events.",storyPath:"components-lv1-button",children:e.jsx(b,{children:"Button"})}),e.jsx(t,{name:"Badge",description:"Displays a status or label.",storyPath:"components-lv1-badge",children:e.jsxs("div",{className:"flex gap-2",children:[e.jsx(c,{children:"Default"}),e.jsx(c,{variant:"outline",children:"Outline"})]})}),e.jsx(t,{name:"Spinner",description:"Indicates a loading state.",storyPath:"components-lv1-spinner",children:e.jsx(k,{})}),e.jsx(t,{name:"Text",description:"Renders styled text content.",storyPath:"components-lv1-text",children:e.jsx(T,{variant:"heading",size:"lg",children:"Heading"})})]})]}),e.jsxs("div",{className:"mb-12",children:[e.jsx("h2",{className:"text-xl font-bold text-foreground mb-4",children:"Form Components"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4",children:[e.jsx(t,{name:"Field",description:"Wraps inputs with label and error.",storyPath:"components-lv1-field",children:e.jsx(v,{label:"Email",description:"Your email address.",children:e.jsx(p,{placeholder:"you@example.com",className:"w-40"})})}),e.jsx(t,{name:"Input",description:"Accepts user text input.",storyPath:"components-lv1-input",children:e.jsx(p,{placeholder:"Enter text...",className:"w-40"})}),e.jsx(t,{name:"Textarea",description:"Multi-line text input.",storyPath:"components-lv1-textarea",children:e.jsx(P,{placeholder:"Write something...",className:"w-40",rows:2})}),e.jsx(t,{name:"Select",description:"Picks one option from a list.",storyPath:"components-lv1-select",children:e.jsxs(N,{defaultValue:"apple",children:[e.jsx(j,{className:"w-40",children:e.jsx(w,{})}),e.jsxs(C,{children:[e.jsx(x,{value:"apple",children:"Apple"}),e.jsx(x,{value:"banana",children:"Banana"})]})]})}),e.jsx(t,{name:"Checkbox",description:"Toggles a boolean value.",storyPath:"components-lv1-checkbox",children:e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx(m,{label:"Option A",defaultChecked:!0}),e.jsx(m,{label:"Option B"})]})}),e.jsx(t,{name:"Radio",description:"Selects one option from a group.",storyPath:"components-lv1-radio",children:e.jsxs(y,{defaultValue:"a",children:[e.jsx(h,{value:"a",label:"Option A"}),e.jsx(h,{value:"b",label:"Option B"})]})}),e.jsx(t,{name:"Switch",description:"Toggles between on and off.",storyPath:"components-lv1-switch",children:e.jsx(S,{label:"Enable",defaultChecked:!0})})]})]}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-bold text-foreground mb-4",children:"Foundation"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4",children:[e.jsxs("a",{href:"/docs/foundation-color--colors",onClick:o=>d(o,"foundation-color","colors"),className:"group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md",children:[e.jsx("div",{className:"flex items-center justify-center h-40 bg-surface",children:e.jsx("div",{className:"flex gap-1",children:["bg-solid","bg-foreground-muted","bg-accent","bg-destructive"].map(o=>e.jsx("div",{className:`w-8 h-8 rounded-lg ${o}`},o))})}),e.jsxs("div",{className:"px-4 py-3 border-t border-border",children:[e.jsx("p",{className:"text-sm font-semibold text-accent group-hover:underline",children:"Color"}),e.jsx("p",{className:"text-xs text-foreground-muted mt-0.5",children:"Color tokens and scales."})]})]}),e.jsxs("a",{href:"/docs/foundation-typography--typography",onClick:o=>d(o,"foundation-typography","typography"),className:"group block border border-border rounded-xl overflow-hidden no-underline transition-shadow duration-200 hover:shadow-md",children:[e.jsx("div",{className:"flex items-center justify-center h-40 bg-surface",children:e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx("span",{className:"text-2xl font-bold text-foreground",children:"Aa"}),e.jsx("span",{className:"text-xs text-foreground-muted",children:"Hanken Grotesk"})]})}),e.jsxs("div",{className:"px-4 py-3 border-t border-border",children:[e.jsx("p",{className:"text-sm font-semibold text-accent group-hover:underline",children:"Typography"}),e.jsx("p",{className:"text-xs text-foreground-muted mt-0.5",children:"Font scales and text styles."})]})]})]})]})]})};var u,g,f;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: 'Overview',
...
}`,...(f=(g=n.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};const Z=["Overview"];export{n as Overview,Z as __namedExportsOrder,X as default};
