...
pnpm test:vrt     # playwright test --grep-invert a11y    → screenshots only`}),(0,V.jsx)(F,{children:`Status: blocking gate`}),(0,V.jsxs)(N,{children:[`The CI a11y job `,(0,V.jsx)(`strong`,{children:`blocks`}),` (#346) — it propagates the Playwright exit code, so a new WCAG 2.1 A/AA violation fails the PR (the full violation list is still tee'd into the job summary). The only `,(0,V.jsx)(W,{children:`color-contrast`}),` findings that remain are the intentional exceptions inventoried on the `,(0,V.jsx)(`strong`,{children:`Contrast`}),` page of this section, each suppressed with a documented, story-scoped`,` `,(0,V.jsx)(W,{children:`disableRules(['color-contrast'])`}),`. One other rule id carries a documented exception: `,(0,V.jsx)(W,{children:`aria-hidden-focus`}),` on open Radix poppers (Select / DropdownMenu / Popover) — while open, Radix hides the page behind the popper via`,` `,(0,V.jsx)(W,{children:`aria-hidden`}),` but leaves the trigger focusable, a known Radix behavior not fixable from Schatten; the disable is scoped to the open-state a11y tests only. These two rule ids are the `,(0,V.jsx)(`em`,{children:`entire`}),` allowed set (see`,` `,(0,V.jsx)(W,{children:`.claude/rules/vrt-spec-guideline.md`}),` §a11y assertions). The addon panel's`,` `,(0,V.jsx)(W,{children:`test`}),` flag is `,(0,V.jsx)(W,{children:`off`}),` so its headless preview run does not race the Playwright suite; addon-a11y stays the on-demand dev companion — click`,` `,(0,V.jsx)(`strong`,{children:`Rerun`}),` in the Accessibility panel to scan the current story.`]})]})},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  name: 'Overview',
  render: () => <Page>
...
(#148), pinned to the WCAG 2.1 A/AA tag set. The CI gate is blocking (#346).`,...Q.parameters?.docs?.description}}},$=[`Overview`,`FocusVisibility`,`AriaConventions`,`Contrast`,`Keyboard`,`ScreenReader`,`AutomatedTesting`]}))();export{J as AriaConventions,Q as AutomatedTesting,Y as Contrast,q as FocusVisibility,X as Keyboard,K as Overview,Z as ScreenReader,$ as __namedExportsOrder,H as default};