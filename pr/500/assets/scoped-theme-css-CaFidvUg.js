import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{r as t,t as n}from"./seasonal-D3DrcYmt.js";var r,i=e((()=>{r=`/*
 * Semantic Tokens (lv2)
...
`}));function s(e,t){let n=e.replace(/\/\*[\s\S]*?\*\//g,``),r=n.indexOf(t);if(r===-1)throw Error(`scoped-theme-css: block "${t}" not found in semantic.css`);let i=n.slice(r,n.indexOf(`}`,r)).match(/--color-solid[\w-]*:\s*[^;]+;/g);if(!i||i.length===0)throw Error(`scoped-theme-css: no --color-solid* declarations in "${t}"`);return i.join(`
  `)}function c(e,t){return`${t.seasonalCss.replace(/:root\[/g,`${e}[`)}\n${[`${e}[data-theme] {\n  ${s(t.semanticCss,`:root {`)}\n}`,`${e}.dark[data-theme] {\n  ${s(t.semanticCss,`.dark {`)}\n}`].join(`
`)}`}var l,u=e((()=>{t(),l=Object.values(n).map(e=>{let[t=``,n=``]=(e.description??``).split(`: `);return{id:e.name,label:e.name.replace(`season--`,``).split(`-`).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(` `),term:t,colors:n}})}));export{a,o as i,c as n,i as o,u as r,r as s,l as t};