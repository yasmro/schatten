...
}`,...l.parameters?.docs?.source},description:{story:"`plain` reads best on a non-default surface. On a tinted panel, `filled` keeps\nits own white fill and stands out, while `plain` lets the surface show through\n— useful for nested or low-emphasis grouping.",...l.parameters?.docs?.description}}};const H=["Playground","Composition","ContentOnly","Variants","OnSurface"];export{i as Composition,o as ContentOnly,l as OnSurface,n as Playground,d as Variants,H as __namedExportsOrder,b as default};
