import{j as e,r as B}from"./iframe-Q-7Zj3Ct.js";import{B as i}from"./Button-DuXjAE-j.js";import{C as j}from"./Callout-BWupUnzj.js";import{C as R}from"./Checkbox-BwFLcAhv.js";import{D as I}from"./Dialog-C0RbHrLD.js";import{F as P}from"./Field-DqmmbesY.js";import{I as w}from"./Input-CO3DmhYo.js";import{R as D,a as v}from"./Radio-D_MNLueB.js";import{S as k,a as T,b as S,c as A,d as y}from"./Select-ptF1rbM-.js";import{S as E}from"./Switch-CKCUxOiq.js";import{T as N}from"./Text-Bu9UCibx.js";import{P as s,L as l,S as n,D as f,N as o,C,a as F}from"./docs-ui-D0Lzeezu.js";import{S as L}from"./search-Bm_PVIJL.js";import"./preload-helper-DUSBS5vW.js";import"./index-DPnazUT8.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css               */import"./Spinner-QdpqgASa.js";/* empty css                *//* empty css                */import"./circle-alert-DVeCNbaT.js";import"./createLucideIcon-BWa8aq_-.js";import"./triangle-alert-F1hZ--OF.js";import"./info-CK878LKv.js";import"./x-48ATuIqe.js";import"./index-8k5_Nd5T.js";import"./index-C_iVNB6w.js";import"./index-C5S3HOSI.js";import"./index-C88_IEkQ.js";import"./index-B0VBQZoU.js";import"./index-Qm0ZzbsL.js";import"./index-BLsZNQv9.js";import"./field-BvkRLkeB.js";/* empty css                 */import"./index-D-IzIQ0Z.js";import"./index-C7GoUSIM.js";import"./index-DzDeP3Xp.js";import"./Combination-BgBsTrHT.js";/* empty css               */import"./Separator-DIRN6NFX.js";/* empty css                  */import"./Tooltip-5cWwGC0k.js";import"./index-CSH6R3SF.js";import"./index-Ct3YrYPq.js";/* empty css                *//* empty css              *//* empty css              */import"./index-DW_SMBTO.js";import"./index-CBUZgVJW.js";/* empty css              *//* empty css               */import"./chevron-up-BwuD6fXW.js";import"./check-BUtLorq3.js";/* empty css               *//* empty css             */const We={title:"Patterns/Accessibility",parameters:{layout:"fullscreen"}},d=({children:r})=>e.jsx("div",{className:"max-w-3xl mx-auto px-8 py-12",children:r}),t=({children:r})=>e.jsx("code",{className:"rounded bg-surface px-1 py-0.5 font-mono text-[0.85em] text-foreground",children:r}),a=({label:r,children:c})=>e.jsxs("div",{className:"border border-border rounded-lg p-4 mb-4",children:[e.jsx("h3",{className:"text-xs font-semibold text-foreground-muted uppercase tracking-wide mb-3",children:r}),e.jsx("div",{className:"flex flex-wrap items-center gap-4",children:c})]}),h={name:"Overview",render:()=>e.jsxs(d,{children:[e.jsx(s,{children:"Accessibility"}),e.jsxs(l,{children:["Schatten targets ",e.jsx("strong",{children:"WCAG 2.1 AA"}),". Every lv1 component ships a stable accessibility surface — an explicit role, a queryable accessible name, keyboard operability, and ",e.jsx(t,{children:"aria-*"})," state wiring — so that consuming apps can select components by"," ",e.jsxs(t,{children:["getByRole(role, ","{ name }",")"]})," instead of by class names or DOM structure. This page is the cross-cutting reference for that contract; the per-area detail lives in the sibling sections."]}),e.jsx(n,{children:"Principles at a glance"}),e.jsxs(o,{children:["Each principle below maps to its own section in this page (see the sidebar under"," ",e.jsx(t,{children:"Patterns/Accessibility"}),")."]}),e.jsxs("ul",{className:"list-disc pl-6 text-sm text-foreground-muted flex flex-col gap-2",children:[e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Focus visibility"})," — every interactive element renders a visible focus ring on keyboard focus."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"ARIA conventions"})," — error / busy / description state is expressed through standard attributes, often wired automatically by"," ",e.jsx(t,{children:"Field"}),"."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Color contrast"})," — text and UI affordances meet the AA contrast lines in both Modes."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Keyboard"})," — all interactive elements are reachable and operable from the keyboard; compound widgets follow their ARIA pattern."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Screen reader"})," — decorative icons are hidden; meaning is carried by text and role, never by color alone."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Automated testing"})," — axe runs in every VRT spec and in the Storybook a11y panel."]})]}),e.jsx(n,{children:"Contributor contracts"}),e.jsxs(o,{children:["The authoritative, implementer-facing sources of truth are"," ",e.jsx(t,{children:".claude/rules/component-architecture.md §8"})," (the a11y contract every lv1 must satisfy), ",e.jsx(t,{children:".claude/rules/field-context-guideline.md"})," (how form state and descriptions are wired), and ",e.jsx(t,{children:".claude/rules/state-token-guideline.md"})," (the contrast-audited state tokens)."]}),e.jsx(n,{children:"Out of scope"}),e.jsxs(o,{children:["WCAG ",e.jsx("strong",{children:"AAA"})," and a dedicated high-contrast mode are future work (Phase 5). Internationalization (i18n) of component copy is also out of scope for this page."]})]})},u={name:"Focus visibility",render:()=>e.jsxs(d,{children:[e.jsx(s,{children:"Focus visibility"}),e.jsxs(l,{children:["Every interactive component renders a visible focus ring when it receives"," ",e.jsx("strong",{children:"keyboard"})," focus. The ring is keyed to ",e.jsx(t,{children:":focus-visible"}),", not"," ",e.jsx(t,{children:":focus"}),", so a plain mouse click does not flash a ring — only keyboard navigation (or other non-pointer focus) shows it."]}),e.jsx(n,{children:"Try it"}),e.jsxs(o,{children:["Press ",e.jsx(t,{children:"Tab"})," to move focus across the row below and watch the ring appear. Toggle the Storybook ",e.jsx("strong",{children:"Theme"})," toolbar between light and dark — the ring stays visible in both Modes."]}),e.jsxs(a,{label:"Tab through these",children:[e.jsx(i,{children:"Primary"}),e.jsx(i,{variant:"secondary",children:"Secondary"}),e.jsx(i,{variant:"link",children:"Link"}),e.jsx(w,{"aria-label":"Sample input",placeholder:"Input",className:"w-40"}),e.jsx(R,{label:"Checkbox"}),e.jsx(E,{label:"Switch"}),e.jsxs(k,{children:[e.jsx(T,{"aria-label":"Select demo",className:"w-40",children:e.jsx(S,{placeholder:"Select"})}),e.jsxs(A,{children:[e.jsx(y,{value:"a",children:"Option A"}),e.jsx(y,{value:"b",children:"Option B"})]})]})]}),e.jsx(n,{children:"How it is implemented"}),e.jsxs(o,{children:["The ring is a ",e.jsx(t,{children:"box-shadow"})," authored in each component's own"," ",e.jsx(t,{children:".st-{block}:focus-visible"})," rule (not a utility baked into a CVA base class). It reads two semantic tokens: ",e.jsx(t,{children:"--color-ring"})," (ink-black in light, inverted in dark) and ",e.jsx(t,{children:"--color-ring-offset"})," (the surface gap), so the indicator re-colors automatically per Mode."]}),e.jsx(C,{children:`/* Button.css */
.st-btn:focus-visible {
  box-shadow:
    0 0 0 2px var(--color-ring-offset),
    0 0 0 4px var(--color-ring);
}`}),e.jsx(o,{children:"Never strip this ring to fit a layout. If it clashes with a saturated surface, override the ring color for contrast — do not remove the indicator."})]})},p={name:"ARIA conventions",render:()=>e.jsxs(d,{children:[e.jsx(s,{children:"ARIA conventions"}),e.jsxs(l,{children:["State is expressed through standard ARIA / HTML attributes, not bespoke classes. The same attribute that drives the visual also announces the state to assistive tech, so the two can never drift apart. Inside a ",e.jsx(t,{children:"Field"}),", most of this wiring is automatic."]}),e.jsx(n,{children:"Required attributes by component"}),e.jsx(f,{headers:["Component","Attribute","Source"],rows:[{key:"form-invalid",cells:["Input / Textarea / Select / Checkbox / Switch / Radio",e.jsx(t,{children:"aria-invalid"},"c"),"Set from isError (or inherited from Field)."]},{key:"form-describedby",cells:["Form inputs",e.jsx(t,{children:"aria-describedby"},"c"),"Field links its description / error ids automatically."]},{key:"btn-label",cells:["Button (icon-only)",e.jsx(t,{children:"aria-label"},"c"),"Author-supplied — a button with no text needs a name."]},{key:"btn-busy",cells:["Button (loading)",e.jsx(t,{children:"aria-busy"},"c"),"Set automatically while isLoading is true."]},{key:"dialog",cells:["Dialog",e.jsxs("span",{children:[e.jsx(t,{children:'role="dialog"'})," · ",e.jsx(t,{children:"aria-modal"})," ·"," ",e.jsx(t,{children:"aria-labelledby"})," · ",e.jsx(t,{children:"aria-describedby"})]},"c"),"Provided by Radix (title → labelledby, description → describedby)."]},{key:"tooltip",cells:["Tooltip",e.jsx(t,{children:"aria-describedby"},"c"),"Radix links the trigger to the tooltip content."]}]}),e.jsx(n,{children:"Required: announced, not enforced"}),e.jsxs(j,{variant:"info",title:"Field propagates aria-required — announce-only",children:[e.jsx(t,{children:"Field required"})," renders the visual marker (",e.jsx(t,{children:"*"}),") ",e.jsx("strong",{children:"and"})," ","sets ",e.jsx(t,{children:"aria-required"}),' on the wrapped control, so assistive tech announces "required". It does ',e.jsx("strong",{children:"not"})," enable native validation — form-submission blocking still comes only from a ",e.jsx(t,{children:"required"})," attribute set directly on the control (the same split as ",e.jsx(t,{children:"isError"}),", which sets ",e.jsx(t,{children:"aria-invalid"})," without forcing native ",e.jsx(t,{children:":invalid"}),")."]}),e.jsx(n,{children:"Live wiring"}),e.jsxs(o,{children:["Inspect the rendered DOM: the invalid input carries"," ",e.jsx(t,{children:'aria-invalid="true"'})," and an ",e.jsx(t,{children:"aria-describedby"})," pointing at the error text; the icon-only button exposes its name via ",e.jsx(t,{children:"aria-label"}),"; the loading button sets ",e.jsx(t,{children:"aria-busy"}),"."]}),e.jsx(a,{label:"aria-invalid + aria-describedby (via Field)",children:e.jsx(P,{label:"Email",error:"Enter a valid email address.",className:"w-72",children:e.jsx(w,{type:"email",defaultValue:"not-an-email"})})}),e.jsxs(a,{label:"aria-label (icon-only Button)",children:[e.jsx(i,{icon:L,"aria-label":"Search"}),e.jsx(N,{color:"muted",size:"sm",children:"getByRole('button', { name: 'Search' }) resolves this."})]}),e.jsx(a,{label:"aria-busy (loading Button)",children:e.jsx(i,{isLoading:!0,children:"Saving"})})]})},m={name:"Contrast",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}}},render:()=>e.jsxs(d,{children:[e.jsx(s,{children:"Color contrast"}),e.jsx(l,{children:"Color is never the only signal, and where it carries meaning it meets the WCAG AA contrast lines in both Modes."}),e.jsx(n,{children:"The lines"}),e.jsx(f,{headers:["Surface","Minimum ratio","Applies to"],rows:[{key:"text",cells:["Body text","4.5 : 1","Normal-size foreground text on its background."]},{key:"large",cells:["Large text","3 : 1","18pt+ (or 14pt bold) — headings and lead text."]},{key:"ui",cells:["UI components","3 : 1","Borders, focus rings, and other non-text affordances."]}]}),e.jsx(n,{children:"State tokens"}),e.jsxs(o,{children:["The semantic state tokens (",e.jsx(t,{children:"error"})," / ",e.jsx(t,{children:"success"})," / ",e.jsx(t,{children:"warning"})," ","/ ",e.jsx(t,{children:"info"}),") clear AA against their paired surfaces in light and dark. Non-solid coloured text routes through the ",e.jsx(t,{children:"--color-{state}-emphasis"})," rung (the 4→5-token shape from #344 Phase B) so it meets the 4.5 : 1 body-text line; the saturated"," ",e.jsx("em",{children:"solid"})," fills are the one documented exception (below). The full, mode-toggle-able swatch matrices live in ",e.jsx(t,{children:"Tokens/Color"}),' under "Filled / Subtle / Disabled vs ReadOnly Treatments (a11y audit)" — treat the audit, not this prose, as ground truth.']}),e.jsx(F,{children:"Worked example — foreground tiers on a surface"}),e.jsxs(o,{children:[e.jsx(t,{children:"text-foreground"})," (primary) and ",e.jsx(t,{children:"text-foreground-muted"})," (secondary) both clear the 4.5 : 1 body-text line in both Modes — muted was raised to AA in #344 Phase A. ",e.jsx(t,{children:"text-foreground-subtle"})," is the ",e.jsx("em",{children:"tertiary"})," tier and is intentionally below 4.5 : 1 at small sizes (it clears the 3 : 1 large-text line) — reach for it only on large or incidental text, never body copy."]}),e.jsxs("div",{className:"rounded-lg border border-border bg-surface p-6 flex flex-col gap-1",children:[e.jsxs("p",{className:"text-foreground",children:[e.jsx(t,{children:"text-foreground"})," on ",e.jsx(t,{children:"bg-surface"})," — primary body text, meets AA."]}),e.jsxs("p",{className:"text-foreground-muted",children:[e.jsx(t,{children:"text-foreground-muted"})," on ",e.jsx(t,{children:"bg-surface"})," — secondary text, meets AA."]}),e.jsxs("p",{className:"text-foreground-subtle",children:[e.jsx(t,{children:"text-foreground-subtle"})," on ",e.jsx(t,{children:"bg-surface"})," — tertiary, large / incidental only."]})]}),e.jsx(n,{children:"Intentional AA exceptions"}),e.jsxs(o,{children:["Four patterns are deliberately exempt from the 4.5 : 1 body-text line — three design exceptions plus one portal-testing artifact. These are the ",e.jsx("em",{children:"only"})," ",e.jsx(t,{children:"color-contrast"})," findings the CI a11y gate (#346) suppresses — each via a documented, story-scoped ",e.jsx(t,{children:"disableRules(['color-contrast'])"})," in the component's ",e.jsx(t,{children:"*.vrt.spec.ts"})," (mirrored in the story's"," ",e.jsx(t,{children:"parameters.a11y"}),"). A blanket disable is never allowed; anything outside this table must clear AA. See ",e.jsx(t,{children:".claude/rules/state-token-guideline.md"})," for the token rationale."]}),e.jsx(f,{headers:["Exception","Where it appears","Why it is AA-exempt"],rows:[{key:"solid",cells:["Solid treatments",'Button primary / destructive; Badge / Callout / Toast appearance="solid"; Dialog action button',"Light foreground on a saturated (or neutral-solid) fill cannot reach 4.5 : 1 — the white-on-vivid trilemma. Meaning is carried by an icon + a visible label (WCAG 1.4.1), not by colour."]},{key:"inverted",cells:["Inverted-on-saturated",'Button variant="inverted"; Text color="inverted" / "inverted-muted" / "inverted-subtle"',"The inverted foreground tiers sit on saturated surfaces and are incidental / large-only by design — the inverted analogue of the foreground-subtle tier."]},{key:"subtle",cells:["foreground-subtle (tertiary)",'Text color="subtle"; faint helper / placeholder-like copy',"The third foreground tier clears the 3 : 1 large-text line but is intentionally below 4.5 : 1 at small sizes. Never use it for body copy."]},{key:"overlay",cells:["Dialog overlay compositing (test artifact)","Dialog *.vrt.spec.ts a11y tests — every story","The full-page portal spec has axe compositing the aria-hidden trigger sitting behind the semi-transparent modal overlay into a blended, non-readable pair. A portal-pattern testing artifact, not a real content-contrast issue — the dialog text itself clears AA."]}]})]})};function q(){const[r,c]=B.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(i,{onClick:()=>c(!0),children:"Open dialog"}),e.jsx(I,{isOpen:r,onOpenChange:c,title:"Keyboard navigation",description:"Tab cycles focus within the dialog; Esc closes it.",actionButton:{label:"Confirm",onClick:()=>c(!1)},cancelButton:{label:"Cancel"},children:e.jsx(N,{children:"Focus is trapped here while the dialog is open. Press Esc to close."})})]})}const g={name:"Keyboard interaction",render:()=>e.jsxs(d,{children:[e.jsx(s,{children:"Keyboard interaction"}),e.jsxs(l,{children:["Every interactive element is reachable with ",e.jsx(t,{children:"Tab"})," / ",e.jsx(t,{children:"Shift+Tab"})," and operable from the keyboard. Compound widgets follow their established ARIA keyboard pattern — implemented by Radix, so the contract on our side is simply"," ",e.jsx("strong",{children:"not to break it"})," (no swallowing ",e.jsx(t,{children:"onKeyDown"}),", no stealing focus)."]}),e.jsx(n,{children:"Key map"}),e.jsx(f,{headers:["Widget","Keys"],rows:[{key:"all",cells:["All interactive elements",e.jsx(t,{children:"Tab"},"c")]},{key:"dialog",cells:["Dialog",e.jsxs("span",{children:[e.jsx(t,{children:"Esc"})," closes · ",e.jsx(t,{children:"Tab"})," cycles focus within (trap)"]},"c")]},{key:"tooltip",cells:["Tooltip / Popover",e.jsx(t,{children:"Esc"},"c")]},{key:"select",cells:["Select / Menu",e.jsxs("span",{children:[e.jsx(t,{children:"↑"})," ",e.jsx(t,{children:"↓"})," navigate · ",e.jsx(t,{children:"Enter"})," confirm"]},"c")]},{key:"radio",cells:["Radio group",e.jsxs("span",{children:[e.jsx(t,{children:"←"})," ",e.jsx(t,{children:"→"})," / ",e.jsx(t,{children:"↑"})," ",e.jsx(t,{children:"↓"})," move selection"]},"c")]}]}),e.jsx(n,{children:"Try it"}),e.jsxs(o,{children:["Operate each widget below without a mouse: open the dialog and press ",e.jsx(t,{children:"Esc"}),"; arrow through the select and the radio group."]}),e.jsx(a,{label:"Dialog — Esc to close, Tab trap",children:e.jsx(q,{})}),e.jsx(a,{label:"Select — arrow keys + Enter",children:e.jsxs(k,{children:[e.jsx(T,{"aria-label":"Fruit",className:"w-48",children:e.jsx(S,{placeholder:"Pick a fruit"})}),e.jsxs(A,{children:[e.jsx(y,{value:"apple",children:"Apple"}),e.jsx(y,{value:"banana",children:"Banana"}),e.jsx(y,{value:"cherry",children:"Cherry"})]})]})}),e.jsx(a,{label:"Radio group — arrow keys",children:e.jsxs(D,{defaultValue:"a",className:"flex-row gap-4",children:[e.jsx(v,{value:"a",label:"Option A"}),e.jsx(v,{value:"b",label:"Option B"}),e.jsx(v,{value:"c",label:"Option C"})]})})]})},b={name:"Screen reader support",render:()=>e.jsxs(d,{children:[e.jsx(s,{children:"Screen reader support"}),e.jsx(l,{children:"What a sighted user reads from layout and color, a screen-reader user must get from the accessibility tree. Two rules carry most of the weight: hide decorations, and never let color be the only carrier of meaning."}),e.jsx(n,{children:"Decorative icons are hidden"}),e.jsxs(o,{children:["Every purely-decorative icon (the icon inside a Button, Badge, Callout, the Checkbox mark, the Switch knob, the Spinner) carries ",e.jsx(t,{children:'aria-hidden="true"'}),", so it is not announced. Do not add a meaningless ",e.jsx(t,{children:"aria-label"})," to a decorative icon — that just adds noise. An icon is only named when it is itself the control (e.g. an icon-only Button, or Field's info trigger with"," ",e.jsx(t,{children:'aria-label="More information"'}),")."]}),e.jsx(n,{children:"Meaning is not color alone"}),e.jsxs(o,{children:["State surfaces pair a color shift with a non-color signal: a labeled icon and visible text for sighted users, and a role + accessible name for assistive tech. In the callout below the variant icon is ",e.jsx(t,{children:"aria-hidden"})," — the meaning is carried by the title and body text, so it survives even if the color shift is not perceived."]}),e.jsx(j,{variant:"success",title:"Saved",className:"mb-4",children:"Your changes were saved. The meaning is in this text, not in the green tint."}),e.jsx(n,{children:"Loading announces politely"}),e.jsxs(o,{children:["Asynchronous progress uses ",e.jsx(t,{children:"aria-busy"})," on the control plus an"," ",e.jsx(t,{children:'aria-live="polite"'})," region so the change is announced without interrupting. The Button below sets ",e.jsx(t,{children:"aria-busy"})," while loading and hides its spinner from the a11y tree."]}),e.jsx(a,{label:"Loading",children:e.jsx(i,{isLoading:!0,children:"Submitting"})})]})},x={name:"Automated testing",render:()=>e.jsxs(d,{children:[e.jsx(s,{children:"Automated testing"}),e.jsx(l,{children:'The a11y contract is enforced by two complementary axe surfaces — one in CI, one at dev time — pinned to the same rule set so "green in the panel" maps to "green in CI".'}),e.jsx(n,{children:"axe in every VRT spec"}),e.jsxs(o,{children:["Each lv1 ",e.jsx(t,{children:"*.vrt.spec.ts"})," pairs every screenshot with an"," ",e.jsx(t,{children:"@axe-core/playwright"})," scan (as a separate test, so a visual failure never masks an a11y failure). Always pin the WCAG tag set, or axe also runs best-practice rules that flag the Storybook iframe itself on every story."]}),e.jsx(C,{children:`const results = await new AxeBuilder({ page })
  .include('#storybook-root')
  .withTags(['wcag2a', 'wcag2aa', 'wcag21a', 'wcag21aa'])
  .analyze()

expect(results.violations).toEqual([])`}),e.jsx(n,{children:"The addon-a11y panel"}),e.jsxs(o,{children:["Storybook's ",e.jsx(t,{children:"addon-a11y"})," runs the same axe surface against the rendered story in the ",e.jsx("strong",{children:"Accessibility"})," panel — the dev-time companion to the CI assertion. Because it scans after the theme decorator applies ",e.jsx(t,{children:".dark"})," /"," ",e.jsx(t,{children:"data-theme"}),", toggling the Theme toolbar surfaces dark-mode and seasonal contrast issues for free."]}),e.jsx(n,{children:"Run it"}),e.jsx(C,{children:`pnpm test:a11y    # playwright test --grep a11y          → a11y only
pnpm test:vrt     # playwright test --grep-invert a11y    → screenshots only`}),e.jsx(n,{children:"Status: blocking gate"}),e.jsxs(o,{children:["The CI a11y job ",e.jsx("strong",{children:"blocks"})," (#346) — it propagates the Playwright exit code, so a new WCAG 2.1 A/AA violation fails the PR (the full violation list is still tee'd into the job summary). The only ",e.jsx(t,{children:"color-contrast"})," findings that remain are the intentional exceptions inventoried on the ",e.jsx("strong",{children:"Contrast"})," page of this section, each suppressed with a documented, story-scoped"," ",e.jsx(t,{children:"disableRules(['color-contrast'])"}),". One other rule id carries a documented exception: ",e.jsx(t,{children:"aria-hidden-focus"})," on open Radix poppers (Select / DropdownMenu / Popover) — while open, Radix hides the page behind the popper via"," ",e.jsx(t,{children:"aria-hidden"})," but leaves the trigger focusable, a known Radix behavior not fixable from Schatten; the disable is scoped to the open-state a11y tests only. These two rule ids are the ",e.jsx("em",{children:"entire"})," allowed set (see"," ",e.jsx(t,{children:".claude/rules/vrt-spec-guideline.md"})," §a11y assertions). The addon panel's"," ",e.jsx(t,{children:"test"})," flag is ",e.jsx(t,{children:"off"})," so its headless preview run does not race the Playwright suite; addon-a11y stays the on-demand dev companion — click"," ",e.jsx("strong",{children:"Rerun"})," in the Accessibility panel to scan the current story."]})]})},Ge=["Overview","FocusVisibility","AriaConventions","Contrast","Keyboard","ScreenReader","AutomatedTesting"];h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: 'Overview',
  render: () => <Page>
...
.st-btn:focus-visible {
  ...
  render: () => <Page>
      ...
      key: 'overlay',
      cells: ['Dialog overlay compositing (test artifact)', 'Dialog *.vrt.spec.ts a11y tests — every story', 'The full-page portal spec has axe compositing the aria-hidden trigger sitting behind the semi-transparent modal overlay into a blended, non-readable pair. A portal-pattern testing artifact, not a real content-contrast issue — the dialog text itself clears AA.']
    }]} />
    </Page>
...
(#148), pinned to the WCAG 2.1 A/AA tag set. The CI gate is blocking (#346).`,...x.parameters?.docs?.description}}};export{p as AriaConventions,x as AutomatedTesting,m as Contrast,u as FocusVisibility,g as Keyboard,h as Overview,b as ScreenReader,Ge as __namedExportsOrder,We as default};
