import{j as e}from"./iframe-Q-7Zj3Ct.js";/* empty css               *//* empty css              *//* empty css               *//* empty css                *//* empty css             *//* empty css                 *//* empty css               *//* empty css                     *//* empty css              *//* empty css                 *//* empty css             *//* empty css              *//* empty css                *//* empty css              *//* empty css               *//* empty css                  *//* empty css                 *//* empty css                *//* empty css               *//* empty css              *//* empty css             *//* empty css             *//* empty css                 *//* empty css              *//* empty css                */import"./preload-helper-DUSBS5vW.js";const F={title:"CSS API/Overview",parameters:{layout:"fullscreen",docs:{description:{component:"# CSS API\n\nSchatten ships both a React component surface and a framework-agnostic\nCSS layer. This page is the **reference catalogue** for the CSS layer:\nevery `.st-*` class consumers can write directly in vanilla HTML, with\nthe matching markup and a11y requirements.\n\n- The class names follow the convention in [css-api.md](.claude/rules/css-api.md):\n  `.st-{block}` / `.st-{block}--{modifier}` / `.st-{block}__{element}`,\n  one axis per modifier, attribute-driven state (`[aria-invalid]`,\n  `[aria-busy]`, `[data-state]`, …).\n- Pixel parity between the React side and the vanilla HTML side is\n  verified per-component in each `{Component}.parity.stories.tsx` and\n  pinned by `{Component}.parity.vrt.spec.ts`.\n\n**Coverage**: every lv1 component. The original 18 landed via #154\nsweep-1〜7; each later lv1 adds its own section on arrival (the CSS API\nfixture section is required by the audit-coverage gate, and this page\nmirrors it)."}}}},c=()=>e.jsx("style",{children:`
  ...
  `}),t=({id:i,title:o,intro:l,attributes:r,children:d})=>e.jsxs("section",{id:i,className:"cssapi-doc__section",children:[e.jsx("h2",{className:"st-text st-text--heading st-text--lg st-text--default cssapi-doc__title-spacing",children:o}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--muted cssapi-doc__intro-spacing",children:l}),r&&r.length>0&&e.jsxs("div",{className:"cssapi-doc__attr-wrapper",children:[e.jsx("h3",{className:"st-text st-text--label st-text--sm st-text--default cssapi-doc__title-spacing",children:"Required attributes for vanilla HTML usage"}),e.jsxs("table",{className:"cssapi-doc__attr-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{scope:"col",children:"Attribute"}),e.jsx("th",{scope:"col",children:"Meaning"}),e.jsx("th",{scope:"col",children:"When"})]})}),e.jsx("tbody",{children:r.map(s=>e.jsxs("tr",{children:[e.jsx("td",{className:"cssapi-doc__attr-name",children:s.name}),e.jsx("td",{children:s.meaning}),e.jsx("td",{children:s.required})]},s.name))})]})]}),e.jsx("div",{className:"cssapi-doc__panel",children:d})]}),a=({children:i})=>e.jsx("pre",{className:"cssapi-doc__code",children:e.jsx("code",{children:i})}),n={name:"Reference (all 25 lv1 components)",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}}},render:()=>e.jsxs(e.Fragment,{children:[e.jsx(c,{}),e.jsxs("div",{className:"cssapi-doc",children:[e.jsx("h1",{className:"st-text st-text--heading st-text--2xl st-text--default cssapi-doc__title-spacing",children:"CSS API — every lv1 component"}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--muted cssapi-doc__intro-spacing",children:"The classes below are emitted by `dist/schatten.css`. Import it once and the markup samples render with no React and no consumer Tailwind setup."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--muted cssapi-doc__intro-spacing--lg",children:"What counts as public is machine-tracked: every `.st-*` class, state attribute, and CSS variable is enumerated in `schatten.manifest.json` (shipped with the package), and the CSS variables are sourced from the public-token registrar (`src/styles/public-tokens.css`). A name absent from the manifest is internal and may change without notice."}),e.jsxs(t,{id:"separator",title:"Separator — .st-separator",intro:"Visual divider. Orientation is an author configuration and goes through a modifier class (--horizontal / --vertical), matching the css-api.md author-config → modifier principle.",attributes:[{name:"role",meaning:'"separator" for semantic dividers, "none" / omit for decorative',required:"recommended"},{name:"aria-orientation",meaning:"For non-decorative vertical separators (assistive tech announces orientation)",required:'role="separator" + vertical only'},{name:"data-orientation",meaning:"Informational only — Radix emits this on the React side; vanilla HTML may include it for DOM parity but it does not drive styling",required:"optional"}],children:[e.jsxs("div",{className:"cssapi-doc__col-wide cssapi-doc__stack",children:[e.jsx("span",{className:"st-text st-text--body st-text--sm st-text--muted",children:"Above"}),e.jsx("div",{className:"st-separator st-separator--horizontal",role:"none"}),e.jsx("span",{className:"st-text st-text--body st-text--sm st-text--muted",children:"Below"})]}),e.jsx(a,{children:`<!-- Decorative -->
...
<!-- Modifier vocabulary -->
<!-- orientation: --horizontal | --vertical -->`})]}),e.jsxs(t,{id:"text",title:"Text — .st-text",intro:"Typography primitive. Five orthogonal axes (variant × size × color × align × truncate), all emitted as side-by-side modifiers — never collapsed.",children:[e.jsxs("div",{className:"cssapi-doc__stack cssapi-doc__stack--tight",children:[e.jsx("h2",{className:"st-text st-text--heading st-text--lg st-text--default",children:"Heading lg"}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default",children:"Body md, default color."}),e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--muted",children:"Body sm, muted color."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--error",children:"Body md, error color."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--vermillion",children:"Body md, vermillion (朱)."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default st-text--align-right",children:"Right-aligned body."}),e.jsx("p",{className:"st-text st-text--body st-text--md st-text--default st-text--truncate w-64",children:"A very long line that should be truncated on overflow."})]}),e.jsx(a,{children:`<p class="st-text st-text--body st-text--md st-text--default">Body text.</p>
...
<!-- close uses --st-duration-base   default 150ms -->`})]}),e.jsxs(t,{id:"field",title:"Field — .st-field",intro:"Layout + a11y wrapper around a single form input. Stacks label / description / children / error vertically and pairs the external <label htmlFor> with the input id. Vanilla HTML consumers wire htmlFor / id / aria-describedby manually — the framework-agnostic CSS does not auto-wire ARIA.",attributes:[{name:"htmlFor (label) + id (input)",meaning:"Pairs the external label with the form control",required:"always when label is present"},{name:"aria-describedby",meaning:"Links the input to the description / error message id",required:"when description or error is present"},{name:'aria-invalid="true"',meaning:"Set on the inner input to drive the error visual (NOT on the .st-field root)",required:"when the value is invalid"},{name:'data-error="true"',meaning:"Observability hook on .st-field root — does NOT drive built-in visuals; consumers may attach external styling to it",required:"optional (mirror of aria-invalid for external observability)"},{name:'data-disabled="true"',meaning:"Set on .st-field root when the field is disabled",required:"optional"}],children:[e.jsxs("div",{className:"cssapi-doc__col-form cssapi-doc__stack",children:[e.jsxs("div",{className:"st-field",children:[e.jsx("div",{className:"st-field__label-row",children:e.jsx("label",{htmlFor:"cssapi-field-email",className:"st-field__label",children:"Email"})}),e.jsx("label",{htmlFor:"cssapi-field-email",id:"cssapi-field-email-desc",className:"st-field__description",children:"We never share your email"}),e.jsx("div",{className:"st-input-wrapper st-input-wrapper--md",children:e.jsx("input",{id:"cssapi-field-email",type:"email",className:"st-input",defaultValue:"user@example.com","aria-describedby":"cssapi-field-email-desc"})})]}),e.jsxs("div",{className:"st-field","data-error":"true",children:[e.jsx("div",{className:"st-field__label-row",children:e.jsxs("label",{htmlFor:"cssapi-field-name",className:"st-field__label",children:["Name",e.jsx("span",{className:"st-field__required-marker",children:"*"})]})}),e.jsx("div",{className:"st-input-wrapper st-input-wrapper--md",children:e.jsx("input",{id:"cssapi-field-name",className:"st-input",required:!0,"aria-invalid":"true","aria-describedby":"cssapi-field-name-error"})}),e.jsx("p",{id:"cssapi-field-name-error",className:"st-field__error",children:"Name is required"})]})]}),e.jsx(a,{children:`<!-- Basic field (label + description + input) -->
<div class="st-field">
...
<!-- .st-fieldset__children     inner <div> flex container with the
                                actual fields                            -->
<!-- .st-fieldset__error        group-level error <p>                    -->`})]}),e.jsxs(t,{id:"card",title:"Card — .st-card",intro:"Surface container. Out-of-pattern single axis: variant toggles the background — --filled (surface fill + --shadow-card) vs --plain (transparent, border only). The bare .st-card is a layout shell with no fill or shadow, so always pair it with --filled or --plain (with no modifier it degrades to the plain look). Sub-elements (__header / __title / __description / __content / __footer) sit directly under the block; region padding is per-region, with a :first-child rule restoring top padding when content or footer leads.",children:[e.jsxs("div",{className:"cssapi-doc__row",children:[e.jsxs("div",{className:"st-card st-card--filled",style:{width:"13rem"},children:[e.jsxs("div",{className:"st-card__header",children:[e.jsx("div",{className:"st-card__title",children:"Filled"}),e.jsx("div",{className:"st-card__description",children:"surface + shadow"})]}),e.jsx("div",{className:"st-card__content",children:"Raised card."})]}),e.jsxs("div",{className:"st-card st-card--plain",style:{width:"13rem"},children:[e.jsxs("div",{className:"st-card__header",children:[e.jsx("div",{className:"st-card__title",children:"Plain"}),e.jsx("div",{className:"st-card__description",children:"transparent, border only"})]}),e.jsx("div",{className:"st-card__content",children:"Surface shows through."})]})]}),e.jsx(a,{children:`<!-- variant toggles the background; always pair .st-card with a modifier -->
...
<!-- Sub-elements: __header / __title / __description / __content / __footer -->`})]}),e.jsxs(t,{id:"table",title:"Table — .st-table",intro:'Presentational-only data table (no sort / filter / pagination logic — compose a headless layer on top). Out of pattern: three orthogonal boolean treatments (--striped / --bordered / --hoverable) plus a --sm / --md / --lg density axis, all root modifiers that reach cells via descendant selectors. Cells carry their own align modifier (__cell--start / --center / --end, same for __head). Selection is a state attribute, not a class: .st-table__row[data-state="selected"]. The table renders inside a .st-table-scroll container for horizontal overflow. Name the table with a __caption (or aria-label).',children:[e.jsx("div",{className:"cssapi-doc__row",children:e.jsx("div",{className:"st-table-scroll",style:{width:"20rem"},children:e.jsxs("table",{className:"st-table st-table--md st-table--striped st-table--bordered",children:[e.jsx("caption",{className:"st-table__caption",children:"Team members"}),e.jsx("thead",{className:"st-table__header",children:e.jsxs("tr",{className:"st-table__row",children:[e.jsx("th",{className:"st-table__head st-table__head--start",children:"Name"}),e.jsx("th",{className:"st-table__head st-table__head--end",children:"Role"})]})}),e.jsxs("tbody",{className:"st-table__body",children:[e.jsxs("tr",{className:"st-table__row",children:[e.jsx("td",{className:"st-table__cell st-table__cell--start",children:"Taro Tanaka"}),e.jsx("td",{className:"st-table__cell st-table__cell--end",children:"Admin"})]}),e.jsxs("tr",{className:"st-table__row","data-state":"selected",children:[e.jsx("td",{className:"st-table__cell st-table__cell--start",children:"Hanako Sato"}),e.jsx("td",{className:"st-table__cell st-table__cell--end",children:"Editor"})]})]})]})})}),e.jsx(a,{children:`<!-- Treatments are orthogonal root modifiers; cells get an align modifier -->
...
<!-- cell align: __cell--start (default) | --center | --end (same for __head) -->`})]}),e.jsxs(t,{id:"avatar",title:"Avatar — .st-avatar",intro:"User's profile image with an initials fallback. One size axis (--sm / --md / --lg → 32 / 40 / 48px); the image→fallback swap is JS-driven (Radix), so vanilla HTML renders a static avatar. Fixed circle. The fallback font-size tracks the root size via a descendant rule, so a vanilla consumer writes only the root --size modifier.",attributes:[{name:'alt="…"',meaning:'Accessible name for the image; use alt="" when the avatar is decorative',required:"recommended"}],children:[e.jsxs("div",{className:"cssapi-doc__row",children:[e.jsx("span",{className:"st-avatar st-avatar--sm",children:e.jsx("span",{className:"st-avatar__fallback",children:"JD"})}),e.jsx("span",{className:"st-avatar st-avatar--md",children:e.jsx("span",{className:"st-avatar__fallback",children:"AB"})}),e.jsx("span",{className:"st-avatar st-avatar--lg",children:e.jsx("span",{className:"st-avatar__fallback",children:"CD"})})]}),e.jsx(a,{children:`<!-- size: --sm | --md | --lg (32 / 40 / 48px); circle fixed -->
<!-- image:    <img class="st-avatar__image"> (JS swaps to fallback on load error) -->
<!-- fallback: <span class="st-avatar__fallback">JD</span> (initials) -->`})]}),e.jsxs(t,{id:"skeleton",title:"Skeleton — .st-skeleton",intro:"Loading placeholder. A single decorative block class with no modifiers — width / height / border-radius are class- or style-driven. Decorative: set aria-hidden and announce loading on the container (role='status' aria-busy='true'). The shimmer pauses under prefers-reduced-motion.",attributes:[{name:'aria-hidden="true"',meaning:"Skeletons are decorative; hide them and announce loading on the container instead",required:"recommended"}],children:[e.jsxs("div",{className:"cssapi-doc__stack",children:[e.jsx("div",{className:"st-skeleton",style:{height:"1rem",width:"14rem"},"aria-hidden":"true"}),e.jsxs("div",{className:"cssapi-doc__row cssapi-doc__row--tight",children:[e.jsx("div",{className:"st-skeleton",style:{height:"3rem",width:"3rem",borderRadius:"9999px"},"aria-hidden":"true"}),e.jsx("div",{className:"st-skeleton",style:{height:"3rem",width:"9rem"},"aria-hidden":"true"})]})]}),e.jsx(a,{children:`<!-- size + shape via class / style; announce loading on the container -->
...
</div>`})]}),e.jsxs(t,{id:"tabs",title:"Tabs — .st-tabs",intro:"Tabbed navigation (interactive; Radix-driven). The markup below is the static shape — keyboard nav, selection, and the sliding .st-tabs__indicator need JS. Orientation is author config carried on [data-orientation], which the list / trigger rules read (nested parts receive it via context, so there is no modifier class). The selected trigger is [data-state='active'].",attributes:[{name:'role="tablist" / "tab" / "tabpanel"',meaning:"Radix assigns these; vanilla consumers add them for SR + keyboard support",required:"always (vanilla)"},{name:'data-state="active"',meaning:"Marks the selected trigger (the indicator tracks it)",required:"runtime"},{name:"data-orientation",meaning:"horizontal (default) / vertical — drives list + trigger layout",required:"author config"}],children:[e.jsxs("div",{className:"st-tabs",children:[e.jsxs("div",{className:"st-tabs__list",role:"tablist","data-orientation":"horizontal",children:[e.jsx("button",{type:"button",className:"st-tabs__trigger",role:"tab","data-state":"active",children:"Account"}),e.jsx("button",{type:"button",className:"st-tabs__trigger",role:"tab","data-state":"inactive",children:"Password"})]}),e.jsx("div",{className:"st-tabs__content",role:"tabpanel",children:"Account settings…"})]}),e.jsx(a,{children:`<div class="st-tabs">
...
<!-- Note: keyboard nav, selection, and the indicator animation need JS (Radix). -->`})]}),e.jsxs(t,{id:"select",title:"Select — .st-select__*",intro:"Form select (interactive; Radix-driven, portal listbox). The trigger is vanilla-stylable (.st-select__trigger with size --sm / --md / --lg); the dropdown content, options, and keyboard nav need JS. Error state is [aria-invalid='true'] on the trigger, matching the other form controls.",attributes:[{name:'role="combobox" / "listbox" / "option"',meaning:"Radix assigns these on the trigger / content / items",required:"always (vanilla)"},{name:'aria-invalid="true"',meaning:"Error state on the trigger (red border)",required:"when isError"}],children:[e.jsxs("button",{type:"button",className:"st-select__trigger st-select__trigger--md",style:{width:"14rem"},children:[e.jsx("span",{children:"Pick a fruit"}),e.jsx("svg",{className:"st-select__icon",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","aria-hidden":"true",children:e.jsx("path",{d:"m6 9 6 6 6-6"})})]}),e.jsx(a,{children:`<!-- trigger is vanilla; the listbox content + keyboard nav need JS (Radix) -->
...
<!-- trigger size: --sm | --md | --lg -->`})]}),e.jsxs(t,{id:"tooltip",title:"Tooltip — .st-tooltip__content",intro:"Hover / focus hint mounted into a portal (interactive; Radix-driven). Renders a single styled bubble, .st-tooltip__content, plus an optional .st-tooltip__arrow; positioning and the show / hide trigger need JS. [data-side] carries the resolved placement for the directional enter animation.",attributes:[{name:'role="tooltip"',meaning:"On the content; the trigger gets aria-describedby pointing at it",required:"always (vanilla)"},{name:"data-side",meaning:"top / right / bottom / left — resolved placement, drives the enter animation",required:"runtime"}],children:[e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--muted mb-3",children:"Tooltip content is portal-mounted and positioned by JS; the static reference below shows the markup."}),e.jsx(a,{children:`<!-- portal content; positioning + show/hide need JS (Radix) -->
<div class="st-tooltip__content" role="tooltip" data-side="top">
  Add to library
  <span class="st-tooltip__arrow"></span>
</div>`})]}),e.jsxs(t,{id:"popover",title:"Popover — .st-popover__content",intro:"Floating content panel mounted into a portal (interactive; Radix-driven). Renders a single styled surface, .st-popover__content; positioning and the open trigger need JS. [data-side] carries the resolved placement; [data-state] toggles open / closed.",attributes:[{name:'role="dialog"',meaning:"On the content; the trigger gets aria-expanded / aria-controls",required:"always (vanilla)"},{name:"data-side",meaning:"top / right / bottom / left — resolved placement, drives the enter animation",required:"runtime"}],children:[e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--muted mb-3",children:"Popover content is portal-mounted and positioned by JS; the static reference below shows the markup."}),e.jsx(a,{children:`<!-- portal content; positioning + open/close need JS (Radix) -->
<div class="st-popover__content" role="dialog" data-side="bottom">
  …
</div>`})]}),e.jsxs(t,{id:"dropdownmenu",title:"DropdownMenu — .st-dropdown-menu__*",intro:"Menu surface mounted into a portal (interactive; Radix-driven). Items are an action subset of Pattern A: --default (resting) / --destructive (delete intent → --color-destructive). The static reference below shows the content panel; opening, keyboard nav, and focus return need JS. [data-highlighted] marks the focused item.",attributes:[{name:'role="menu" / "menuitem"',meaning:"Radix assigns these on the portal content / items",required:"always (vanilla)"},{name:"data-highlighted",meaning:"Marks the keyboard-focused item",required:"runtime"}],children:[e.jsx("p",{className:"st-text st-text--body st-text--sm st-text--muted mb-3",children:"Menu content is portal-mounted; the static reference below shows the panel markup."}),e.jsx(a,{children:`<!-- portal content; opening + keyboard nav + focus return need JS (Radix) -->
...
<!-- Sub-elements: __content / __item / __label / __separator / __shortcut /
     ...
     __sub-trigger / __sub-trigger-chevron -->`})]})]})]})},P=["Reference"];n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...n.parameters?.docs?.source}}};export{n as Reference,P as __namedExportsOrder,F as default};
