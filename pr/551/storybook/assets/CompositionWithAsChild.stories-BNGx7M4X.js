...
}`,...o.parameters?.docs?.source},description:{story:"`Text` polymorphism — `as` swaps the semantic tag; `textVariants()` puts\nText styling on an arbitrary element. `Text` does **not** expose\n`asChild` (removed in v0.11.0).",...o.parameters?.docs?.description}}};export{a as ButtonAsLink,r as LinkWithButtonVariants,s as Overview,o as TextPolymorphism,O as __namedExportsOrder,W as default};
