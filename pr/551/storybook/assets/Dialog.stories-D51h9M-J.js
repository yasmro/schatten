import{r as o,j as n}from"./iframe-Q-7Zj3Ct.js";import{D as a}from"./Dialog-C0RbHrLD.js";import{B as s}from"./Button-DuXjAE-j.js";import"./preload-helper-DUSBS5vW.js";import"./index-C_iVNB6w.js";import"./index-8k5_Nd5T.js";import"./index-DPnazUT8.js";import"./index-D-IzIQ0Z.js";import"./index-C7GoUSIM.js";import"./index-B0VBQZoU.js";import"./index-Qm0ZzbsL.js";import"./index-BLsZNQv9.js";import"./index-DzDeP3Xp.js";import"./Combination-BgBsTrHT.js";import"./index-C88_IEkQ.js";/* empty css               */import"./Separator-DIRN6NFX.js";import"./utils-HnQPFlDo.js";/* empty css                  */import"./x-48ATuIqe.js";import"./createLucideIcon-BWa8aq_-.js";import"./index-BekUCMdb.js";/* empty css               */import"./Spinner-QdpqgASa.js";/* empty css                */const G={title:"Components/lv1/Dialog",component:a,parameters:{layout:"centered",docs:{description:{component:`Dialog renders a modal overlay for important content or actions —
...
- Mobile:  \`[Action] / [Cancel] / ── ── ── / [SubAction]\`
  (separator only when \`subActionButton\` is provided)`}}},tags:["autodocs"],argTypes:{isOpen:{description:"Controlled open state.",control:"boolean",table:{type:{summary:"boolean"}}},onOpenChange:{description:"Called when the open state changes (close ✕, ESC, overlay click, cancel button).",table:{type:{summary:"(isOpen: boolean) => void"}},control:!1},title:{description:"Dialog heading. Required.",control:"text",table:{type:{summary:"string"}}},description:{description:"Optional supporting text rendered below the title.",control:"text",table:{type:{summary:"string"}}},isCloseButtonVisible:{description:"Whether the close (✕) button in the top-right is rendered.",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}},actionButton:{description:"Primary action button. Required. Set `isLoading: true` on this slot to show a spinner; Dialog will disable the other footer buttons and block dismissal.",table:{type:{summary:"DialogActionButton"}},control:!1},cancelButton:{description:"Cancel button (secondary variant). Closes the dialog when clicked.",table:{type:{summary:"DialogCancelButton"}},control:!1},subActionButton:{description:"Sub-action button (tertiary variant) — placed at the far left on desktop. Like `actionButton`, accepts `isLoading` for async sub-action handlers.",table:{type:{summary:"DialogSubActionButton"}},control:!1},children:{description:"Body content rendered between the header and the footer.",table:{type:{summary:"ReactNode"}},control:!1}}},l={name:"Playground",args:{isOpen:!1,title:"Delete account",description:"This action cannot be undone.",isCloseButtonVisible:!0,actionButton:{label:"Delete",variant:"destructive",isLoading:!1},cancelButton:{label:"Cancel"},subActionButton:{label:"Save as draft",isLoading:!1},children:"All data associated with this account will be permanently removed."},render:t=>{const[e,i]=o.useState(t.isOpen);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>i(!0),children:"Open dialog"}),n.jsx(a,{...t,isOpen:e,onOpenChange:i,actionButton:{...t.actionButton,onClick:()=>i(!1)},subActionButton:t.subActionButton?{...t.subActionButton,onClick:()=>i(!1)}:void 0})]})}},c={name:"Confirm (primary)",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:"Standard confirmation dialog with a primary action and cancel."}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Save changes",description:"Your changes will be saved to this document.",actionButton:{label:"Save",onClick:()=>e(!1)},cancelButton:{label:"Cancel"}})]})}},u={name:"Destructive",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:'Set `actionButton.variant: "destructive"` for irreversible actions like delete.'}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{variant:"destructive",onClick:()=>e(!0),children:"Delete"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Delete account?",description:"This action cannot be undone. All data will be permanently removed.",actionButton:{label:"Delete",variant:"destructive",onClick:()=>e(!1)},cancelButton:{label:"Cancel"}})]})}},d={name:"With Sub-Action",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:'`subActionButton` provides a tertiary alternative — for example "Save as draft". On desktop it sits at the far left; on mobile it stacks below a separator at the bottom of the footer, after Action and Cancel.'}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Publish article?",description:"Your article will be visible to all readers.",actionButton:{label:"Publish",onClick:()=>e(!1)},cancelButton:{label:"Cancel"},subActionButton:{label:"Save as draft",onClick:()=>e(!1)}})]})}},p={name:"Loading",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:"When the action slot has `isLoading: true`, the action button shows a spinner, the cancel and sub-action buttons (and close ✕) are disabled, and dismissal (ESC / overlay click / ✕) is blocked. The parent owns this state."}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Saving…",description:"Please wait while we save your changes.",actionButton:{label:"Save",onClick:()=>{},isLoading:!0},cancelButton:{label:"Cancel"}})]})}},h={name:"Sub-Action Loading",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:"When `subActionButton.isLoading` is true, the sub-action button shows the spinner; the action button (and cancel) are disabled in turn."}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Publish article?",description:"Saving as draft…",actionButton:{label:"Publish",onClick:()=>{}},cancelButton:{label:"Cancel"},subActionButton:{label:"Save as draft",onClick:()=>{},isLoading:!0}})]})}},b={name:"Async Action",parameters:{docs:{description:{story:"Pattern for awaiting an async primary action. The parent flips `actionButton.isLoading` true → awaits → flips false (or closes the dialog)."}}},render:()=>{const[t,e]=o.useState(!1),[i,r]=o.useState(!1),O=async()=>{r(!0),await new Promise(v=>setTimeout(v,1500)),r(!1),e(!1)};return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open async dialog"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Submit form?",description:"This will submit your form to the server.",actionButton:{label:"Submit",onClick:O,isLoading:i},cancelButton:{label:"Cancel"}})]})}},g={name:"Async Sub-Action",parameters:{docs:{description:{story:"Sub-action handlers can be async too — set `isLoading: true` on `subActionButton` instead. The action button (and cancel) are disabled while the sub-action is in flight."}}},render:()=>{const[t,e]=o.useState(!1),[i,r]=o.useState(null),O=async()=>{r("action"),await new Promise(C=>setTimeout(C,1500)),r(null),e(!1)},v=async()=>{r("sub"),await new Promise(C=>setTimeout(C,1500)),r(null),e(!1)};return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Publish article?",description:"Try clicking Save as draft — only the sub-action shows a spinner.",actionButton:{label:"Publish",onClick:O,isLoading:i==="action"},cancelButton:{label:"Cancel"},subActionButton:{label:"Save as draft",onClick:v,isLoading:i==="sub"}})]})}},m={name:"Without Close Button",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:"Set `isCloseButtonVisible={false}` to hide the ✕ button — useful when you want to force the user through one of the footer actions."}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,isCloseButtonVisible:!1,title:"Terms of service",description:"You must accept the terms to continue.",actionButton:{label:"Accept",onClick:()=>e(!1)},cancelButton:{label:"Decline"}})]})}},f={name:"Info Only (action only)",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:'For "OK"-only information dialogs, omit `cancelButton` and use `actionButton` to dismiss.'}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Update available",description:"A new version of the app is ready. Reload to apply.",actionButton:{label:"OK",onClick:()=>e(!1)}})]})}},y={name:"Long Content",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}},docs:{description:{story:"Dialog caps its height at the viewport (`max-h-[calc(100vh-2rem)]`) and the body region scrolls internally. No consumer-side `max-height` / `overflow` is needed — header and footer stay pinned."}}},render:()=>{const[t,e]=o.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(s,{onClick:()=>e(!0),children:"Open"}),n.jsx(a,{isOpen:t,onOpenChange:e,title:"Privacy policy update",description:"Please review the changes before continuing.",actionButton:{label:"Accept",onClick:()=>e(!1)},cancelButton:{label:"Decline"},children:n.jsx("div",{className:"flex flex-col gap-3",children:Array.from({length:8}).map((i,r)=>n.jsx("p",{children:"We have updated our privacy policy to reflect changes in how we handle user data. The updates clarify our practices around analytics, third-party integrations, and the retention of session-level information. By accepting, you acknowledge that you have read and understood the changes. You can review the full policy at any time from your account settings."},r))})})]})}},H=["Playground","Confirm","Destructive","WithSubAction","Loading","SubActionLoading","AsyncAction","AsyncSubAction","WithoutCloseButton","InfoOnly","LongContent"];l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  name: 'Playground',
  args: {
    isOpen: false,
...
}`,...y.parameters?.docs?.source}}};export{b as AsyncAction,g as AsyncSubAction,c as Confirm,u as Destructive,f as InfoOnly,p as Loading,y as LongContent,l as Playground,h as SubActionLoading,d as WithSubAction,m as WithoutCloseButton,H as __namedExportsOrder,G as default};
