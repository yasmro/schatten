import{j as e}from"./iframe-Q-7Zj3Ct.js";import{P as c,L as l,S as r,N as i}from"./docs-ui-D0Lzeezu.js";import"./preload-helper-DUSBS5vW.js";const w={title:"Tokens/Elevation",parameters:{layout:"fullscreen"}},m=[{token:"sm",value:"0 1px 2px 0 rgb(0 0 0 / 0.05)"},{token:"md",value:"0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)"},{token:"lg",value:"0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)"},{token:"xl",value:"0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)"}],p=[{name:"popover",alias:"md",status:"applied",usedBy:"Tooltip / Select content"},{name:"modal",alias:"lg",status:"applied",usedBy:"Dialog"},{name:"toast",alias:"md",status:"applied",usedBy:"Toast"},{name:"card",alias:"sm",status:"applied",usedBy:"Card"}],u=({status:s})=>s==="applied"?e.jsx("span",{className:"rounded-full bg-success-subtle px-2 py-0.5 text-xs font-medium text-success-emphasis",children:"applied"}):e.jsx("span",{className:"rounded-full bg-warning-subtle px-2 py-0.5 text-xs font-medium text-warning-emphasis",children:"defined only"}),x=({shadow:s,label:d})=>e.jsxs("div",{className:"flex flex-col items-center gap-3",children:[e.jsx("div",{className:"h-24 w-40 rounded-xl bg-surface",style:{boxShadow:s},"aria-hidden":"true"}),e.jsx("span",{className:"text-xs font-mono text-foreground",children:d})]}),a={name:"Shadow Scale",render:()=>e.jsxs("div",{className:"max-w-3xl mx-auto px-8 py-12",children:[e.jsx(c,{children:"Elevation"}),e.jsxs(l,{children:["Schatten expresses elevation with a four-step shadow scale, defined in"," ",e.jsx("code",{children:"src/core/tokens/spacing.css"})," and registered in the public-token registrar (",e.jsx("code",{children:"src/styles/public-tokens.css"}),"). Every shadow is a translucent black (",e.jsx("code",{children:"rgb(0 0 0 / α)"}),"); it is mode-agnostic, so the same value reads as a softer shadow against a dark surface (see ",e.jsx("strong",{children:"Usage guide"}),")."]}),e.jsx(r,{children:"Primitive scale"}),e.jsxs(i,{children:["The raw ",e.jsx("code",{children:"--shadow-*"})," steps. Reach for a ",e.jsx("em",{children:"semantic"})," token (see"," ",e.jsx("strong",{children:"Semantic tokens"}),") in components; the primitives are the underlying values those aliases point at. ",e.jsx("code",{children:"--shadow-xl"})," ships in the scale but is currently mapped to no semantic alias and used by no component — reserved, not retired."]}),e.jsx("div",{className:"flex flex-wrap gap-8 p-8 bg-background",children:m.map(s=>e.jsx(x,{shadow:s.value,label:`--shadow-${s.token}`},s.token))}),e.jsx("div",{className:"mt-6 border border-border rounded-xl px-5",children:m.map(s=>e.jsxs("div",{className:"flex items-baseline gap-4 py-3 border-b border-border last:border-b-0",children:[e.jsxs("p",{className:"w-28 shrink-0 text-sm font-medium text-foreground font-mono",children:["--shadow-",s.token]}),e.jsx("code",{className:"flex-1 text-xs text-foreground-muted break-all",children:s.value})]},s.token))})]})},t={name:"Semantic Tokens",render:()=>e.jsxs("div",{className:"max-w-3xl mx-auto px-8 py-12",children:[e.jsx(c,{children:"Semantic tokens"}),e.jsxs(l,{children:["Components reference these intent-named tokens, not the raw scale. Each is a value-preserving alias over a primitive step — the table reads as"," ",e.jsx("strong",{children:"purpose → which primitive → which component uses it"}),". Tokens marked"," ",e.jsx("em",{children:"defined only"})," exist for forward use but are not wired to any surface yet."]}),e.jsx("div",{className:"border border-border rounded-xl px-5",children:p.map(s=>e.jsxs("div",{className:"flex items-center gap-4 py-4 border-b border-border last:border-b-0",children:[e.jsx("div",{className:"w-40 shrink-0 flex items-center justify-center py-2 bg-background",children:e.jsx("div",{className:"h-12 w-28 rounded-lg bg-surface",style:{boxShadow:`var(--shadow-${s.name})`},"aria-hidden":"true"})}),e.jsxs("div",{className:"flex-1",children:[e.jsxs("p",{className:"text-sm font-medium text-foreground font-mono",children:["--shadow-",s.name]}),e.jsxs("p",{className:"text-xs text-foreground-muted font-mono",children:["= --shadow-",s.alias]}),e.jsx("p",{className:"text-xs text-foreground-muted mt-1",children:s.usedBy})]}),e.jsx("div",{className:"w-28 shrink-0",children:e.jsx(u,{status:s.status})})]},s.name))})]})},n=({surface:s,token:d,note:h})=>e.jsxs("div",{className:"flex items-start gap-4 py-3 border-b border-border last:border-b-0",children:[e.jsx("p",{className:"w-28 shrink-0 text-sm font-medium text-foreground",children:s}),e.jsx("code",{className:"w-40 shrink-0 text-xs text-foreground-muted",children:d}),e.jsx("p",{className:"flex-1 text-sm text-foreground-muted",children:h})]}),o={name:"Usage Guide",render:()=>e.jsxs("div",{className:"max-w-3xl mx-auto px-8 py-12",children:[e.jsx(c,{children:"Usage guide"}),e.jsxs(l,{children:["Pick a shadow by what the surface ",e.jsx("em",{children:"is"}),", not by how deep you want it to look. The semantic token for each surface type already encodes the right depth."]}),e.jsx(r,{children:"By surface type"}),e.jsxs("div",{className:"border border-border rounded-xl px-5 mb-8",children:[e.jsx(n,{surface:"Card",token:"--shadow-card",note:"Resting content cards. Lowest elevation. (Alias of --shadow-sm; applied by Card.)"}),e.jsx(n,{surface:"Tooltip / Popover",token:"--shadow-popover",note:"Transient floating content layered just above the page."}),e.jsx(n,{surface:"Toast",token:"--shadow-toast",note:"Notifications that overlay content but are not modal."}),e.jsx(n,{surface:"Dialog / Modal",token:"--shadow-modal",note:"Focus-trapping surfaces. Highest elevation in the system today."})]}),e.jsx(r,{children:"Don't over-elevate"}),e.jsx(i,{children:"Shadow is a signal, not decoration. A flat surface (no shadow) is the right answer for most in-flow content — reserve elevation for things that genuinely float above the page. Stacking many shadowed surfaces flattens the hierarchy the shadow was meant to create."}),e.jsx(r,{children:"Dark mode"}),e.jsxs(i,{children:["Shadows are ",e.jsx("strong",{children:"mode-agnostic"}),": there is no dark-specific shadow token, and the"," ",e.jsx("code",{children:".dark"})," cascade does not override ",e.jsx("code",{children:"--shadow-*"}),". The same translucent black is applied in both modes, so a shadow reads as softer against a dark surface than against a light one. Toggle the Storybook theme to compare — the muted dark appearance is intended, not a missing token. (Re-tuning depth per mode is a possible future refinement.)"]})]})},v=["ShadowScale","SemanticTokens","UsageGuide"];a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  name: 'Shadow Scale',
...
}`,...o.parameters?.docs?.source}}};export{t as SemanticTokens,a as ShadowScale,o as UsageGuide,v as __namedExportsOrder,w as default};
