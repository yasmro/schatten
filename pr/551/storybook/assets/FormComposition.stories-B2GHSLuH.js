import{j as e,r as S}from"./iframe-Q-7Zj3Ct.js";import{B as y}from"./Button-DuXjAE-j.js";import{C as x}from"./Checkbox-BwFLcAhv.js";import{F as r}from"./Field-DqmmbesY.js";import{F as u}from"./FieldSet-SBzglJZ8.js";import{I as t}from"./Input-CO3DmhYo.js";import{R as k,a as g}from"./Radio-D_MNLueB.js";import{S as C,a as q,b as R,c as E,d as j}from"./Select-ptF1rbM-.js";import{S as N}from"./Switch-CKCUxOiq.js";import{N as s,S as I}from"./docs-ui-D0Lzeezu.js";import"./preload-helper-DUSBS5vW.js";import"./index-DPnazUT8.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css               */import"./Spinner-QdpqgASa.js";/* empty css                */import"./index-8k5_Nd5T.js";import"./index-C_iVNB6w.js";import"./index-C5S3HOSI.js";import"./index-C88_IEkQ.js";import"./index-B0VBQZoU.js";import"./index-Qm0ZzbsL.js";import"./index-BLsZNQv9.js";import"./field-BvkRLkeB.js";/* empty css                 */import"./Tooltip-5cWwGC0k.js";import"./index-C7GoUSIM.js";import"./index-DzDeP3Xp.js";import"./index-D-IzIQ0Z.js";import"./index-CSH6R3SF.js";import"./index-Ct3YrYPq.js";/* empty css                *//* empty css              */import"./info-CK878LKv.js";import"./createLucideIcon-BWa8aq_-.js";/* empty css                 *//* empty css              */import"./index-DW_SMBTO.js";import"./index-CBUZgVJW.js";/* empty css              */import"./Combination-BgBsTrHT.js";/* empty css               */import"./chevron-up-BwuD6fXW.js";import"./check-BUtLorq3.js";/* empty css               */const ve={title:"Patterns/Form Composition",parameters:{layout:"fullscreen"}},i={name:"1. Field basics",render:()=>e.jsxs("div",{className:"mx-auto mt-12 flex w-96 flex-col gap-4",children:[e.jsxs(s,{children:["A single Field wires the label, description, and required marker to the input. Note:"," ",e.jsx("code",{className:"text-xs",children:"required"})," renders the visual"," ",e.jsx("code",{className:"text-xs",children:"*"})," and sets ",e.jsx("code",{className:"text-xs",children:"aria-required"})," ","on the input (announce-only) — native validation is ",e.jsx("strong",{children:"not"})," enabled; add"," ",e.jsx("code",{className:"text-xs",children:"required"})," to the input element yourself when you want form-submission blocking."]}),e.jsx(r,{label:"Email",description:"Used when you sign in",required:!0,children:e.jsx(t,{type:"email",placeholder:"you@example.com"})})]})},n={name:"2. Error state",render:()=>e.jsxs("div",{className:"mx-auto mt-12 flex w-96 flex-col gap-4",children:[e.jsxs(s,{children:["Passing ",e.jsx("code",{className:"text-xs",children:"error"})," auto-derives"," ",e.jsx("code",{className:"text-xs",children:"isError"}),", which wires"," ",e.jsx("code",{className:"text-xs",children:'aria-invalid="true"'})," +"," ",e.jsx("code",{className:"text-xs",children:"aria-describedby"})," on the input. Meaning comes from the error text, not colour alone."]}),e.jsx(r,{label:"Email",error:"Enter a valid email address",required:!0,children:e.jsx(t,{type:"email",defaultValue:"invalid-email"})})]})},l={name:"3. Grouping with FieldSet",render:()=>e.jsxs("div",{className:"mx-auto mt-12 w-96",children:[e.jsxs(s,{children:["FieldSet renders a native ",e.jsx("code",{className:"text-xs",children:"<fieldset>"})," +"," ",e.jsx("code",{className:"text-xs",children:"<legend>"}),", and"," ",e.jsx("code",{className:"text-xs",children:"disabled"})," propagates to every descendant control. A nested"," ",e.jsx("code",{className:"text-xs",children:'direction="row"'})," FieldSet lays two fields side by side, tuned with ",e.jsx("code",{className:"text-xs",children:"flexGrow"})," /"," ",e.jsx("code",{className:"text-xs",children:"flexShrink"}),"."]}),e.jsxs(u,{legend:"Shipping address",description:"Where we deliver",children:[e.jsx(r,{label:"Street",required:!0,children:e.jsx(t,{placeholder:"1-2-3 Minato"})}),e.jsxs(u,{direction:"row",children:[e.jsx(r,{label:"City",required:!0,flexGrow:1,children:e.jsx(t,{placeholder:"Minato"})}),e.jsx(r,{label:"Postal code",required:!0,flexShrink:0,children:e.jsx(t,{placeholder:"100-0001",className:"w-32"})})]}),e.jsx(r,{label:"Country",children:e.jsxs(C,{defaultValue:"jp",children:[e.jsx(q,{children:e.jsx(R,{})}),e.jsxs(E,{children:[e.jsx(j,{value:"jp",children:"Japan"}),e.jsx(j,{value:"us",children:"United States"})]})]})})]})]})},d={name:"4. Checkbox / Radio / Switch",render:()=>e.jsxs("div",{className:"mx-auto mt-12 w-96",children:[e.jsxs(s,{children:["Checkbox / Switch / Radio carry their own ",e.jsx("code",{className:"text-xs",children:"<label>"}),", so they are ",e.jsx("strong",{children:"not"})," wrapped in Field — group them directly under a FieldSet. Radio is wrapped in a RadioGroup, and that group is wrapped by a single Field for its group label."]}),e.jsxs("div",{className:"flex flex-col gap-8",children:[e.jsxs(u,{legend:"Notifications",description:"Choose any",children:[e.jsx(x,{label:"Email",defaultChecked:!0}),e.jsx(x,{label:"SMS"}),e.jsx(x,{label:"Push",defaultChecked:!0})]}),e.jsx(r,{label:"Plan",required:!0,children:e.jsxs(k,{defaultValue:"pro",children:[e.jsx(g,{value:"free",label:"Free"}),e.jsx(g,{value:"pro",label:"Pro"}),e.jsx(g,{value:"enterprise",label:"Enterprise"})]})}),e.jsxs(u,{legend:"Display",children:[e.jsx(N,{label:"Dark mode"}),e.jsx(N,{label:"High contrast"})]})]})]})},c={name:"5. Complete sign-up form",render:()=>{const[a,b]=S.useState(!1),[p,F]=S.useState({}),v=f=>{f.preventDefault();const h=new FormData(f.currentTarget),w=h.get("password"),o={};h.get("email")||(o.email="Email is required"),w?w!==h.get("passwordConfirm")&&(o.passwordConfirm="Passwords do not match"):o.password="Password is required",F(o),Object.keys(o).length===0&&(b(!0),setTimeout(()=>b(!1),1200))};return e.jsxs("div",{className:"mx-auto mt-12 w-96",children:[e.jsxs(s,{children:["Errors live in one state object;"," ",e.jsxs("code",{className:"text-xs",children:["disabled=","{submitting}"]})," plus Button"," ",e.jsx("code",{className:"text-xs",children:"isLoading"})," (which sets"," ",e.jsx("code",{className:"text-xs",children:'aria-busy="true"'}),") keep the form consistent while the simulated request runs."]}),e.jsxs("form",{onSubmit:v,className:"flex flex-col gap-4",children:[e.jsx(r,{label:"Email",required:!0,error:p.email,children:e.jsx(t,{type:"email",name:"email",disabled:a})}),e.jsx(r,{label:"Password",required:!0,error:p.password,children:e.jsx(t,{type:"password",name:"password",disabled:a})}),e.jsx(r,{label:"Password (confirm)",required:!0,error:p.passwordConfirm,children:e.jsx(t,{type:"password",name:"passwordConfirm",disabled:a})}),e.jsx(x,{label:"I agree to the terms",name:"agree",disabled:a}),e.jsx(y,{type:"submit",isLoading:a,className:"self-start",children:"Sign up"})]})]})}},m={name:"6. react-hook-form integration",render:()=>e.jsxs("div",{className:"mx-auto max-w-2xl px-8 py-12",children:[e.jsx(I,{children:"react-hook-form integration"}),e.jsxs(s,{children:["Recommended pattern for pairing with ",e.jsx("code",{className:"text-xs",children:"react-hook-form"}),". The snippet below works as-is — the three Schatten-side guarantees that make it work:"]}),e.jsxs("ul",{className:"flex list-disc flex-col gap-2 pl-6 text-sm text-foreground-muted",children:[e.jsxs("li",{children:[e.jsx("code",{className:"text-xs",children:"Input"})," is ",e.jsx("code",{className:"text-xs",children:"forwardRef"}),"-ed, so spreading ",e.jsx("code",{className:"text-xs",children:"{...register(...)}"})," alone delivers the ref / onChange."]}),e.jsxs("li",{children:[e.jsx("code",{className:"text-xs",children:"Select"})," / ",e.jsx("code",{className:"text-xs",children:"RadioGroup"})," /"," ",e.jsx("code",{className:"text-xs",children:"Switch"})," are controlled, so wrap them in"," ",e.jsx("code",{className:"text-xs",children:"Controller"}),"."]}),e.jsxs("li",{children:["Pass ",e.jsx("code",{className:"text-xs",children:"errors.<name>?.message"})," straight into the Field"," ",e.jsx("code",{className:"text-xs",children:"error"})," prop."]})]}),e.jsx("pre",{className:"mt-4 overflow-x-auto rounded-md border border-border bg-surface-hover p-4 text-xs text-foreground",children:e.jsx("code",{children:`import { useForm } from 'react-hook-form'
...
}`})}),e.jsxs(s,{children:["TanStack Form / Conform work the same way — wrap controlled components in their"," ",e.jsx("code",{className:"text-xs",children:"Controller"})," equivalent."]})]})},ye=["BasicField","FieldWithError","FieldSetGrouping","CheckboxRadioSwitch","CompleteSignUpForm","WithReactHookForm"];i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  name: '1. Field basics',
...
}`,...m.parameters?.docs?.source}}};export{i as BasicField,d as CheckboxRadioSwitch,c as CompleteSignUpForm,l as FieldSetGrouping,n as FieldWithError,m as WithReactHookForm,ye as __namedExportsOrder,ve as default};
