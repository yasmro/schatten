import{j as e}from"./iframe-Q-7Zj3Ct.js";import{I as o}from"./Icon-fQSSJYaW.js";import{S as n}from"./search-Bm_PVIJL.js";import{S as c,A as p,C as u,E as f,D as x,a as g}from"./star-S3uE0iDG.js";import{C as m}from"./circle-alert-DVeCNbaT.js";import{A as v}from"./arrow-right-Dxc1KrX7.js";import{A as h,a as y}from"./arrow-up-CofsLcoD.js";import{C}from"./chevron-right-ClQLlGRq.js";import{C as w,a as N}from"./chevron-up-BwuD6fXW.js";import{C as S}from"./check-BUtLorq3.js";import{X as j}from"./x-48ATuIqe.js";import{P as b}from"./plus-D_b6hAPH.js";import{M as z,P as A,E as I,U as T,B as L,C as k}from"./upload-C_56KYrN.js";import{S as E}from"./settings-FNIc4S5R.js";import{T as U}from"./trash-BsRobO0j.js";import{C as O}from"./copy-BjrEn5r1.js";import{I as P}from"./info-CK878LKv.js";import{C as R,T as D}from"./triangle-alert-F1hZ--OF.js";import{U as G}from"./user-CYc14UEV.js";import"./preload-helper-DUSBS5vW.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css             */import"./createLucideIcon-BWa8aq_-.js";const l=["inherit","default","muted","subtle","vermillion","indigo","error","success","warning","info","inverted","inverted-muted","inverted-subtle"],me={title:"Components/lv1/Icon",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{icon:{description:"Lucide icon component to render. Import it from `lucide-react` and pass it directly.",control:!1,table:{type:{summary:"LucideIcon"}}},size:{description:"Size of the icon.",control:"select",options:["sm","md","lg"],table:{type:{summary:'"sm" | "md" | "lg"'},defaultValue:{summary:"md"}}},color:{description:"Color of the icon. Vocabulary mirrors `Text`’s `color`.",control:"select",options:l,table:{type:{summary:l.map(r=>`"${r}"`).join(" | ")},defaultValue:{summary:"inherit"}}},"aria-label":{description:'Accessible label. Forwarded to the `<svg>` as-is — the component never overrides it. Its presence is what toggles the icon between decorative and meaningful: omitted → `aria-hidden="true"` is auto-applied; provided → `role="img"` is auto-applied. Those two auto-applied attributes can still be overridden by passing `aria-hidden` / `role` explicitly.',control:"text",table:{type:{summary:"string"},defaultValue:{summary:'none — icon is decorative (aria-hidden="true")'}}}},args:{icon:n,size:"md",color:"inherit"}},a={},s={name:"Sizes",render:()=>e.jsxs("div",{className:"flex items-end gap-4",children:[e.jsx(o,{icon:n,size:"sm"}),e.jsx(o,{icon:n,size:"md"}),e.jsx(o,{icon:n,size:"lg"})]})},i={name:"Colors",parameters:{docs:{description:{story:"The `color` vocabulary mirrors `Text`. `inverted-*` colors are previewed on a dark surface."}}},render:()=>e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex flex-wrap items-center gap-4",children:["default","muted","subtle","vermillion","indigo"].map(r=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(o,{icon:c,size:"lg",color:r}),e.jsx("span",{className:"text-xs text-foreground-muted",children:r})]},r))}),e.jsx("div",{className:"flex flex-wrap items-center gap-4",children:["error","success","warning","info"].map(r=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(o,{icon:m,size:"lg",color:r}),e.jsx("span",{className:"text-xs text-foreground-muted",children:r})]},r))}),e.jsx("div",{className:"flex flex-wrap items-center gap-4 rounded-md bg-foreground p-4",children:["inverted","inverted-muted","inverted-subtle"].map(r=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(o,{icon:c,size:"lg",color:r}),e.jsx("span",{className:"text-xs text-inverted-foreground-muted",children:r})]},r))})]})},_=[{name:"ArrowRight",icon:v},{name:"ArrowLeft",icon:p},{name:"ArrowUp",icon:h},{name:"ArrowDown",icon:y},{name:"ChevronRight",icon:C},{name:"ChevronLeft",icon:u},{name:"ChevronDown",icon:w},{name:"ChevronUp",icon:N},{name:"Check",icon:S},{name:"X",icon:j},{name:"Plus",icon:b},{name:"Minus",icon:z},{name:"Search",icon:n},{name:"Settings",icon:E},{name:"Trash2",icon:U},{name:"Pencil",icon:A},{name:"Copy",icon:O},{name:"Eye",icon:f},{name:"EyeOff",icon:I},{name:"Info",icon:P},{name:"CircleAlert",icon:m},{name:"CircleCheck",icon:R},{name:"TriangleAlert",icon:D},{name:"Download",icon:x},{name:"Upload",icon:T},{name:"ExternalLink",icon:g},{name:"Bell",icon:L},{name:"Calendar",icon:k},{name:"User",icon:G},{name:"Star",icon:c}],t={name:"Gallery",parameters:{docs:{description:{story:"A representative selection of `lucide-react` icons. `Icon` accepts any lucide icon — this gallery is documentation, not an allowlist."}}},render:()=>e.jsx("div",{className:"grid grid-cols-6 gap-6",children:_.map(({name:r,icon:d})=>e.jsxs("div",{className:"flex flex-col items-center gap-2",children:[e.jsx(o,{icon:d,size:"lg",color:"default"}),e.jsx("span",{className:"text-xs text-foreground-muted",children:r})]},r))})},de=["Playground","Sizes","Colors","Gallery"];a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"{}",...a.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  name: 'Sizes',
...
}`,...t.parameters?.docs?.source}}};export{i as Colors,t as Gallery,a as Playground,s as Sizes,de as __namedExportsOrder,me as default};
