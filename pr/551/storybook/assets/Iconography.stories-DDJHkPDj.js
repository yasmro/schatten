import{j as e}from"./iframe-Q-7Zj3Ct.js";import{I as s}from"./Icon-fQSSJYaW.js";import{P as c,L as t,a as r,N as o,C as i,S as a}from"./docs-ui-D0Lzeezu.js";import{S as u}from"./search-Bm_PVIJL.js";import{A as y}from"./arrow-right-Dxc1KrX7.js";import{A as b,C as N,E as w,D as S,a as I,S as p}from"./star-S3uE0iDG.js";import{A as T,a as k}from"./arrow-up-CofsLcoD.js";import{C}from"./chevron-right-ClQLlGRq.js";import{C as L,a as z}from"./chevron-up-BwuD6fXW.js";import{C as A}from"./check-BUtLorq3.js";import{X as D}from"./x-48ATuIqe.js";import{P as B}from"./plus-D_b6hAPH.js";import{M as P,P as E,E as U,U as O,B as R,C as G}from"./upload-C_56KYrN.js";import{S as W}from"./settings-FNIc4S5R.js";import{T as f}from"./trash-BsRobO0j.js";import{C as _}from"./copy-BjrEn5r1.js";import{I as M}from"./info-CK878LKv.js";import{C as v}from"./circle-alert-DVeCNbaT.js";import{C as F,T as q}from"./triangle-alert-F1hZ--OF.js";import{U as V}from"./user-CYc14UEV.js";import"./preload-helper-DUSBS5vW.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css             */import"./createLucideIcon-BWa8aq_-.js";const je={title:"Tokens/Iconography",parameters:{layout:"fullscreen"}},X=({items:n})=>e.jsx("ul",{className:"mb-3 ml-5 list-disc space-y-1 text-sm text-foreground-muted",children:n.map((g,j)=>e.jsx("li",{children:g},j))}),d={name:"Why lucide-react",render:()=>e.jsxs("div",{className:"mx-auto max-w-3xl px-8 py-12",children:[e.jsx(c,{children:"Iconography"}),e.jsxs(t,{children:["Schatten standardizes on ",e.jsx("code",{children:"lucide-react"})," for all iconography. Icons are rendered through the ",e.jsx("code",{children:"Icon"})," component, which normalizes size and color and wires the right accessibility attributes. This page explains why Lucide, how to use ",e.jsx("code",{children:"Icon"}),", and the patterns to follow and avoid."]}),e.jsx(a,{children:"Why lucide-react"}),e.jsx(X,{items:[e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:"Lightweight & tree-shakeable"})," — each icon is its own ES module, so only the icons you import ship in the bundle."]}),e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:"Modern & actively maintained"})," — a consistent 24×24 grid and stroke language across 1000+ icons, with regular releases."]}),e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:"shadcn/ui alignment"})," — Lucide is shadcn/ui's default icon set, and Schatten follows shadcn conventions as its baseline."]}),e.jsxs(e.Fragment,{children:[e.jsx("strong",{children:"One vendor, one contract"})," — a single icon source keeps sizing, stroke weight, and visual rhythm uniform across the whole design system."]})]})]})},l={name:"Usage",render:()=>e.jsxs("div",{className:"mx-auto max-w-3xl px-8 py-12",children:[e.jsx(c,{children:"Usage"}),e.jsxs(t,{children:["Import the icon you need from ",e.jsx("code",{children:"lucide-react"})," and pass the component to"," ",e.jsx("code",{children:"Icon"})," via the ",e.jsx("code",{children:"icon"})," prop — not a name string."]}),e.jsx(i,{children:`import { Search } from 'lucide-react'
import { Icon } from '@yasmro/schatten'

<Icon icon={Search} />`}),e.jsx(a,{children:"Size"}),e.jsxs(o,{children:["Three sizes: ",e.jsx("code",{children:"sm"})," (16px) / ",e.jsx("code",{children:"md"})," (20px, default) / ",e.jsx("code",{children:"lg"})," ","(24px). For a one-off size outside the scale, pass a Tailwind sizing class via"," ",e.jsx("code",{children:"className"})," (e.g. ",e.jsx("code",{children:'className="size-8"'}),") instead."]}),e.jsx("div",{className:"flex items-end gap-6",children:["sm","md","lg"].map(n=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{icon:u,size:n,color:"default"}),e.jsx("span",{className:"font-mono text-xs text-foreground-muted",children:n})]},n))}),e.jsx(a,{children:"Color"}),e.jsxs(o,{children:["The ",e.jsx("code",{children:"color"})," vocabulary mirrors ",e.jsx("code",{children:"Text"})," so an icon and its adjacent label share one token. It defaults to ",e.jsx("code",{children:"inherit"})," (takes the surrounding"," ",e.jsx("code",{children:"currentColor"}),"), which keeps ",e.jsx("code",{children:"Icon"})," composition-safe inside an already-colored surface such as a solid Button. ",e.jsx("code",{children:"inverted-*"})," colors are previewed on a dark surface."]}),e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx("div",{className:"flex flex-wrap items-center gap-4",children:["default","muted","subtle","vermillion","indigo"].map(n=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{icon:p,size:"lg",color:n}),e.jsx("span",{className:"font-mono text-xs text-foreground-muted",children:n})]},n))}),e.jsx("div",{className:"flex flex-wrap items-center gap-4",children:["error","success","warning","info"].map(n=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{icon:v,size:"lg",color:n}),e.jsx("span",{className:"font-mono text-xs text-foreground-muted",children:n})]},n))}),e.jsx("div",{className:"flex flex-wrap items-center gap-4 rounded-md bg-foreground p-4",children:["inverted","inverted-muted","inverted-subtle"].map(n=>e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{icon:p,size:"lg",color:n}),e.jsx("span",{className:"font-mono text-xs text-inverted-foreground-muted",children:n})]},n))})]}),e.jsx(a,{children:"Accessibility"}),e.jsxs(o,{children:["Accessibility is driven by the standard ",e.jsx("code",{children:"aria-label"})," attribute — there is no dedicated prop. Omit it for decorative icons (",e.jsx("code",{children:'aria-hidden="true"'})," is applied automatically); provide it for meaningful icons (",e.jsx("code",{children:'role="img"'})," is applied, so the icon is queryable via ",e.jsxs("code",{children:["getByRole('img', ","{ name }",")"]}),")."]}),e.jsxs("div",{className:"flex flex-wrap gap-8",children:[e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{icon:p,size:"lg",color:"default"}),e.jsx("span",{className:"font-mono text-xs text-foreground-muted",children:"decorative"}),e.jsx("span",{className:"text-xs text-foreground-muted",children:'aria-hidden="true"'})]}),e.jsxs("div",{className:"flex flex-col items-center gap-1",children:[e.jsx(s,{icon:f,size:"lg",color:"default","aria-label":"Delete"}),e.jsx("span",{className:"font-mono text-xs text-foreground-muted",children:'aria-label="Delete"'}),e.jsx("span",{className:"text-xs text-foreground-muted",children:'role="img"'})]})]}),e.jsx(i,{children:`<Icon icon={Star} />                      // decorative -> aria-hidden="true"
<Icon icon={Trash2} aria-label="Delete" /> // meaningful  -> role="img"`})]})},m={name:"Pass the component, not a name",render:()=>e.jsxs("div",{className:"mx-auto max-w-3xl px-8 py-12",children:[e.jsx(c,{children:"Pass the component, not a name"}),e.jsxs(t,{children:[e.jsx("code",{children:"Icon"})," takes a Lucide ",e.jsx("em",{children:"component"})," (",e.jsxs("code",{children:["icon=","{Search}"]}),"), not a name string (",e.jsx("code",{children:'name="Search"'}),"). This is a deliberate design choice with three benefits."]}),e.jsx(a,{children:"1. Tree-shaking"}),e.jsx(o,{children:"Only the icons you actually import end up in the bundle. A name-string API would have to reference a map of every possible icon, defeating tree-shaking."}),e.jsx(a,{children:"2. Typos become build errors"}),e.jsxs(o,{children:["A misspelled component name is a compile-time error. A misspelled ",e.jsx("em",{children:"string"})," would fail silently at runtime (an undefined icon)."]}),e.jsx(i,{children:`// component — a typo is a build error
import { Search } from 'lucide-react'
<Icon icon={Search} />

// there is no \`name\` prop in Schatten — this does not type-check
<Icon name="Search" />
<Icon name="Serach" />  // …and a typo could never be caught at build time`}),e.jsx(a,{children:"3. No allowlist to maintain"}),e.jsxs(o,{children:[e.jsx("code",{children:"Icon"})," accepts ",e.jsx("strong",{children:"any"})," Lucide icon — there is no"," ",e.jsx("code",{children:"ICON_MAP"})," or allowlist file to keep in sync. The vendor is fixed to Lucide (the"," ",e.jsx("code",{children:"icon"})," prop is typed ",e.jsx("code",{children:"LucideIcon"}),"); widening to a vendor-agnostic type later is an additive, non-breaking change."]})]})},Y=[{name:"ArrowRight",icon:y},{name:"ArrowLeft",icon:b},{name:"ArrowUp",icon:T},{name:"ArrowDown",icon:k},{name:"ChevronRight",icon:C},{name:"ChevronLeft",icon:N},{name:"ChevronDown",icon:L},{name:"ChevronUp",icon:z},{name:"Check",icon:A},{name:"X",icon:D},{name:"Plus",icon:B},{name:"Minus",icon:P},{name:"Search",icon:u},{name:"Settings",icon:W},{name:"Trash2",icon:f},{name:"Pencil",icon:E},{name:"Copy",icon:_},{name:"Eye",icon:w},{name:"EyeOff",icon:U},{name:"Info",icon:M},{name:"CircleAlert",icon:v},{name:"CircleCheck",icon:F},{name:"TriangleAlert",icon:q},{name:"Download",icon:S},{name:"Upload",icon:O},{name:"ExternalLink",icon:I},{name:"Bell",icon:R},{name:"Calendar",icon:G},{name:"User",icon:V},{name:"Star",icon:p}],h={name:"Gallery",render:()=>e.jsxs("div",{className:"mx-auto max-w-3xl px-8 py-12",children:[e.jsx(c,{children:"Gallery"}),e.jsxs(t,{children:["A representative selection of ",e.jsx("code",{children:"lucide-react"})," icons commonly used across Schatten components. ",e.jsx("strong",{children:"This is documentation, not an allowlist"})," — ",e.jsx("code",{children:"Icon"})," ","accepts any of Lucide's 1000+ icons. Browse the full set at"," ",e.jsx("a",{href:"https://lucide.dev/icons",target:"_blank",rel:"noreferrer",className:"text-info underline",children:"lucide.dev/icons"}),"."]}),e.jsx("div",{className:"grid grid-cols-6 gap-6",children:Y.map(({name:n,icon:g})=>e.jsxs("div",{className:"flex flex-col items-center gap-2",children:[e.jsx(s,{icon:g,size:"lg",color:"default"}),e.jsx("span",{className:"font-mono text-xs text-foreground-muted",children:n})]},n))})]})},x={name:"Do's and Don'ts",render:()=>e.jsxs("div",{className:"mx-auto max-w-3xl px-8 py-12",children:[e.jsx(c,{children:"Do's & Don'ts"}),e.jsxs(t,{children:["All of these render — the difference is consistency and accessibility. Always go through"," ",e.jsx("code",{children:"Icon"})," so size, color tokens, and a11y defaults stay uniform."]}),e.jsxs("div",{className:"grid grid-cols-2 gap-6",children:[e.jsxs("div",{children:[e.jsx(r,{children:"✅ Wrap in Icon"}),e.jsx(o,{children:"Size, color tokens, and a11y defaults are applied."}),e.jsx("div",{className:"rounded-lg border border-success bg-success-subtle p-4",children:e.jsx(s,{icon:u,size:"lg",color:"default"})}),e.jsx(i,{children:"<Icon icon={Search} />"})]}),e.jsxs("div",{children:[e.jsx(r,{children:"❌ Raw Lucide element"}),e.jsx(o,{children:"Bypasses the size scale, color tokens, and a11y defaults."}),e.jsx("div",{className:"rounded-lg border border-warning bg-warning-subtle p-4 text-foreground",children:e.jsx(u,{})}),e.jsx(i,{children:"<Search />  // not normalized"})]})]}),e.jsxs("div",{className:"mt-6 grid grid-cols-2 gap-6",children:[e.jsxs("div",{children:[e.jsx(r,{children:"✅ Label a meaningful icon"}),e.jsx(o,{children:'Exposed as role="img" with an accessible name.'}),e.jsx(i,{children:'<Icon icon={Trash2} aria-label="Delete" />'})]}),e.jsxs("div",{children:[e.jsx(r,{children:"❌ aria-hidden on a labelled icon"}),e.jsx(o,{children:"Contradicts the label and drops it from the a11y tree — Icon warns in dev."}),e.jsx(i,{children:'<Icon icon={Trash2} aria-label="Delete" aria-hidden />'})]})]}),e.jsx(a,{children:"Don't hand-write SVG for icons Lucide already ships"}),e.jsxs(o,{children:["If the icon exists in Lucide, use it through ",e.jsx("code",{children:"Icon"})," so sizing, color tokens, and accessibility stay consistent. Reserve a raw ",e.jsx("code",{children:"<svg>"})," for genuinely custom marks that are not part of the icon set."]})]})},ye=["WhyLucide","Usage","PassTheComponent","Gallery","DosAndDonts"];d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
}`,...x.parameters?.docs?.source}}};export{x as DosAndDonts,h as Gallery,m as PassTheComponent,l as Usage,d as WhyLucide,ye as __namedExportsOrder,je as default};
