import{j as e}from"./iframe-Q-7Zj3Ct.js";import{I as a}from"./Input-CO3DmhYo.js";import{X as v}from"./x-48ATuIqe.js";import{T as w}from"./trash-BsRobO0j.js";import{T as I,S as D,a as R,G as b,C as L}from"./tag-Bm9Zd357.js";import{S as j,E as h,a as S,D as E,C as O,A as T}from"./star-S3uE0iDG.js";import{S as x}from"./search-Bm_PVIJL.js";import{P as V}from"./plus-D_b6hAPH.js";import{M as f}from"./mail-D2QEgDKy.js";import{L as y}from"./lock-Ci9hxzSG.js";import{C as g}from"./circle-alert-DVeCNbaT.js";import{C as N}from"./chevron-right-ClQLlGRq.js";import{C}from"./check-BUtLorq3.js";import{A as k}from"./arrow-right-Dxc1KrX7.js";import"./preload-helper-DUSBS5vW.js";import"./field-BvkRLkeB.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css              */import"./createLucideIcon-BWa8aq_-.js";const ae={title:"Components/lv1/Input",component:a,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{size:{description:"Size of the input.",control:"select",options:["sm","md","lg"],table:{type:{summary:'"sm" | "md" | "lg"'},defaultValue:{summary:"md"}}},isError:{description:"Displays the input in an error state with error border and ring.",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},textLeft:{description:"Text displayed before the input. Takes priority over iconLeft.",control:"text",table:{type:{summary:"string"}}},textRight:{description:"Text displayed after the input. Takes priority over iconRight.",control:"text",table:{type:{summary:"string"}}},iconLeft:{description:"Lucide icon component rendered before the input. Ignored when textLeft is set. Import the icon from `lucide-react` and pass it directly (e.g. `iconLeft={Search}`).",control:"select",options:["ArrowLeft","ArrowRight","Check","ChevronLeft","ChevronRight","CircleAlert","Clock","Download","ExternalLink","Eye","Globe","Lock","Mail","Plus","Search","Send","Sparkles","Star","Tag","Trash2","X"],mapping:{ArrowLeft:T,ArrowRight:k,Check:C,ChevronLeft:O,ChevronRight:N,CircleAlert:g,Clock:L,Download:E,ExternalLink:S,Eye:h,Globe:b,Lock:y,Mail:f,Plus:V,Search:x,Send:R,Sparkles:D,Star:j,Tag:I,Trash2:w,X:v},table:{type:{summary:"LucideIcon"}}},iconRight:{description:"Lucide icon component rendered after the input. Ignored when textRight is set. Import the icon from `lucide-react` and pass it directly.",control:"select",options:["ArrowLeft","ArrowRight","Check","ChevronLeft","ChevronRight","CircleAlert","Clock","Download","ExternalLink","Eye","Globe","Lock","Mail","Plus","Search","Send","Sparkles","Star","Tag","Trash2","X"],mapping:{ArrowLeft:T,ArrowRight:k,Check:C,ChevronLeft:O,ChevronRight:N,CircleAlert:g,Clock:L,Download:E,ExternalLink:S,Eye:h,Globe:b,Lock:y,Mail:f,Plus:V,Search:x,Send:R,Sparkles:D,Star:j,Tag:I,Trash2:w,X:v},table:{type:{summary:"LucideIcon"}}},placeholder:{description:"Placeholder text displayed when the input is empty.",control:"text",table:{type:{summary:"string"}}},disabled:{description:"Disables the input and applies disabled styling.",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},readOnly:{description:"Makes the input read-only. The value is focusable and selectable but not editable, and is still submitted with the form. Renders with a warm-tinted readOnly surface to differentiate from disabled.",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},type:{description:"HTML input type.",control:"select",options:["text","email","password","number","search","tel","url","date","datetime-local"],table:{type:{summary:"string"},defaultValue:{summary:"text"}}}}},r={name:"Playground",args:{placeholder:"Enter text...",size:"md"}},t={name:"Sizes",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-72",children:[e.jsx(a,{size:"sm",placeholder:"Small"}),e.jsx(a,{size:"md",placeholder:"Medium"}),e.jsx(a,{size:"lg",placeholder:"Large"})]})},l={name:"Types",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-72",children:[e.jsx(a,{type:"text",placeholder:"Text"}),e.jsx(a,{type:"email",placeholder:"Email"}),e.jsx(a,{type:"password",placeholder:"Password"}),e.jsx(a,{type:"number",placeholder:"Number"}),e.jsx(a,{type:"search",placeholder:"Search"}),e.jsx(a,{type:"date","aria-label":"Date"}),e.jsx(a,{type:"datetime-local","aria-label":"Date and time"})]})},s={name:"With Text",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-80",children:[e.jsx(a,{textLeft:"https://",placeholder:"example.com"}),e.jsx(a,{textRight:".com",placeholder:"domain"}),e.jsx(a,{textLeft:"$",textRight:"USD",placeholder:"0.00"})]})},o={name:"With Icons",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-72",children:[e.jsx(a,{iconLeft:x,placeholder:"Search..."}),e.jsx(a,{iconLeft:f,placeholder:"Email"}),e.jsx(a,{iconRight:h,type:"password",placeholder:"Password"})]})},i={name:"Text Priority over Icon",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-80",children:[e.jsx(a,{textLeft:"https://",iconLeft:b,placeholder:"textLeft wins over iconLeft"}),e.jsx(a,{textRight:"@gmail.com",iconRight:f,placeholder:"textRight wins over iconRight"})]})},n={name:"Error",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-72",children:[e.jsx(a,{isError:!0,placeholder:"Error state"}),e.jsx(a,{isError:!0,defaultValue:"Invalid input","aria-label":"Invalid input"}),e.jsx(a,{isError:!0,iconLeft:g,placeholder:"With icon"})]})},d={name:"Disabled",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-72",children:[e.jsx(a,{disabled:!0,placeholder:"Disabled"}),e.jsx(a,{disabled:!0,defaultValue:"Disabled with value","aria-label":"Disabled with value"}),e.jsx(a,{disabled:!0,iconLeft:x,iconRight:h,defaultValue:"Disabled with icons","aria-label":"Disabled with icons"}),e.jsx(a,{disabled:!0,textLeft:"https://",textRight:".com",defaultValue:"Disabled with text","aria-label":"Disabled with text affixes"})]})},c={name:"Disabled with error",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-72",children:[e.jsx(a,{disabled:!0,isError:!0,placeholder:"Disabled + error"}),e.jsx(a,{disabled:!0,isError:!0,defaultValue:"Disabled + error","aria-label":"Disabled with error"})]})},p={name:"ReadOnly",render:()=>e.jsxs("div",{className:"flex flex-col gap-4 w-72",children:[e.jsx(a,{readOnly:!0,defaultValue:"Read-only value","aria-label":"Read-only value"}),e.jsx(a,{readOnly:!0,iconLeft:y,defaultValue:"With icon","aria-label":"With icon"}),e.jsx(a,{readOnly:!0,textLeft:"ID",defaultValue:"usr_123456","aria-label":"User ID"})]})},u={name:"Disabled vs ReadOnly",render:()=>e.jsxs("div",{className:"flex flex-col gap-3 w-72",children:[e.jsx("div",{className:"text-xs text-foreground-muted",children:"Default"}),e.jsx(a,{defaultValue:"Editable value","aria-label":"Editable value"}),e.jsx("div",{className:"text-xs text-foreground-muted mt-2",children:"ReadOnly (informational)"}),e.jsx(a,{readOnly:!0,defaultValue:"Read-only value","aria-label":"Read-only value"}),e.jsx("div",{className:"text-xs text-foreground-muted mt-2",children:"Disabled (cannot interact)"}),e.jsx(a,{disabled:!0,defaultValue:"Disabled value","aria-label":"Disabled value"})]})},m={name:"ReadOnly with error",render:()=>e.jsx("div",{className:"flex flex-col gap-4 w-72",children:e.jsx(a,{readOnly:!0,isError:!0,defaultValue:"ReadOnly + error","aria-label":"ReadOnly with error"})})},re=["Playground","Sizes","Types","WithText","WithIcons","TextOverridesIcon","ErrorState","Disabled","DisabledWithError","ReadOnly","DisabledVsReadOnly","ReadOnlyWithError"];r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...
  render: () => <div className="flex flex-col gap-4 w-72">
      ...
      {/* Adornments must recede with the block — an icon / text affix that
          ...
          value it decorates. */}
      <Input disabled iconLeft={Search} iconRight={Eye} defaultValue="Disabled with icons" aria-label="Disabled with icons" />
      <Input disabled textLeft="https://" textRight=".com" defaultValue="Disabled with text" aria-label="Disabled with text affixes" />
    </div>
...
}`,...m.parameters?.docs?.source}}};export{d as Disabled,u as DisabledVsReadOnly,c as DisabledWithError,n as ErrorState,r as Playground,p as ReadOnly,m as ReadOnlyWithError,t as Sizes,i as TextOverridesIcon,l as Types,o as WithIcons,s as WithText,re as __namedExportsOrder,ae as default};
