import{j as e}from"./iframe-Q-7Zj3Ct.js";import{S as h,b as A,s as k,a as C}from"./scoped-theme-css-BlBrCmtQ.js";import{g as D}from"./index-BjhfJjZn.js";import{P as u,L as x,S as P,N as B,C as E}from"./docs-ui-D0Lzeezu.js";import{T as l}from"./Text-Bu9UCibx.js";import{B as o}from"./Button-DuXjAE-j.js";import{B as y}from"./Badge-zrbl6OP8.js";import{C as T}from"./Callout-BWupUnzj.js";import{F as w}from"./Field-DqmmbesY.js";import{I as L}from"./Input-CO3DmhYo.js";import{S as R,a as I,b as M,c as O,d as b}from"./Select-ptF1rbM-.js";import"./preload-helper-DUSBS5vW.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css             */import"./index-DPnazUT8.js";/* empty css               */import"./Spinner-QdpqgASa.js";/* empty css                *//* empty css              *//* empty css                */import"./circle-alert-DVeCNbaT.js";import"./createLucideIcon-BWa8aq_-.js";import"./triangle-alert-F1hZ--OF.js";import"./info-CK878LKv.js";import"./x-48ATuIqe.js";import"./field-BvkRLkeB.js";import"./Tooltip-5cWwGC0k.js";import"./index-C_iVNB6w.js";import"./index-8k5_Nd5T.js";import"./index-C7GoUSIM.js";import"./index-B0VBQZoU.js";import"./index-Qm0ZzbsL.js";import"./index-BLsZNQv9.js";import"./index-DzDeP3Xp.js";import"./index-D-IzIQ0Z.js";import"./index-CSH6R3SF.js";import"./index-C5S3HOSI.js";import"./index-C88_IEkQ.js";import"./index-Ct3YrYPq.js";/* empty css                *//* empty css              *//* empty css              */import"./index-CBUZgVJW.js";import"./Combination-BgBsTrHT.js";/* empty css               */import"./chevron-up-BwuD6fXW.js";import"./check-BUtLorq3.js";const V=A(".seasonal-showcase-cell",{semanticCss:C,seasonalCss:k}),_=["light","dark"],v=h.map(s=>s.id),z=[50,100,200,300,400,500,600,700,800,900,950];function g(){return e.jsx("style",{children:V})}function S({mode:s,season:a,className:n="",children:i}){return e.jsx("div",{className:`seasonal-showcase-cell ${s==="dark"?"dark":""} rounded-lg border border-border bg-background ${n}`,"data-theme":a??void 0,children:i})}function U(){return e.jsx("div",{className:"flex gap-1","aria-hidden":"true",children:z.map(s=>e.jsx("span",{className:"h-5 flex-1 rounded-sm border border-border",style:{backgroundColor:`var(--color-theme-${s})`},title:`theme-${s}`},s))})}function j(){return e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx(U,{}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx(o,{variant:"primary",size:"sm",children:"Primary"}),e.jsx(o,{variant:"secondary",size:"sm",children:"Secondary"}),e.jsx(o,{variant:"destructive",size:"sm",children:"Delete"}),e.jsx(y,{variant:"neutral",appearance:"solid",children:"Neutral"})]}),e.jsx(T,{variant:"neutral",appearance:"solid",title:"Seasonal surface",children:"Solid surfaces ride the active seasonal ramp."})]})}const ze={title:"Theming/Seasonal Showcase",tags:["!dev"],parameters:{layout:"fullscreen"}},d={name:"Eight Seasons",render:()=>e.jsxs("div",{className:"p-6",children:[e.jsx(g,{}),e.jsxs("div",{className:"mx-auto max-w-6xl",children:[e.jsx(u,{children:"Seasonal Showcase"}),e.jsx(x,{children:"Schatten ships eight seasonal palettes based on the 24 solar terms (二十四節気) and Japanese traditional colors. A Special supplies the theme ramp and the Mode picks the rungs, so every solid surface — Button primary, the neutral solid Badge and Callout — re-tints per season, while destructive red and info blue stay pinned."}),e.jsx("div",{className:"grid grid-cols-1 gap-4 md:grid-cols-2",children:h.map(s=>e.jsxs("section",{className:"flex flex-col gap-2 rounded-xl border border-border p-4",children:[e.jsxs("header",{className:"flex flex-wrap items-baseline gap-2",children:[e.jsx("h2",{className:"font-semibold text-foreground text-lg",children:s.label}),e.jsxs("span",{className:"text-foreground-muted text-xs",children:[s.term," · ",s.colors]}),e.jsx("span",{className:"ml-auto font-mono text-foreground-muted text-xs",children:s.id})]}),_.map(a=>e.jsx(S,{mode:a,season:s.id,className:"p-4",children:e.jsx(j,{})},a))]},s.id))})]})]})},c={name:"Side by Side",argTypes:{seasonA:{description:"Season applied to the left cell.",control:"select",options:v,table:{type:{summary:"SeasonalThemeId"},defaultValue:{summary:"season--spring-early"}}},seasonB:{description:"Season applied to the right cell.",control:"select",options:v,table:{type:{summary:"SeasonalThemeId"},defaultValue:{summary:"season--winter-deep"}}},mode:{description:"Mode for both cells (independent of the toolbar).",control:"select",options:["light","dark"],table:{type:{summary:'"light" | "dark"'},defaultValue:{summary:"light"}}}},args:{seasonA:"season--spring-early",seasonB:"season--winter-deep",mode:"light"},render:s=>{const{seasonA:a,seasonB:n,mode:i}=s;return e.jsxs("div",{className:"p-6",children:[e.jsx(g,{}),e.jsxs("div",{className:"mx-auto max-w-5xl",children:[e.jsx(u,{children:"Side by Side"}),e.jsx(x,{children:"Pick any two seasons and compare the identical component stack under each ramp. The default pair — spring-early (hue 12) vs winter-deep (hue 255) — is the widest hue contrast the eight palettes offer."}),e.jsx("div",{className:"grid grid-cols-1 gap-4 md:grid-cols-2",children:[["left",a],["right",n]].map(([N,t])=>{const r=h.find(f=>f.id===t);return e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsxs("header",{className:"flex flex-wrap items-baseline gap-2",children:[e.jsx("h2",{className:"font-semibold text-base text-foreground",children:r?.label}),e.jsx("span",{className:"text-foreground-muted text-xs",children:r?.colors}),e.jsx("span",{className:"ml-auto font-mono text-foreground-muted text-xs",children:t})]}),e.jsx(S,{mode:i,season:t,className:"p-4",children:e.jsx(j,{})})]},N)})})]})]})}},$=["Overview","Reports","Audiences","Settings"],W=[{label:"Sessions",value:"24.3k",delta:"+12.4%",tone:"success"},{label:"Sign-ups",value:"1,208",delta:"+3.1%",tone:"success"},{label:"Churn",value:"0.8%",delta:"-0.2%",tone:"error"}];function F(){return e.jsxs("div",{className:"flex min-h-[600px] flex-col",children:[e.jsxs("header",{className:"flex flex-wrap items-center gap-3 border-border border-b px-6 py-3",children:[e.jsx("span",{className:"size-6 rounded bg-solid","aria-hidden":"true"}),e.jsx(l,{variant:"heading",as:"span",size:"md",children:"Schatten Analytics"}),e.jsx(y,{variant:"neutral",appearance:"solid",children:"Pro"}),e.jsxs("div",{className:"ml-auto flex items-center gap-2",children:[e.jsx(o,{variant:"secondary",size:"sm",children:"Export"}),e.jsx(o,{variant:"primary",size:"sm",children:"New report"})]})]}),e.jsxs("div",{className:"flex flex-1",children:[e.jsx("nav",{"aria-label":"Dashboard sections",className:"w-44 border-border border-r p-3",children:e.jsx("ul",{className:"flex flex-col gap-1",children:$.map((s,a)=>e.jsx("li",{children:e.jsx("a",{href:"#overview","aria-current":a===0?"page":void 0,className:a===0?"block rounded bg-solid px-3 py-1.5 font-medium text-sm text-solid-foreground":"block rounded px-3 py-1.5 text-foreground-muted text-sm hover:bg-surface-hover",children:s})},s))})}),e.jsxs("main",{className:"flex flex-1 flex-col gap-4 p-6",children:[e.jsx(l,{variant:"heading",as:"h2",size:"lg",id:"overview",children:"Overview"}),e.jsx("div",{className:"grid grid-cols-1 gap-4 sm:grid-cols-3",children:W.map(s=>e.jsxs("div",{className:"flex flex-col items-start gap-1 rounded-lg border border-border bg-surface p-4",children:[e.jsx(l,{variant:"label",as:"span",size:"sm",color:"muted",children:s.label}),e.jsx(l,{variant:"heading",as:"span",size:"xl",children:s.value}),e.jsx(y,{variant:s.tone,appearance:"subtle",children:s.delta})]},s.label))}),e.jsx(T,{variant:"info",appearance:"subtle",title:"Pinned colors",children:"State colors stay put: info is always blue and destructive is always red, whichever season is active."}),e.jsxs("section",{className:"flex max-w-xl flex-col gap-3 rounded-lg border border-border bg-surface p-4",children:[e.jsx(l,{variant:"heading",as:"h3",size:"sm",children:"New report"}),e.jsx(w,{label:"Report name",children:e.jsx(L,{placeholder:"Q2 retention"})}),e.jsx(w,{label:"Period",children:e.jsxs(R,{defaultValue:"quarter",children:[e.jsx(I,{children:e.jsx(M,{placeholder:"Select period"})}),e.jsxs(O,{children:[e.jsx(b,{value:"week",children:"Last week"}),e.jsx(b,{value:"quarter",children:"Last quarter"}),e.jsx(b,{value:"year",children:"Last year"})]})]})}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(o,{variant:"primary",size:"sm",children:"Create"}),e.jsx(o,{variant:"tertiary",size:"sm",children:"Cancel"})]})]})]})]})]})}const m={name:"Dashboard Mockup",argTypes:{season:{description:"Seasonal palette applied to the whole mockup.",control:"select",options:["none",...v],table:{type:{summary:'SeasonalThemeId | "none"'},defaultValue:{summary:"season--spring-early"}}},mode:{description:"Mode for the mockup (independent of the toolbar).",control:"select",options:["light","dark"],table:{type:{summary:'"light" | "dark"'},defaultValue:{summary:"light"}}}},args:{season:"season--spring-early",mode:"light"},render:s=>{const{season:a,mode:n}=s;return e.jsxs("div",{className:"p-6",children:[e.jsx(g,{}),e.jsxs("div",{className:"mx-auto max-w-6xl",children:[e.jsx(u,{children:"Dashboard Mockup"}),e.jsx(x,{children:"A complete page built from lv1 components, wearing one seasonal ramp. The season flows through the solid family only — switch the season arg and watch the header mark, active nav item, primary buttons and Pro badge re-tint while state colors hold still."}),e.jsx(S,{mode:n,season:a==="none"?null:a,className:"overflow-hidden",children:e.jsx(F,{})})]})]})}},Y=Date.UTC(2026,3,1),p={name:"Auto Season",argTypes:{date:{description:"Date to resolve into a season. Set it to today to preview the live behavior.",control:"date",table:{type:{summary:"Date"}}},mode:{description:"Mode for the preview cell (independent of the toolbar).",control:"select",options:["light","dark"],table:{type:{summary:'"light" | "dark"'},defaultValue:{summary:"light"}}}},args:{date:Y,mode:"light"},render:s=>{const{date:a,mode:n}=s,i=new Date(typeof a=="string"?Number.isNaN(Number(a))?a:Number(a):a),t=`season--${D(i)}`,r=h.find(f=>f.id===t);return e.jsxs("div",{className:"p-6",children:[e.jsx(g,{}),e.jsxs("div",{className:"mx-auto max-w-3xl",children:[e.jsx(u,{children:"Auto Season"}),e.jsxs(x,{children:[e.jsx("code",{children:"getCurrentSeason(date)"})," maps any date onto the eight solar-term periods — drag the date control and watch the resolved palette change."]}),e.jsxs("div",{className:"mb-4 flex flex-wrap items-baseline gap-2",children:[e.jsx(l,{variant:"heading",as:"h2",size:"md",children:r?.label}),e.jsxs("span",{className:"text-foreground-muted text-sm",children:[r?.term," · ",r?.colors]}),e.jsx("span",{className:"ml-auto font-mono text-foreground-muted text-xs",children:t})]}),e.jsx(S,{mode:n,season:t,className:"p-4",children:e.jsx(j,{})}),e.jsx(P,{children:"Wiring it up"}),e.jsxs(B,{children:["Browser: call ",e.jsx("code",{children:"applySeasonTheme()"})," once on load. SSR: spread"," ",e.jsx("code",{children:"getSeasonAttribute()"})," onto the root element so the attribute is there before first paint. With the React provider, pass ",e.jsx("code",{children:'defaultSpecial="auto-seasonal"'})," ","instead."]}),e.jsx(E,{children:`import { applySeasonTheme, getSeasonAttribute } from '@yasmro/schatten/themes/seasonal'
...
<ThemeProvider defaultSpecial="auto-seasonal">…</ThemeProvider>`})]})]})}},Ue=["EightSeasons","SideBySide","DashboardMockup","AutoSeason"];d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: 'Eight Seasons',
