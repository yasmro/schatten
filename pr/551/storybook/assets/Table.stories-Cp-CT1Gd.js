...
}`,...t.parameters?.docs?.source},description:{story:"Interactive single instance — toggle `size` / `striped` / `bordered` /\n`hoverable` in the Controls panel.",...t.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: 'Treatments',
...
}`,...d.parameters?.docs?.source},description:{story:"The orthogonal treatments. `striped` and `bordered` are independent booleans,\nso they compose — the fourth table is both at once.",...d.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: 'Sizes',
  render: () => <div className="flex flex-col gap-8">
      <div>
...
}`,...o.parameters?.docs?.source},description:{story:"Cell density — `sm` / `md` / `lg`.",...o.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  name: 'Hoverable',
