import{j as e,r as R}from"./iframe-Q-7Zj3Ct.js";import{B as j}from"./Button-DuXjAE-j.js";import{C as k}from"./Callout-BWupUnzj.js";import{D as A}from"./Dialog-C0RbHrLD.js";import{F}from"./Field-DqmmbesY.js";import{I as O}from"./Input-CO3DmhYo.js";import{S as B,a as D,b as N,c as I,d as f}from"./Select-ptF1rbM-.js";import{t as L,T as q}from"./Toaster-DT14zaNf.js";import{T,a as w,b as S,c as v}from"./Tooltip-5cWwGC0k.js";import{P as n,L as o,C as a,N as s,a as P,D as E,S as l}from"./docs-ui-D0Lzeezu.js";import"./preload-helper-DUSBS5vW.js";import"./index-DPnazUT8.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css               */import"./Spinner-QdpqgASa.js";/* empty css                *//* empty css                */import"./circle-alert-DVeCNbaT.js";import"./createLucideIcon-BWa8aq_-.js";import"./triangle-alert-F1hZ--OF.js";import"./info-CK878LKv.js";import"./x-48ATuIqe.js";import"./index-C_iVNB6w.js";import"./index-8k5_Nd5T.js";import"./index-D-IzIQ0Z.js";import"./index-C7GoUSIM.js";import"./index-B0VBQZoU.js";import"./index-Qm0ZzbsL.js";import"./index-BLsZNQv9.js";import"./index-DzDeP3Xp.js";import"./Combination-BgBsTrHT.js";import"./index-C88_IEkQ.js";/* empty css               */import"./Separator-DIRN6NFX.js";/* empty css                  */import"./field-BvkRLkeB.js";/* empty css              *//* empty css              */import"./index-CBUZgVJW.js";import"./index-CSH6R3SF.js";import"./index-C5S3HOSI.js";import"./index-Ct3YrYPq.js";/* empty css               */import"./chevron-up-BwuD6fXW.js";import"./check-BUtLorq3.js";/* empty css              *//* empty css                */const Oe={title:"Patterns/Testing",parameters:{layout:"fullscreen"}},r=({children:d})=>e.jsx("div",{className:"max-w-3xl mx-auto px-8 py-12",children:d}),t=({children:d})=>e.jsx("code",{className:"rounded bg-surface px-1 py-0.5 font-mono text-[0.85em] text-foreground",children:d}),i=({label:d,children:c})=>e.jsxs("div",{className:"border border-border rounded-lg p-4 mb-4",children:[e.jsx("h3",{className:"text-xs font-semibold text-foreground-muted uppercase tracking-wide mb-3",children:d}),e.jsx("div",{className:"flex flex-wrap items-center gap-4",children:c})]}),h={name:"Overview",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"Testing"}),e.jsxs(o,{children:["How to make Schatten components addressable from a consumer E2E suite (Playwright / Cypress / React Testing Library). The plumbing is deliberately thin: components forward"," ",e.jsx(t,{children:"data-testid"})," (and every other unknown DOM attribute) onto their root element — there is no bespoke ",e.jsx(t,{children:"testId"})," prop to learn."]}),e.jsxs(k,{variant:"info",title:"Role first, testid second",children:["Prefer ",e.jsx(t,{children:"getByRole(role, { name })"})," with an accessible name. It is stable across refactors and doubles as an accessibility check. Reach for ",e.jsx(t,{children:"data-testid"})," ","only when a role-based query is ambiguous, unstable, or impossible (anonymous wrappers, repeated rows)."]}),e.jsx(l,{children:"What this page covers"}),e.jsxs("ul",{className:"list-disc pl-6 text-sm text-foreground-muted flex flex-col gap-2",children:[e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Root pass-through"})," — testid lands on the rendered root via ",e.jsx(t,{children:"{...props}"}),"."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Compound components"})," — each sub-part takes its own testid (Select)."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"asChild caveat"})," — with an element child the testid merges onto the child (Tooltip)."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Portal content"})," — testid goes on the Content, and queries scope from the page (Select / Tooltip)."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Curated-props exceptions"})," — Dialog and Toast do not forward arbitrary attributes; address Dialog by its role, Toast by its rendered text."]}),e.jsxs("li",{children:[e.jsx("strong",{className:"text-foreground",children:"Naming & no auto-testid"})," — the value is yours to choose; Schatten never injects one."]})]}),e.jsx(l,{children:"Contributor contract"}),e.jsxs(s,{children:["The implementer-facing source of truth is"," ",e.jsx(t,{children:".claude/rules/component-testid-guideline.md"}),". This page is its live, runnable companion — when the rule and this page disagree, the rule wins."]})]})},p={name:"1. data-testid on the root",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"1. data-testid on the root"}),e.jsxs(o,{children:["Pass ",e.jsx(t,{children:"data-testid"})," like any other DOM attribute. There is no ",e.jsx(t,{children:"testId"})," ","prop — the component spreads ",e.jsx(t,{children:"{...props}"})," onto its rendered root, so the attribute appears on the real element. The same mechanism works for ",e.jsx(t,{children:"data-cy"}),","," ",e.jsx(t,{children:"data-test"}),", or any custom hook."]}),e.jsx(i,{label:"A button with a testid",children:e.jsx(j,{"data-testid":"submit-btn",children:"Save"})}),e.jsx(l,{children:"Rendered DOM"}),e.jsxs(s,{children:["Inspect the button above — the attribute is on the native ",e.jsx(t,{children:"<button>"}),", alongside the public ",e.jsx(t,{children:"st-*"})," classes."]}),e.jsx(a,{children:`<button data-testid="submit-btn" class="st-btn st-btn--primary st-btn--md">
  Save
</button>`}),e.jsx(l,{children:"Selecting it"}),e.jsx(a,{children:`// Playwright
await page.getByTestId('submit-btn').click()

// …but prefer role + name when it is unambiguous:
await page.getByRole('button', { name: 'Save' }).click()`})]})},u={name:"2. Compound components",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"2. Compound components"}),e.jsxs(o,{children:["Compound components (Select, Tooltip, RadioGroup) are built from named parts, and each part forwards its own props. Put a ",e.jsx(t,{children:"data-testid"})," on whichever parts your test needs — they are independent. Select is the canonical example."]}),e.jsx(i,{label:"Select with a testid on every part (open it)",children:e.jsxs(B,{children:[e.jsx(D,{"aria-label":"Country","data-testid":"country-trigger",className:"w-56",children:e.jsx(N,{placeholder:"Country"})}),e.jsxs(I,{"data-testid":"country-content",children:[e.jsx(f,{value:"jp","data-testid":"country-item-jp",children:"Japan"}),e.jsx(f,{value:"us","data-testid":"country-item-us",children:"United States"})]})]})}),e.jsx(a,{children:`<Select>
...
<TooltipTrigger data-testid="help">
  <Button>Help</Button>
</TooltipTrigger>`})]})},g={name:"4. Portal-rendered content",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"4. Portal-rendered content"}),e.jsxs(o,{children:[e.jsx(t,{children:"SelectContent"}),", ",e.jsx(t,{children:"TooltipContent"}),", and similar popups render through a Portal into ",e.jsx(t,{children:"document.body"})," — outside ",e.jsx(t,{children:"#storybook-root"})," and outside the trigger's DOM subtree. A selector rooted at the trigger will never reach them by DOM traversal."]}),e.jsx(l,{children:"Two rules"}),e.jsxs("ul",{className:"list-disc pl-6 text-sm text-foreground-muted flex flex-col gap-2 mb-4",children:[e.jsx("li",{children:"Put the testid on the Content element itself, not on the trigger."}),e.jsxs("li",{children:["Scope the query from ",e.jsx(t,{children:"page"})," (Playwright) / ",e.jsx(t,{children:"screen"})," (RTL), not from a trigger-rooted locator."]})]}),e.jsx(i,{label:"Open the select — the listbox is portaled to body",children:e.jsxs(B,{children:[e.jsx(D,{"aria-label":"Fruit","data-testid":"fruit-trigger",className:"w-56",children:e.jsx(N,{placeholder:"Pick a fruit"})}),e.jsxs(I,{"data-testid":"fruit-content",children:[e.jsx(f,{value:"apple",children:"Apple"}),e.jsx(f,{value:"banana",children:"Banana"}),e.jsx(f,{value:"cherry",children:"Cherry"})]})]})}),e.jsx(a,{children:`// Playwright — open via the trigger, then scope into the portaled content
await page.getByTestId('fruit-trigger').click()
await page
  .getByTestId('fruit-content')
  .getByRole('option', { name: 'Banana' })
  .click()`})]})};function M(){const[d,c]=R.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(j,{"data-testid":"delete-open",onClick:()=>c(!0),children:"Delete account"}),e.jsx(A,{isOpen:d,onOpenChange:c,title:"Delete account",description:"This action cannot be undone.",actionButton:{label:"Delete",variant:"destructive",onClick:()=>c(!1)},cancelButton:{label:"Cancel"},children:e.jsx("p",{"data-testid":"delete-message",children:"Are you sure you want to delete your account?"})})]})}function H(){return e.jsxs(e.Fragment,{children:[e.jsx(j,{onClick:()=>L({title:"Saved successfully",variant:"success"}),children:"Save"}),e.jsx(q,{})]})}const x={name:"5. Curated-props components",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"5. Curated-props components"}),e.jsxs(o,{children:["A few high-level components take a curated prop surface and do ",e.jsx("strong",{children:"not"})," spread unknown attributes onto their content. For these, address the children you pass in, or query by role + accessible name."]}),e.jsx(P,{children:"Dialog — put the testid on your children"}),e.jsxs(s,{children:["Dialog renders structured props (",e.jsx(t,{children:"title"}),", ",e.jsx(t,{children:"actionButton"}),","," ",e.jsx(t,{children:"cancelButton"}),") and its ",e.jsx(t,{children:"children"})," in the body — it does not forward a"," ",e.jsx(t,{children:"data-testid"})," onto its Content. Put testids on the elements you author, and use"," ",e.jsx(t,{children:"getByRole('dialog', { name })"})," for the frame (Radix sets"," ",e.jsx(t,{children:'role="dialog"'})," and links the title as its name)."]}),e.jsx(i,{label:"Open the dialog (rendered into a Portal)",children:e.jsx(M,{})}),e.jsx(a,{children:`<Dialog title="Delete account" isOpen={open} onOpenChange={setOpen}
...
await page.getByTestId('delete-message')                     // your children`}),e.jsx(P,{children:"Toast — imperative, so query by text"}),e.jsxs(s,{children:["Toasts are created by the imperative ",e.jsx(t,{children:"toast({ … })"})," call, which takes no JSX — there is no element to hang a ",e.jsx(t,{children:"data-testid"})," on. The visible toast carries"," ",e.jsx("strong",{children:"no role"})," either: Sonner (the renderer since v0.14.0) announces toast content through its own visually-hidden live region, not via ",e.jsx(t,{children:'role="status"'})," on the toast element. Query by the rendered text, or by Sonner's"," ",e.jsx(t,{children:"[data-sonner-toast]"})," wrapper when you need the toast element itself."]}),e.jsx(i,{label:"Fire a toast",children:e.jsx(H,{})}),e.jsx(a,{children:`toast({ title: 'Saved successfully', variant: 'success' })

// Playwright — query the rendered title text
await expect(page.getByText('Saved successfully')).toBeVisible()

// The toast element itself (Sonner-owned wrapper)
page.locator('li[data-sonner-toast]')`})]})},y={name:"6. Form fields",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"6. Form fields"}),e.jsxs(o,{children:["Compose a labelled field with the flat ",e.jsx(t,{children:"Field"})," API and put the"," ",e.jsx(t,{children:"data-testid"})," on the input you pass as children. Field wires the label, description, and error state around it; the input is still a plain DOM element that forwards"," ","the attribute."]}),e.jsx(i,{label:"Field + Input with a testid",children:e.jsx(F,{label:"Email",error:"Enter a valid email address.",className:"w-72",children:e.jsx(O,{type:"email","data-testid":"email-input",defaultValue:"not-an-email"})})}),e.jsx(a,{children:`<Field label="Email" error={emailError}>
  <Input type="email" data-testid="email-input" />
</Field>

// Playwright
await page.getByTestId('email-input').fill('foo@example.com')`})]})},b={name:"7. Naming & no auto-testid",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"7. Naming & no auto-testid"}),e.jsx(o,{children:"Choosing testid values is the consuming product's responsibility, not Schatten's. This page only describes the plumbing — where the attribute lands and how it survives a Portal boundary. The naming scheme is yours."}),e.jsx(l,{children:"A recommendation, not a rule"}),e.jsxs(s,{children:["A feature-scoped, purpose-suffixed shape reads well and avoids collisions —"," ",e.jsx(t,{children:"{feature}-{purpose}"}),", e.g. ",e.jsx(t,{children:"signup-email-input"})," or"," ",e.jsx(t,{children:"dashboard-user-menu"}),". ",e.jsx(t,{children:"camelCase"})," and ",e.jsx(t,{children:"kebab-case"})," both work; pick one and keep it consistent across your codebase. Reserve testids for elements that role + accessible name cannot already address."]}),e.jsx(l,{children:"Schatten never injects a testid"}),e.jsxs(k,{variant:"warning",title:"No library-supplied testids",children:["Schatten does not emit ",e.jsx(t,{children:"data-testid"})," from inside the library — no fixed testids on internal Slots or Portals, no values derived from ",e.jsx(t,{children:"displayName"}),", no"," ",e.jsx(t,{children:"testing"}),"-flag toggles. A library-supplied testid would pollute your namespace and force you to dodge reserved names. The single source of truth is you."]}),e.jsxs(s,{children:["Runtime ",e.jsx(t,{children:"data-*"})," attributes that Radix emits for behaviour / styling (",e.jsx(t,{children:"data-state"}),", ",e.jsx(t,{children:"data-disabled"}),", ",e.jsx(t,{children:"data-side"}),") are a separate concern — they are not testids and are safe to rely on for state-scoped assertions."]})]})},C={name:"8. Selector cheatsheet",render:()=>e.jsxs(r,{children:[e.jsx(n,{children:"8. Selector cheatsheet"}),e.jsx(o,{children:"The same intent expressed across the three common test runners. Reach for the role-based row first; fall back to the testid row when role + name cannot disambiguate."}),e.jsx(E,{headers:["Intent","Playwright","Cypress","React Testing Library"],rows:[{key:"role",cells:["By role + name (first choice)",e.jsx(t,{children:"page.getByRole('button', { name })"},"c"),e.jsx(t,{children:"cy.findByRole('button', { name })"},"c"),e.jsx(t,{children:"screen.getByRole('button', { name })"},"c")]},{key:"testid",cells:["By testid (fallback)",e.jsx(t,{children:"page.getByTestId('x')"},"c"),e.jsx(t,{children:`cy.get('[data-testid="x"]')`},"c"),e.jsx(t,{children:"screen.getByTestId('x')"},"c")]},{key:"portal",cells:["Portal content","Scope from page","Document-wide by default",e.jsxs("span",{children:[e.jsx(t,{children:"screen"})," (not ",e.jsx(t,{children:"within"}),")"]},"c")]}]}),e.jsxs(s,{children:["Cypress is shown for reference only — Schatten does not depend on it. The role-based queries come from Testing Library's queries (built into Playwright and"," ",e.jsx(t,{children:"@testing-library/cypress"}),")."]})]})},Le=["Overview","RootPassThrough","CompoundComponents","AsChildCaveat","PortalContent","CuratedPropsExceptions","FormFields","NamingAndNoAutoTestid","FrameworkSelectors"];h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: 'Overview',
  render: () => <Page>
...
React Testing Library, with role-first as the default.`,...C.parameters?.docs?.description}}};export{m as AsChildCaveat,u as CompoundComponents,x as CuratedPropsExceptions,y as FormFields,C as FrameworkSelectors,b as NamingAndNoAutoTestid,h as Overview,g as PortalContent,p as RootPassThrough,Le as __namedExportsOrder,Oe as default};
