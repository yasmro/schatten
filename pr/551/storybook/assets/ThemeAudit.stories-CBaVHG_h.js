import{j as e,r as h}from"./iframe-Q-7Zj3Ct.js";import{S as d,b as u,s as x,a as g}from"./scoped-theme-css-BlBrCmtQ.js";import{C as f}from"./Callout-BWupUnzj.js";import{B as i}from"./Button-DuXjAE-j.js";import{B as c}from"./Badge-zrbl6OP8.js";import"./preload-helper-DUSBS5vW.js";import"./index-BjhfJjZn.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";/* empty css                */import"./circle-alert-DVeCNbaT.js";import"./createLucideIcon-BWa8aq_-.js";import"./triangle-alert-F1hZ--OF.js";import"./info-CK878LKv.js";import"./x-48ATuIqe.js";import"./index-DPnazUT8.js";/* empty css               */import"./Spinner-QdpqgASa.js";/* empty css                *//* empty css              */const b=["light","dark"],y=u(".theme-audit-cell",{semanticCss:g,seasonalCss:x});function l(){return e.jsx("style",{children:y})}function v(){return e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx(i,{variant:"primary",size:"sm",children:"Primary"}),e.jsx(i,{variant:"destructive",size:"sm",children:"Delete"}),e.jsx(i,{variant:"secondary",size:"sm",children:"Secondary"}),e.jsx(c,{variant:"neutral",appearance:"solid",children:"Neutral"}),e.jsx(c,{variant:"success",appearance:"subtle",children:"Success"}),e.jsx("span",{className:"rounded bg-solid px-2 py-0.5 font-medium text-solid-foreground text-xs",children:"Aa"}),e.jsx("span",{className:"size-4 rounded bg-theme-500","aria-hidden":"true"}),e.jsx("span",{className:"size-4 rounded bg-theme-200","aria-hidden":"true"}),e.jsx("span",{className:"size-4 rounded bg-theme-700","aria-hidden":"true"})]})}function p({mode:a,special:s}){const n=a==="dark";return e.jsxs("div",{className:`theme-audit-cell ${n?"dark":""} flex flex-col gap-3 rounded-lg border border-border bg-background p-4`,"data-theme":s??void 0,children:[e.jsxs("div",{className:"flex items-center justify-between text-xs",children:[e.jsx("span",{className:"font-mono text-foreground-muted",children:s??"(no theme)"}),e.jsx("span",{className:"rounded bg-surface px-1.5 py-0.5 font-mono text-foreground-muted uppercase",children:a})]}),e.jsx(v,{}),e.jsx(f,{variant:"info",appearance:"subtle",title:"Info",children:"Theme scale and Mode tokens combine here."})]})}const U={title:"Theming/Theme Audit",tags:["!dev"],parameters:{layout:"fullscreen"}},o={name:"Overview (16 patterns)",parameters:{docs:{description:{story:"8 Specials × 2 Modes = 16 patterns. Rows = Special (seasonal palette); columns = Mode (light/dark). Use this grid to verify orthogonality and to spot regressions when a new Special is added."}}},render:()=>e.jsxs("div",{className:"theme-audit-overview p-6",children:[e.jsx(l,{}),e.jsxs("header",{className:"mx-auto mb-6 max-w-6xl",children:[e.jsx("h1",{className:"mb-2 font-bold text-3xl text-foreground",children:"Theme Composition Audit"}),e.jsx("p",{className:"text-foreground-muted text-sm leading-relaxed",children:"Mode (light/dark) and Special (seasonal palette) are independent axes. This grid renders every combination so visual regressions across the matrix can be spotted in one screen."})]}),e.jsx("div",{className:"mx-auto grid max-w-6xl grid-cols-2 gap-3 md:grid-cols-2",children:d.map(a=>e.jsxs("div",{className:"contents",children:[e.jsxs("div",{className:"col-span-2 mt-4 flex items-baseline gap-2 first:mt-0",children:[e.jsx("h2",{className:"font-semibold text-base text-foreground",children:a.label}),e.jsx("span",{className:"text-foreground-muted text-xs",children:a.colors}),e.jsx("span",{className:"ml-auto font-mono text-foreground-muted text-xs",children:a.id})]}),b.map(s=>e.jsx(p,{mode:s,special:a.id},`${a.id}-${s}`))]},a.id))})]})},r={name:"Per Special",argTypes:{special:{description:"Which Special palette to apply on this story.",control:"select",options:["none",...d.map(a=>a.id)],table:{type:{summary:`${d.map(a=>`"${a.id}"`).join(" | ")} | "none"`},defaultValue:{summary:"none"}}},mode:{description:"Mode for this story (independent of the toolbar).",control:"select",options:["light","dark"],table:{type:{summary:'"light" | "dark"'},defaultValue:{summary:"light"}}}},args:{special:"none",mode:"light"},render:a=>{const{special:s,mode:n}=a;return e.jsxs("div",{className:"p-6",children:[e.jsx(l,{}),e.jsx("div",{className:"mx-auto max-w-3xl",children:e.jsx(p,{mode:n,special:s==="none"?null:s})})]})}},S=[{name:"--color-theme-500",owner:"Special",purpose:"Theme scale mid-tone"},{name:"--color-theme-200",owner:"Special",purpose:"Theme scale tint"},{name:"--color-background",owner:"Mode",purpose:"Page background"},{name:"--color-surface",owner:"Mode",purpose:"Card / container"},{name:"--color-foreground",owner:"Mode",purpose:"Primary text"},{name:"--color-border",owner:"Mode",purpose:"Default border"},{name:"--color-surface-disabled",owner:"Mode",purpose:"Disabled (Specials must not override)"},{name:"--color-info",owner:"Pinned",purpose:"Pinned to blue; never moves with Special"}],m=[{id:"l-none",label:"light · (none)",mode:"light",special:null},{id:"l-spring",label:"light · spring-early",mode:"light",special:"season--spring-early"},{id:"d-none",label:"dark · (none)",mode:"dark",special:null},{id:"d-spring",label:"dark · spring-early",mode:"dark",special:"season--spring-early"}];function w(){const a=h.useId();return e.jsxs("div",{children:[e.jsx("h2",{id:a,className:"mb-2 font-semibold text-foreground text-xl",children:"Cascade verification"}),e.jsxs("p",{className:"mb-4 text-foreground-muted text-sm leading-relaxed",children:["Each column is a sample point: a wrapper with the indicated Mode class and"," ",e.jsx("code",{className:"rounded bg-surface-hover px-1 font-mono text-foreground",children:"data-theme"}),". Per the two-axis model, Mode-owned tokens (background, foreground, border, disabled) must change between the light/dark columns; Special-owned tokens (",e.jsx("code",{className:"rounded bg-surface-hover px-1 font-mono text-foreground",children:"--color-theme-*"}),") must change between the (none) / (spring-early) columns;"," ",e.jsx("code",{className:"rounded bg-surface-hover px-1 font-mono text-foreground",children:"--color-info"})," ","must remain pinned to blue everywhere."]}),e.jsx("div",{className:"overflow-x-auto rounded-lg border border-border",children:e.jsxs("table",{"aria-labelledby":a,className:"w-full border-collapse text-sm",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-surface-hover text-left",children:[e.jsx("th",{scope:"col",className:"px-3 py-2 font-mono font-semibold text-foreground",children:"token"}),e.jsx("th",{scope:"col",className:"px-3 py-2 font-semibold text-foreground",children:"owner"}),m.map(s=>e.jsx("th",{scope:"col",className:"px-3 py-2 font-mono text-foreground text-xs",children:s.label},s.id))]})}),e.jsx("tbody",{children:S.map(s=>e.jsxs("tr",{className:"border-border border-t",children:[e.jsx("td",{className:"px-3 py-2 font-mono text-foreground text-xs",children:s.name}),e.jsxs("td",{className:"px-3 py-2",children:[e.jsx("span",{className:`rounded px-1.5 py-0.5 font-mono text-xs ${s.owner==="Special"?"bg-theme-100 text-theme-900":s.owner==="Mode"?"bg-info-subtle text-info-emphasis":"bg-warning-subtle text-warning-emphasis"}`,children:s.owner}),e.jsx("div",{className:"text-foreground-muted text-xs",children:s.purpose})]}),m.map(n=>e.jsx("td",{className:"px-3 py-2",children:e.jsx("div",{className:`theme-audit-cell ${n.mode==="dark"?"dark":""} inline-flex items-center gap-2 rounded border border-border bg-background p-1`,"data-theme":n.special??void 0,children:e.jsx("span",{className:"inline-block size-5 rounded border border-border",style:{background:`var(${s.name})`},"aria-hidden":"true"})})},n.id))]},s.name))})]})})]})}const t={name:"Cascade Verification",render:()=>e.jsxs("div",{className:"p-6",children:[e.jsx(l,{}),e.jsx("div",{className:"mx-auto max-w-5xl",children:e.jsx(w,{})})]})},W=["Overview","PerSpecial","CascadeVerification"];o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
}`,...r.parameters?.docs?.source},description:{story:`Renders the showcase for one Special × one Mode at a time, both selected via
...
(\`&args=special:...;mode:...\`).`,...r.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
