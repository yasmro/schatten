import{j as e,r as b}from"./iframe-Q-7Zj3Ct.js";import{T as l,t as a,d as f}from"./Toaster-DT14zaNf.js";import{B as s}from"./Button-DuXjAE-j.js";import"./preload-helper-DUSBS5vW.js";import"./utils-HnQPFlDo.js";import"./index-BekUCMdb.js";import"./Spinner-QdpqgASa.js";/* empty css                */import"./circle-alert-DVeCNbaT.js";import"./createLucideIcon-BWa8aq_-.js";import"./triangle-alert-F1hZ--OF.js";import"./info-CK878LKv.js";import"./x-48ATuIqe.js";import"./index-Qm0ZzbsL.js";import"./index-BLsZNQv9.js";/* empty css              */import"./index-DPnazUT8.js";/* empty css               */const j=3600*1e3,I={title:"Components/lv1/Toast",component:l,parameters:{layout:"fullscreen"},tags:["autodocs"],argTypes:{position:{description:"Where the toast viewport sits on screen.",control:"select",options:["top-left","top-center","top-right","bottom-left","bottom-center","bottom-right"],table:{type:{summary:'"top-left" | "top-center" | "top-right" | "bottom-left" | "bottom-center" | "bottom-right"'},defaultValue:{summary:"bottom-center"}}},duration:{description:"Default auto-dismiss duration in ms. Per-toast duration overrides this.",control:"number",table:{type:{summary:"number"},defaultValue:{summary:"5000"}}}}},y=["neutral","success","error","warning","info"],d=["subtle","solid"],w={neutral:{title:"Heads up",description:"A neutral notification."},success:{title:"Saved",description:"Your changes have been saved."},error:{title:"Error",description:"Could not save your changes."},warning:{title:"Warning",description:"Disk space is running low."},info:{title:"Update available",description:"A new version is ready to install."}},S=t=>e.jsxs("div",{className:"min-h-screen p-8 flex flex-col gap-6 items-start",children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-base font-semibold mb-1",children:"Toast Playground"}),e.jsxs("p",{className:"text-sm text-foreground-muted",children:["Use the matrix below to fire any variant × appearance combination, and the second row to try toasts with an action. Switch the position via Controls. The ",e.jsx("code",{children:"<Toaster />"})," is mounted at the bottom of this story."]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold mb-2",children:"Variant × Appearance"}),e.jsxs("div",{className:"grid grid-cols-[auto_repeat(2,minmax(0,1fr))] gap-2 items-center",children:[e.jsx("span",{className:"text-xs font-mono text-foreground-muted"}),d.map(n=>e.jsx("span",{className:"text-xs font-mono text-foreground-muted text-center",children:n},n)),y.map(n=>e.jsxs(b.Fragment,{children:[e.jsx("span",{className:"text-xs font-mono text-foreground-muted",children:n}),d.map(r=>e.jsx(s,{variant:"secondary",size:"sm",onClick:()=>a({...w[n],variant:n,appearance:r}),children:"Fire"},`${n}-${r}`))]},n))]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold mb-2",children:"With Action (auto-dismisses on click)"}),e.jsxs("div",{className:"grid grid-cols-[auto_repeat(2,minmax(0,1fr))] gap-2 items-center",children:[e.jsx("span",{className:"text-xs font-mono text-foreground-muted"}),d.map(n=>e.jsx("span",{className:"text-xs font-mono text-foreground-muted text-center",children:n},n)),y.map(n=>e.jsxs(b.Fragment,{children:[e.jsx("span",{className:"text-xs font-mono text-foreground-muted",children:n}),d.map(r=>e.jsx(s,{variant:"secondary",size:"sm",onClick:()=>a({...w[n],variant:n,appearance:r,action:{label:"Undo",onClick:()=>{}}}),children:"Fire + action"},`action-${n}-${r}`))]},`action-${n}`))]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold mb-2",children:"Other"}),e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx(s,{variant:"secondary",size:"sm",onClick:()=>a({title:"Title only",variant:"success"}),children:"Title only"}),e.jsx(s,{variant:"secondary",size:"sm",onClick:()=>a({title:"Long content example",description:"This toast has a longer description to verify how the layout handles wrapping text alongside the floating top-right button.",variant:"warning"}),children:"Long content"})]})]}),e.jsx(l,{position:t.position})]}),p={name:"Playground",args:{position:"bottom-center"},render:t=>e.jsx(S,{position:t.position})},i=({inputs:t,position:n})=>(b.useEffect(()=>{f();for(const r of t)a({duration:j,...r});return()=>{f()}},[t]),e.jsx("div",{className:"min-h-screen",children:e.jsx(l,{position:n??"bottom-center",expand:!0,visibleToasts:10})})),m={name:"Subtle Treatments",render:()=>e.jsx(i,{inputs:[{variant:"neutral",appearance:"subtle",title:"Neutral",description:"A baseline notification."},{variant:"success",appearance:"subtle",title:"Success",description:"Your changes have been saved."},{variant:"error",appearance:"subtle",title:"Error",description:"Could not save your changes."},{variant:"warning",appearance:"subtle",title:"Warning",description:"Disk space is running low."},{variant:"info",appearance:"subtle",title:"Info",description:"A new version is available."}]})},u={name:"Solid Treatments",parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!1}]}}},render:()=>e.jsx(i,{inputs:[{variant:"neutral",appearance:"solid",title:"Neutral",description:"A muted-but-emphatic notification."},{variant:"success",appearance:"solid",title:"Success",description:"Your changes have been saved."},{variant:"error",appearance:"solid",title:"Error",description:"Could not save your changes."},{variant:"warning",appearance:"solid",title:"Warning",description:"Disk space is running low."},{variant:"info",appearance:"solid",title:"Info",description:"A new version is available."}]})},g={name:"With Action",render:()=>e.jsx(i,{inputs:[{variant:"success",title:"Saved",description:"Your changes have been saved.",action:{label:"Undo",onClick:()=>{}}},{variant:"info",title:"Update available",description:"A new version is ready to install.",action:{label:"Reload",onClick:()=>{}}}]})},v={name:"Title Only",render:()=>e.jsx(i,{inputs:[{variant:"success",title:"Saved"},{variant:"error",title:"Could not connect"}]})},h={name:"Long Content",render:()=>e.jsx(i,{inputs:[{variant:"warning",title:"Heads up: long-running operation completed with warnings",description:"Three records were skipped because they did not match the expected schema. You can retry the import after correcting the source file, or proceed with the partial data that has already been saved.",action:{label:"View details",onClick:()=>{}}}]})},o={name:"Long Action Label",render:()=>e.jsx(i,{inputs:[{variant:"info",title:"New version ready",description:"A fresh build of the app is available.",action:{label:"View details and full report",onClick:()=>{}}},{variant:"success",appearance:"solid",title:"Saved across all devices",action:{label:"View details and full report",onClick:()=>{}}}]})},T=()=>(b.useEffect(()=>(f(),a.loading({title:"Saving…",description:"Uploading your changes."}),a.loading({title:"Connecting…",appearance:"solid"}),()=>{f()}),[]),e.jsx("div",{className:"min-h-screen",children:e.jsx(l,{position:"bottom-center",expand:!0,visibleToasts:10})})),x={name:"Loading",render:()=>e.jsx(T,{})},c={name:"Promise",render:()=>e.jsxs("div",{className:"min-h-screen p-8 flex flex-col gap-4 items-start",children:[e.jsx("p",{className:"text-sm text-foreground-muted",children:"Click to fire a promise toast (loading → success). Reject variant transitions to error."}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(s,{variant:"secondary",size:"sm",onClick:()=>a.promise(new globalThis.Promise(t=>setTimeout(t,1500)),{loading:"Saving…",success:{title:"Saved",variant:"success"},error:{title:"Save failed",variant:"error"}}),children:"Resolve"}),e.jsx(s,{variant:"secondary",size:"sm",onClick:()=>a.promise(new globalThis.Promise((t,n)=>setTimeout(()=>n(new Error("nope")),1500)),{loading:"Saving…",success:"Saved",error:t=>({title:"Save failed",description:String(t),variant:"error"})}),children:"Reject"})]}),e.jsx(l,{position:"bottom-center",expand:!0,visibleToasts:10})]})},$=["PlaygroundStory","SubtleTreatments","SolidTreatments","WithAction","TitleOnly","LongContent","LongActionLabel","Loading","PromiseDemo"];p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: 'Playground',
  args: {
...
}`,...c.parameters?.docs?.source},description:{story:"`toast.promise()` drives a toast from a promise. The button below fires a\npromise that resolves after ~1.5s, transitioning loading → success.\nInteractive — not captured by VRT.",...c.parameters?.docs?.description}}};export{x as Loading,o as LongActionLabel,h as LongContent,p as PlaygroundStory,c as PromiseDemo,u as SolidTreatments,m as SubtleTreatments,v as TitleOnly,g as WithAction,$ as __namedExportsOrder,I as default};
