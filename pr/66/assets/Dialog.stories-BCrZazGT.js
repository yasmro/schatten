import{r,j as e}from"./iframe-DAPfhwBF.js";import{B as d}from"./Button-GGWMwQM_.js";import{b as Re,P as y,d as b,c as _e,a as Ee,g as Fe}from"./index-PFxrtnf8.js";import{u as R}from"./index-DBCWXewn.js";import{u as N}from"./index-Cj_i147L.js";import{P as We,D as Me}from"./index-xToI322b.js";import{R as Ve,h as qe,u as Ye,F as Ge}from"./Combination-BlWpQp0m.js";import{P as _}from"./index-C_OhFp75.js";import{c as T}from"./utils-BLSKlp9E.js";import{S as Ke}from"./Separator-DDB1TisH.js";import"./preload-helper-DVxGsIx5.js";import"./index-B0pce7q3.js";import"./index-0G5xgJJL.js";import"./chevron-up-DPJKpvpG.js";import"./index-1evVQkiP.js";import"./Spinner-BP8IvgFa.js";import"./index-7z8EXDXR.js";import"./index-BWcDJ_89.js";var P="Dialog",[Oe]=_e(P),[$e,g]=Oe(P),ve=t=>{const{__scopeDialog:n,children:o,open:s,defaultOpen:i,onOpenChange:a,modal:l=!0}=t,c=r.useRef(null),p=r.useRef(null),[h,m]=Re({prop:s,defaultProp:i??!1,onChange:a,caller:P});return e.jsx($e,{scope:n,triggerRef:c,contentRef:p,contentId:N(),titleId:N(),descriptionId:N(),open:h,onOpenChange:m,onOpenToggle:r.useCallback(()=>m(L=>!L),[m]),modal:l,children:o})};ve.displayName=P;var Ce="DialogTrigger",ze=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=g(Ce,o),a=R(n,i.triggerRef);return e.jsx(y.button,{type:"button","aria-haspopup":"dialog","aria-expanded":i.open,"aria-controls":i.contentId,"data-state":W(i.open),...s,ref:a,onClick:b(t.onClick,i.onOpenToggle)})});ze.displayName=Ce;var E="DialogPortal",[He,xe]=Oe(E,{forceMount:void 0}),Se=t=>{const{__scopeDialog:n,forceMount:o,children:s,container:i}=t,a=g(E,n);return e.jsx(He,{scope:n,forceMount:o,children:r.Children.map(s,l=>e.jsx(_,{present:o||a.open,children:e.jsx(We,{asChild:!0,container:i,children:l})}))})};Se.displayName=E;var j="DialogOverlay",De=r.forwardRef((t,n)=>{const o=xe(j,t.__scopeDialog),{forceMount:s=o.forceMount,...i}=t,a=g(j,t.__scopeDialog);return a.modal?e.jsx(_,{present:s||a.open,children:e.jsx(Xe,{...i,ref:n})}):null});De.displayName=j;var Ue=Ee("DialogOverlay.RemoveScroll"),Xe=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=g(j,o);return e.jsx(Ve,{as:Ue,allowPinchZoom:!0,shards:[i.contentRef],children:e.jsx(y.div,{"data-state":W(i.open),...s,ref:n,style:{pointerEvents:"auto",...s.style}})})}),f="DialogContent",we=r.forwardRef((t,n)=>{const o=xe(f,t.__scopeDialog),{forceMount:s=o.forceMount,...i}=t,a=g(f,t.__scopeDialog);return e.jsx(_,{present:s||a.open,children:a.modal?e.jsx(Ze,{...i,ref:n}):e.jsx(Je,{...i,ref:n})})});we.displayName=f;var Ze=r.forwardRef((t,n)=>{const o=g(f,t.__scopeDialog),s=r.useRef(null),i=R(n,o.contentRef,s);return r.useEffect(()=>{const a=s.current;if(a)return qe(a)},[]),e.jsx(Be,{...t,ref:i,trapFocus:o.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:b(t.onCloseAutoFocus,a=>{var l;a.preventDefault(),(l=o.triggerRef.current)==null||l.focus()}),onPointerDownOutside:b(t.onPointerDownOutside,a=>{const l=a.detail.originalEvent,c=l.button===0&&l.ctrlKey===!0;(l.button===2||c)&&a.preventDefault()}),onFocusOutside:b(t.onFocusOutside,a=>a.preventDefault())})}),Je=r.forwardRef((t,n)=>{const o=g(f,t.__scopeDialog),s=r.useRef(!1),i=r.useRef(!1);return e.jsx(Be,{...t,ref:n,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:a=>{var l,c;(l=t.onCloseAutoFocus)==null||l.call(t,a),a.defaultPrevented||(s.current||(c=o.triggerRef.current)==null||c.focus(),a.preventDefault()),s.current=!1,i.current=!1},onInteractOutside:a=>{var p,h;(p=t.onInteractOutside)==null||p.call(t,a),a.defaultPrevented||(s.current=!0,a.detail.originalEvent.type==="pointerdown"&&(i.current=!0));const l=a.target;((h=o.triggerRef.current)==null?void 0:h.contains(l))&&a.preventDefault(),a.detail.originalEvent.type==="focusin"&&i.current&&a.preventDefault()}})}),Be=r.forwardRef((t,n)=>{const{__scopeDialog:o,trapFocus:s,onOpenAutoFocus:i,onCloseAutoFocus:a,...l}=t,c=g(f,o),p=r.useRef(null),h=R(n,p);return Ye(),e.jsxs(e.Fragment,{children:[e.jsx(Ge,{asChild:!0,loop:!0,trapped:s,onMountAutoFocus:i,onUnmountAutoFocus:a,children:e.jsx(Me,{role:"dialog",id:c.contentId,"aria-describedby":c.descriptionId,"aria-labelledby":c.titleId,"data-state":W(c.open),...l,ref:h,onDismiss:()=>c.onOpenChange(!1)})}),e.jsxs(e.Fragment,{children:[e.jsx(Qe,{titleId:c.titleId}),e.jsx(tt,{contentRef:p,descriptionId:c.descriptionId})]})]})}),F="DialogTitle",Ie=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=g(F,o);return e.jsx(y.h2,{id:i.titleId,...s,ref:n})});Ie.displayName=F;var ke="DialogDescription",Ae=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=g(ke,o);return e.jsx(y.p,{id:i.descriptionId,...s,ref:n})});Ae.displayName=ke;var je="DialogClose",Pe=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=g(je,o);return e.jsx(y.button,{type:"button",...s,ref:n,onClick:b(t.onClick,()=>i.onOpenChange(!1))})});Pe.displayName=je;function W(t){return t?"open":"closed"}var Le="DialogTitleWarning",[jt,Ne]=Fe(Le,{contentName:f,titleName:F,docsSlug:"dialog"}),Qe=({titleId:t})=>{const n=Ne(Le),o=`\`${n.contentName}\` requires a \`${n.titleName}\` for the component to be accessible for screen reader users.

If you want to hide the \`${n.titleName}\`, you can wrap it with our VisuallyHidden component.

For more information, see https://radix-ui.com/primitives/docs/components/${n.docsSlug}`;return r.useEffect(()=>{t&&(document.getElementById(t)||console.error(o))},[o,t]),null},et="DialogDescriptionWarning",tt=({contentRef:t,descriptionId:n})=>{const s=`Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Ne(et).contentName}}.`;return r.useEffect(()=>{var a;const i=(a=t.current)==null?void 0:a.getAttribute("aria-describedby");n&&i&&(document.getElementById(n)||console.warn(s))},[s,t,n]),null},nt=ve,ot=Se,at=De,st=we,it=Ie,rt=Ae,Te=Pe;function lt({title:t,description:n}){return e.jsxs("div",{className:"shrink-0 flex flex-col gap-1.5 pr-8",children:[e.jsx(it,{className:"text-lg font-semibold leading-tight text-foreground",children:t}),n&&e.jsx(rt,{className:"text-sm text-foreground-muted",children:n})]})}function ct({children:t}){return e.jsx("div",{className:"min-h-0 overflow-y-auto text-sm text-foreground",children:t})}function dt({actionButton:t,cancelButton:n,subActionButton:o,anyLoading:s}){const i=!!t.isLoading,a=!!(o!=null&&o.isLoading);return e.jsxs("div",{className:T("shrink-0 flex flex-col gap-2","sm:flex-row sm:items-center sm:gap-2 sm:justify-end"),children:[e.jsx(d,{variant:t.variant??"primary",isLoading:i,disabled:a,onClick:t.onClick,icon:t.icon,className:"order-1 sm:order-3",children:t.label}),n&&e.jsx(Te,{asChild:!0,children:e.jsx(d,{variant:"secondary",disabled:s,onClick:n.onClick,icon:n.icon,className:"order-2",children:n.label})}),o&&e.jsx(Ke,{className:"order-3 my-2 sm:my-0 sm:hidden","aria-hidden":"true"}),o&&e.jsx(d,{variant:"tertiary",isLoading:a,disabled:i,onClick:o.onClick,icon:o.icon,className:"order-4 sm:order-1 sm:mr-auto",children:o.label})]})}function ut({disabled:t}){return e.jsx("div",{className:"absolute right-4 top-4",children:e.jsx(Te,{asChild:!0,children:e.jsx(d,{variant:"tertiary",size:"sm",icon:"X","aria-label":"Close",disabled:t})})})}const u=({isOpen:t,onOpenChange:n,title:o,description:s,isCloseButtonVisible:i=!0,actionButton:a,cancelButton:l,subActionButton:c,children:p})=>{r.useEffect(()=>{},[t,a.onClick]);const h=!!a.isLoading||!!(c!=null&&c.isLoading),m=r.useCallback(L=>{h&&L.preventDefault()},[h]);return e.jsx(nt,{open:t,onOpenChange:n,children:e.jsxs(ot,{children:[e.jsx(at,{className:T("dialog-overlay fixed inset-0 z-(--z-modal-backdrop) bg-black/50")}),e.jsxs(st,{onEscapeKeyDown:m,onPointerDownOutside:m,onInteractOutside:m,...s===void 0&&{"aria-describedby":void 0},className:T("dialog-content fixed left-1/2 top-1/2 z-(--z-modal)","-translate-x-1/2 -translate-y-1/2","w-[calc(100vw-2rem)] max-w-md","max-h-[calc(100vh-2rem)] overflow-hidden","bg-background border border-border-strong shadow-lg","flex flex-col gap-6 p-6"),children:[e.jsx(lt,{title:o,description:s}),p&&e.jsx(ct,{children:p}),e.jsx(dt,{actionButton:a,cancelButton:l,subActionButton:c,anyLoading:h}),i&&e.jsx(ut,{disabled:h})]})]})})};u.displayName="Dialog";try{u.displayName="Dialog",u.__docgenInfo={description:"",displayName:"Dialog",props:{isOpen:{defaultValue:null,description:"Controlled open state.",name:"isOpen",required:!0,type:{name:"boolean"}},onOpenChange:{defaultValue:null,description:"Called when the open state changes (close ✕, ESC, overlay click, cancel button).",name:"onOpenChange",required:!0,type:{name:"(isOpen: boolean) => void"}},title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},isCloseButtonVisible:{defaultValue:{value:"true"},description:"Default: true.",name:"isCloseButtonVisible",required:!1,type:{name:"boolean"}},actionButton:{defaultValue:null,description:`Required primary action. Set \`isLoading: true\` on the slot to show
...
- Desktop (horizontal): visual order is \`SubAction … Cancel Action\`
  ...
  confirmation lands on the primary action immediately.`,name:"children",required:!1,type:{name:"ReactNode"}}}}}catch{}const Pt={title:"Components/lv1/Dialog",component:u,parameters:{layout:"centered",docs:{description:{component:`Dialog renders a modal overlay for important content or actions —
...
}`,...(q=(V=O.parameters)==null?void 0:V.docs)==null?void 0:q.source}}};var Y,G,K;v.parameters={...v.parameters,docs:{...(Y=v.parameters)==null?void 0:Y.docs,source:{originalSource:`{
...
}`,...(K=(G=v.parameters)==null?void 0:G.docs)==null?void 0:K.source}}};var $,z,H;C.parameters={...C.parameters,docs:{...($=C.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: 'Destructive',
  parameters: {
    docs: {
      description: {
...
}`,...(H=(z=C.parameters)==null?void 0:z.docs)==null?void 0:H.source}}};var U,X,Z;x.parameters={...x.parameters,docs:{...(U=x.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(Z=(X=x.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};var J,Q,ee;S.parameters={...S.parameters,docs:{...(J=S.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: 'Loading',
  parameters: {
    docs: {
      description: {
...
}`,...(ee=(Q=S.parameters)==null?void 0:Q.docs)==null?void 0:ee.source}}};var te,ne,oe;D.parameters={...D.parameters,docs:{...(te=D.parameters)==null?void 0:te.docs,source:{originalSource:`{
...
}`,...(oe=(ne=D.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var ae,se,ie;w.parameters={...w.parameters,docs:{...(ae=w.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  name: 'Async Action',
  parameters: {
    docs: {
      description: {
...
}`,...(ie=(se=w.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var re,le,ce;B.parameters={...B.parameters,docs:{...(re=B.parameters)==null?void 0:re.docs,source:{originalSource:`{
...
}`,...(ce=(le=B.parameters)==null?void 0:le.docs)==null?void 0:ce.source}}};var de,ue,pe;I.parameters={...I.parameters,docs:{...(de=I.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(pe=(ue=I.parameters)==null?void 0:ue.docs)==null?void 0:pe.source}}};var he,ge,me;k.parameters={...k.parameters,docs:{...(he=k.parameters)==null?void 0:he.docs,source:{originalSource:`{
...
}`,...(me=(ge=k.parameters)==null?void 0:ge.docs)==null?void 0:me.source}}};var fe,be,ye;A.parameters={...A.parameters,docs:{...(fe=A.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  name: 'Long Content',
  parameters: {
    docs: {
      description: {
...
}`,...(ye=(be=A.parameters)==null?void 0:be.docs)==null?void 0:ye.source}}};const Lt=["Playground","Confirm","Destructive","WithSubAction","Loading","SubActionLoading","AsyncAction","AsyncSubAction","WithoutCloseButton","InfoOnly","LongContent"];export{w as AsyncAction,B as AsyncSubAction,v as Confirm,C as Destructive,k as InfoOnly,S as Loading,A as LongContent,O as Playground,D as SubActionLoading,x as WithSubAction,I as WithoutCloseButton,Lt as __namedExportsOrder,Pt as default};
