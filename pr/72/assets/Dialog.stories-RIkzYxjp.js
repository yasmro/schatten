import{r,j as e}from"./iframe-DLwXByxr.js";import{B as d}from"./Button-CGrJ6yW5.js";import{b as Te,P as y,d as b,c as _e,a as Ee,g as Fe}from"./index-DCiiPkaU.js";import{u as T}from"./index-BR7Qj2PG.js";import{u as N}from"./index-CnAaxLzR.js";import{P as We,D as Me}from"./index-Cgy-Xs-B.js";import{R as Ve,h as qe,u as Ye,F as Ge}from"./Combination-tP3LN9o5.js";import{P as _}from"./index-kWlwgulB.js";import{c as R}from"./utils-BLSKlp9E.js";import{S as Ke}from"./Separator-D3Og8gxw.js";import"./preload-helper-GK_mXVe5.js";import"./index-CneWHPCu.js";import"./index-xgt8tK7t.js";import"./chevron-up-DWLYWpqJ.js";import"./index-1evVQkiP.js";import"./Spinner-BAWSolPE.js";import"./index-BMFY3PKZ.js";import"./index-DTgdH8Mc.js";var j="Dialog",[ve]=_e(j),[$e,m]=ve(j),Oe=t=>{const{__scopeDialog:n,children:o,open:s,defaultOpen:i,onOpenChange:a,modal:l=!0}=t,c=r.useRef(null),p=r.useRef(null),[g,h]=Te({prop:s,defaultProp:i??!1,onChange:a,caller:j});return e.jsx($e,{scope:n,triggerRef:c,contentRef:p,contentId:N(),titleId:N(),descriptionId:N(),open:g,onOpenChange:h,onOpenToggle:r.useCallback(()=>h(L=>!L),[h]),modal:l,children:o})};Oe.displayName=j;var Ce="DialogTrigger",ze=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=m(Ce,o),a=T(n,i.triggerRef);return e.jsx(y.button,{type:"button","aria-haspopup":"dialog","aria-expanded":i.open,"aria-controls":i.contentId,"data-state":W(i.open),...s,ref:a,onClick:b(t.onClick,i.onOpenToggle)})});ze.displayName=Ce;var E="DialogPortal",[He,De]=ve(E,{forceMount:void 0}),xe=t=>{const{__scopeDialog:n,forceMount:o,children:s,container:i}=t,a=m(E,n);return e.jsx(He,{scope:n,forceMount:o,children:r.Children.map(s,l=>e.jsx(_,{present:o||a.open,children:e.jsx(We,{asChild:!0,container:i,children:l})}))})};xe.displayName=E;var P="DialogOverlay",Se=r.forwardRef((t,n)=>{const o=De(P,t.__scopeDialog),{forceMount:s=o.forceMount,...i}=t,a=m(P,t.__scopeDialog);return a.modal?e.jsx(_,{present:s||a.open,children:e.jsx(Xe,{...i,ref:n})}):null});Se.displayName=P;var Ue=Ee("DialogOverlay.RemoveScroll"),Xe=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=m(P,o);return e.jsx(Ve,{as:Ue,allowPinchZoom:!0,shards:[i.contentRef],children:e.jsx(y.div,{"data-state":W(i.open),...s,ref:n,style:{pointerEvents:"auto",...s.style}})})}),f="DialogContent",Be=r.forwardRef((t,n)=>{const o=De(f,t.__scopeDialog),{forceMount:s=o.forceMount,...i}=t,a=m(f,t.__scopeDialog);return e.jsx(_,{present:s||a.open,children:a.modal?e.jsx(Ze,{...i,ref:n}):e.jsx(Je,{...i,ref:n})})});Be.displayName=f;var Ze=r.forwardRef((t,n)=>{const o=m(f,t.__scopeDialog),s=r.useRef(null),i=T(n,o.contentRef,s);return r.useEffect(()=>{const a=s.current;if(a)return qe(a)},[]),e.jsx(we,{...t,ref:i,trapFocus:o.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:b(t.onCloseAutoFocus,a=>{var l;a.preventDefault(),(l=o.triggerRef.current)==null||l.focus()}),onPointerDownOutside:b(t.onPointerDownOutside,a=>{const l=a.detail.originalEvent,c=l.button===0&&l.ctrlKey===!0;(l.button===2||c)&&a.preventDefault()}),onFocusOutside:b(t.onFocusOutside,a=>a.preventDefault())})}),Je=r.forwardRef((t,n)=>{const o=m(f,t.__scopeDialog),s=r.useRef(!1),i=r.useRef(!1);return e.jsx(we,{...t,ref:n,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:a=>{var l,c;(l=t.onCloseAutoFocus)==null||l.call(t,a),a.defaultPrevented||(s.current||(c=o.triggerRef.current)==null||c.focus(),a.preventDefault()),s.current=!1,i.current=!1},onInteractOutside:a=>{var p,g;(p=t.onInteractOutside)==null||p.call(t,a),a.defaultPrevented||(s.current=!0,a.detail.originalEvent.type==="pointerdown"&&(i.current=!0));const l=a.target;((g=o.triggerRef.current)==null?void 0:g.contains(l))&&a.preventDefault(),a.detail.originalEvent.type==="focusin"&&i.current&&a.preventDefault()}})}),we=r.forwardRef((t,n)=>{const{__scopeDialog:o,trapFocus:s,onOpenAutoFocus:i,onCloseAutoFocus:a,...l}=t,c=m(f,o),p=r.useRef(null),g=T(n,p);return Ye(),e.jsxs(e.Fragment,{children:[e.jsx(Ge,{asChild:!0,loop:!0,trapped:s,onMountAutoFocus:i,onUnmountAutoFocus:a,children:e.jsx(Me,{role:"dialog",id:c.contentId,"aria-describedby":c.descriptionId,"aria-labelledby":c.titleId,"data-state":W(c.open),...l,ref:g,onDismiss:()=>c.onOpenChange(!1)})}),e.jsxs(e.Fragment,{children:[e.jsx(Qe,{titleId:c.titleId}),e.jsx(tt,{contentRef:p,descriptionId:c.descriptionId})]})]})}),F="DialogTitle",ke=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=m(F,o);return e.jsx(y.h2,{id:i.titleId,...s,ref:n})});ke.displayName=F;var Ie="DialogDescription",Ae=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=m(Ie,o);return e.jsx(y.p,{id:i.descriptionId,...s,ref:n})});Ae.displayName=Ie;var Pe="DialogClose",je=r.forwardRef((t,n)=>{const{__scopeDialog:o,...s}=t,i=m(Pe,o);return e.jsx(y.button,{type:"button",...s,ref:n,onClick:b(t.onClick,()=>i.onOpenChange(!1))})});je.displayName=Pe;function W(t){return t?"open":"closed"}var Le="DialogTitleWarning",[Pt,Ne]=Fe(Le,{contentName:f,titleName:F,docsSlug:"dialog"}),Qe=({titleId:t})=>{const n=Ne(Le),o=`\`${n.contentName}\` requires a \`${n.titleName}\` for the component to be accessible for screen reader users.

If you want to hide the \`${n.titleName}\`, you can wrap it with our VisuallyHidden component.

For more information, see https://radix-ui.com/primitives/docs/components/${n.docsSlug}`;return r.useEffect(()=>{t&&(document.getElementById(t)||console.error(o))},[o,t]),null},et="DialogDescriptionWarning",tt=({contentRef:t,descriptionId:n})=>{const s=`Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Ne(et).contentName}}.`;return r.useEffect(()=>{var a;const i=(a=t.current)==null?void 0:a.getAttribute("aria-describedby");n&&i&&(document.getElementById(n)||console.warn(s))},[s,t,n]),null},nt=Oe,ot=xe,at=Se,st=Be,it=ke,rt=Ae,Re=je;function lt({title:t,description:n}){return e.jsxs("div",{className:"shrink-0 flex flex-col gap-1.5 pr-8",children:[e.jsx(it,{className:"text-lg font-semibold leading-tight text-foreground",children:t}),n&&e.jsx(rt,{className:"text-sm text-foreground-muted",children:n})]})}function ct({children:t}){return e.jsx("div",{className:"min-h-0 overflow-y-auto text-sm text-foreground",children:t})}function dt({actionButton:t,cancelButton:n,subActionButton:o,anyLoading:s}){const i=!!t.isLoading,a=!!(o!=null&&o.isLoading);return e.jsxs("div",{className:R("shrink-0 flex flex-col gap-2","sm:flex-row sm:items-center sm:gap-2 sm:justify-end"),children:[e.jsx(d,{variant:t.variant??"primary",isLoading:i,disabled:a,onClick:t.onClick,icon:t.icon,className:"order-1 sm:order-3",children:t.label}),n&&e.jsx(Re,{asChild:!0,children:e.jsx(d,{variant:"secondary",disabled:s,onClick:n.onClick,icon:n.icon,className:"order-2",children:n.label})}),o&&e.jsx(Ke,{className:"order-3 my-2 sm:my-0 sm:hidden","aria-hidden":"true"}),o&&e.jsx(d,{variant:"tertiary",isLoading:a,disabled:i,onClick:o.onClick,icon:o.icon,className:"order-4 sm:order-1 sm:mr-auto",children:o.label})]})}function ut({disabled:t}){return e.jsx("div",{className:"absolute right-4 top-4",children:e.jsx(Re,{asChild:!0,children:e.jsx(d,{variant:"tertiary",size:"sm",icon:"X","aria-label":"Close",disabled:t})})})}const u=({isOpen:t,onOpenChange:n,title:o,description:s,isCloseButtonVisible:i=!0,actionButton:a,cancelButton:l,subActionButton:c,children:p})=>{r.useEffect(()=>{},[t,a.onClick]);const g=!!a.isLoading||!!(c!=null&&c.isLoading),h=r.useCallback(L=>{g&&L.preventDefault()},[g]);return e.jsx(nt,{open:t,onOpenChange:n,children:e.jsxs(ot,{children:[e.jsx(at,{className:R("dialog-overlay fixed inset-0 z-(--z-modal-backdrop) bg-black/50")}),e.jsxs(st,{onEscapeKeyDown:h,onPointerDownOutside:h,onInteractOutside:h,...s===void 0&&{"aria-describedby":void 0},className:R("dialog-content fixed left-1/2 top-1/2 z-(--z-modal)","-translate-x-1/2 -translate-y-1/2","w-[calc(100vw-2rem)] max-w-md","max-h-[calc(100vh-2rem)] overflow-hidden","bg-background border border-border-strong shadow-lg","flex flex-col gap-6 p-6"),children:[e.jsx(lt,{title:o,description:s}),p&&e.jsx(ct,{children:p}),e.jsx(dt,{actionButton:a,cancelButton:l,subActionButton:c,anyLoading:g}),i&&e.jsx(ut,{disabled:g})]})]})})};u.displayName="Dialog";try{u.displayName="Dialog",u.__docgenInfo={description:"",displayName:"Dialog",filePath:"/home/runner/work/schatten/schatten/src/components/lv1/Dialog/Dialog.tsx",methods:[],props:{isOpen:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Controlled open state.",name:"isOpen",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!0,tags:{},type:{name:"boolean"}},onOpenChange:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Called when the open state changes (close ✕, ESC, overlay click, cancel button).",name:"onOpenChange",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!0,tags:{},type:{name:"(isOpen: boolean) => void"}},title:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"",name:"title",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!0,tags:{},type:{name:"string"}},description:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"",name:"description",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!1,tags:{},type:{name:"string"}},isCloseButtonVisible:{defaultValue:{value:"true"},declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:"Default: true.",name:"isCloseButtonVisible",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!1,tags:{},type:{name:"boolean"}},actionButton:{defaultValue:null,declarations:[{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"}],description:`Required primary action. Set \`isLoading: true\` on the slot to show
...
- Desktop (horizontal): visual order is \`SubAction … Cancel Action\`
  ...
  confirmation lands on the primary action immediately.`,name:"children",parent:{fileName:"schatten/src/components/lv1/Dialog/Dialog.tsx",name:"DialogProps"},required:!1,tags:{},type:{name:"ReactNode"}}},tags:{}}}catch{}const jt={title:"Components/lv1/Dialog",component:u,parameters:{layout:"centered",docs:{description:{component:`Dialog renders a modal overlay for important content or actions —
...
}`,...(ye=(be=A.parameters)==null?void 0:be.docs)==null?void 0:ye.source}}};const Lt=["Playground","Confirm","Destructive","WithSubAction","Loading","SubActionLoading","AsyncAction","AsyncSubAction","WithoutCloseButton","InfoOnly","LongContent"];export{B as AsyncAction,w as AsyncSubAction,O as Confirm,C as Destructive,I as InfoOnly,x as Loading,A as LongContent,v as Playground,S as SubActionLoading,D as WithSubAction,k as WithoutCloseButton,Lt as __namedExportsOrder,jt as default};
