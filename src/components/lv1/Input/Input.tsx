...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const handleWrapperClick = () => {
      // React-only ergonomic: clicking the wrapper (e.g. its padding area)
      // focuses the input. Vanilla HTML consumers must click the input
      // directly — there's no CSS-only equivalent for focus delegation.
      // Documented in CSSApi.stories.tsx Input section.
      if (!disabled) {
